...
idecimals ccollabel iextent casgntrig cinitial chelp cvalexp cvalmsg cdesc ~
cviewas bClose bHelp 
&Scoped-Define DISPLAYED-OBJECTS cname cdatatype cformat iorder clabel ~
idecimals ccollabel iextent casgntrig cinitial chelp cvalexp cvalmsg cdesc ~
cviewas lmandatory lcasesen 
...
DEFINE VARIABLE cdatatype AS CHARACTER FORMAT "X(9)":U 
     LABEL "Data Type" 
     VIEW-AS FILL-IN 
     SIZE 25 BY 1
     BGCOLOR 15 FGCOLOR 0  NO-UNDO.

DEFINE VARIABLE cformat AS CHARACTER FORMAT "X(30)":U 
     LABEL "Format" 
     VIEW-AS FILL-IN 
     SIZE 25 BY 1
     BGCOLOR 15 FGCOLOR 0  NO-UNDO.
...
DEFINE FRAME DEFAULT-FRAME
     ...
     cdatatype AT ROW 1.38 COL 54 COLON-ALIGNED
     cformat AT ROW 2.67 COL 13 COLON-ALIGNED
     iorder AT ROW 2.67 COL 54 COLON-ALIGNED
     clabel AT ROW 4 COL 13 COLON-ALIGNED
     idecimals AT ROW 4 COL 54 COLON-ALIGNED
     ccollabel AT ROW 5.29 COL 13 COLON-ALIGNED
     iextent AT ROW 5.29 COL 54 COLON-ALIGNED
     casgntrig AT ROW 6.57 COL 13 COLON-ALIGNED
     cinitial AT ROW 6.57 COL 54 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  DISPLAY cname cdatatype cformat iorder clabel idecimals ccollabel iextent 
          casgntrig cinitial chelp cvalexp cvalmsg cdesc cviewas lmandatory 
          lcasesen 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE cname cdatatype cformat iorder clabel idecimals ccollabel iextent 
         casgntrig cinitial chelp cvalexp cvalmsg cdesc cviewas bClose bHelp 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
