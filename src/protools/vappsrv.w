...
DEFINE FRAME F-Main
     ...
     RowObject.Service AT ROW 3.62 COL 20 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 17 BY 1
     RowObject.App-Service AT ROW 4.81 COL 2.6
          VIEW-AS FILL-IN 
          SIZE 27 BY 1
     RowObject.ServerURL AT ROW 6 COL 5.8
          LABEL "AppServer URL"
          VIEW-AS FILL-IN 
          SIZE 45 BY 1
     RowObject.Configuration AT ROW 7.19 COL 22 NO-LABEL
          VIEW-AS RADIO-SET HORIZONTAL EXPAND 
          RADIO-BUTTONS 
                    "Remote", yes,
"Local", no
          SIZE 31 BY .95
     RowObject.Security AT ROW 8.14 COL 22
          VIEW-AS TOGGLE-BOX
          SIZE 34.6 BY .81
     RowObject.Info AT ROW 10.05 COL 3 NO-LABEL
          VIEW-AS EDITOR NO-WORD-WRAP MAX-CHARS 255 SCROLLBAR-HORIZONTAL SCROLLBAR-VERTICAL
          SIZE 64 BY 3.57
     RECT-2 AT ROW 1 COL 1
     "Configuration:" VIEW-AS TEXT
          SIZE 13 BY .95 AT ROW 7.19 COL 8
     "AppServer Information String:" VIEW-AS TEXT
          SIZE 29 BY .62 AT ROW 9.1 COL 3
