...
&Scoped-Define ENABLED-FIELDS Customer.Sales-Rep Customer.Terms ~
Customer.Discount Customer.Credit-Limit Customer.Balance 
...
&Scoped-Define DISPLAYED-FIELDS Customer.Sales-Rep Customer.Terms ~
Customer.Discount Customer.Credit-Limit Customer.Balance 
...
DEFINE FRAME F-Main
     Customer.Sales-Rep AT ROW 1.95 COL 13 COLON-ALIGNED
           VIEW-AS TEXT 
          SIZE 14 BY .76
     Customer.Terms AT ROW 2.91 COL 13 COLON-ALIGNED
           VIEW-AS TEXT 
          SIZE 16 BY .76
     Customer.Discount AT ROW 3.86 COL 13 COLON-ALIGNED
           VIEW-AS TEXT 
          SIZE 14 BY .76
     Customer.Credit-Limit AT ROW 4.81 COL 13 COLON-ALIGNED
           VIEW-AS TEXT 
          SIZE 17 BY .76
     Customer.Balance AT ROW 5.76 COL 13 COLON-ALIGNED
           VIEW-AS TEXT 
          SIZE 17 BY .76
     "Sales/Credit" VIEW-AS TEXT
          SIZE 13.8 BY .76 AT ROW 1 COL 3
          FONT 1
