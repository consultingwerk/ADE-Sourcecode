...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH Order OF Customer NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main Order
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main Order
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "sports.Order OF sports.Customer"
     _Options          = "NO-LOCK"
