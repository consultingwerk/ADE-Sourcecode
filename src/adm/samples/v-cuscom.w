...
&Scoped-Define ENABLED-FIELDS Customer.Comments 
...
&Scoped-Define DISPLAYED-FIELDS Customer.Comments 
...
DEFINE FRAME F-Main
     Customer.Comments AT ROW 1.14 COL 9.8 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 59.2 BY 1
          BGCOLOR 14 FGCOLOR 4 
     RECT-5 AT ROW 1 COL 1.6
     "Note:" VIEW-AS TEXT
          SIZE 6.8 BY .76 AT ROW 1.24 COL 2.8
          BGCOLOR 14 FGCOLOR 4 
...
/* SETTINGS FOR FILL-IN Customer.Comments IN FRAME F-Main
   ALIGN-L EXP-LABEL                                                    */
