...
{&OUT} '  onClick="cleanup()" onLoad="init()" onResize="setSize()" ~n'.
{&OUT} '  onUnload="return fileChanges(event)">~n'.

{&OUT} '<LAYER NAME="layer1" LEFT=1 TOP=1 VISIBILITY="hide">~n'.
{&OUT} '  <FORM NAME="form1">~n'.
{&OUT} '    <TEXTAREA NAME="txt" ROWS="10" COLS="10" WRAP="off"></TEXTAREA>~n'.
{&OUT} '    <INPUT NAME="fileName" TYPE="hidden" VALUE="Untitled">~n'.
{&OUT} '    <INPUT NAME="dirPath" TYPE="hidden">~n'.
{&OUT} '  </FORM>~n'.
{&OUT} '</LAYER>~n'.

{&OUT} '<SCRIPT LANGUAGE="JavaScript1.2"><!--~n'.
{&OUT} '  document.layer1.document.form1.elements[0].focus()~;~n'.
{&OUT} '//--></SCRIPT>~n'.
...
/************************* END OF HTML *************************/
/*
** File: src/main/abl/webedit/editornn.w
** Generated on: 2021-03-15 16:17:37
** By: WebSpeed Embedded SpeedScript Preprocessor
** Version: 2
** Source file: src/main/abl/webedit/editornn.html
