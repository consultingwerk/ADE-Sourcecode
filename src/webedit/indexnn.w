...
{&OUT} '</HEAD>~n'.
{&OUT} '<FRAMESET FRAMEBORDER=1 ROWS="70,*">~n'.
{&OUT} '  <FRAME NAME="WS_hdr" SRC="../webedit/headnn.w"  ~n'.
{&OUT} '    MARGINHEIGHT=8 MARGINWIDTH=5 NORESIZE SCROLLING="no">~n'.
{&OUT} '  <FRAMESET FRAMEBORDER=1 COLS="130,100%,*">~n'.
{&OUT} '    <FRAME NAME="WS_menu" SRC="../webedit/menu.w" NORESIZE ~n'.
{&OUT} '      MARGINHEIGHT=5 MARGINWIDTH=5>~n'.
{&OUT} '    <FRAME NAME="WS_edit" SRC="../webedit/editornn.w" SCROLLING="no">~n'.
{&OUT} '    <FRAME NAME="WS_file" SRC="' /*Tag=`*/ RootURL /*Tag=`*/ '/workshop/body.html" SCROLLING="no" ~n'.
...
/************************* END OF HTML *************************/
/*
** File: src/main/abl/webedit/indexnn.w
** Generated on: 2021-03-15 16:17:37
** By: WebSpeed Embedded SpeedScript Preprocessor
** Version: 2
** Source file: src/main/abl/webedit/indexnn.html
