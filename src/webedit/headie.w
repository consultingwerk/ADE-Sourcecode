...
{&OUT} '      <FONT SIZE="+2" COLOR="#660066"><B>~n'.
{&OUT} '        <SPAN ID="headerTitle">Editor - Untitled</SPAN>~n'.
{&OUT} '      </FONT>~n'.
{&OUT} '    </TD>~n'.
...
/************************* END OF HTML *************************/
/*
** File: src/main/abl/webedit/headie.w
** Generated on: 2021-03-15 16:17:37
** By: WebSpeed Embedded SpeedScript Preprocessor
** Version: 2
** Source file: src/main/abl/webedit/headie.html
