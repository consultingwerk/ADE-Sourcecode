...
&Scoped-define VSTINFO-TITLE Database Monitor
...
------------------------------------------------------------------------------*/
 {&OUT}
   { webtools/html.i  &SEGMENTS = "head"
                      ...
                      &TITLE    = "{&VSTINFO-TITLE}" }
   '<FRAMESET COLS="160,*">~n'
   '     <FRAME NAME="WSVST_index" SRC="vstinfo.w?html=Menu"~n'
   '                 FRAMEBORDER=yes MARGINHEIGHT=0 MARGINWIDTH=0>~n'
   '     <FRAME NAME="WSVST_main" SRC="vstinfo.w?html=report&report=DbStatus"~n'
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  DEF VAR link AS CHAR NO-UNDO
      INITIAL '&&nbsp~;&&nbsp~;<A HREF="vstinfo.w?html=Report&&amp~;Report=&1">&2</A><BR>~n'.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  DEFINE VAR c_html    AS CHAR NO-UNDO.
  DEFINE VAR c_report  AS CHAR NO-UNDO.
