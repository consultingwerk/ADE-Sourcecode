...
assign
   ...
   newname  = input frame bfldprop b_Field._Field-Name
   oldorder = b_Field._Order
   neworder = input frame bfldprop b_Field._Order.

do ON ERROR UNDO, LEAVE  ON STOP UNDO, LEAVE:
   run adecomm/_setcurs.p ("WAIT").
   
   ASSIGN b_Field._Field-name = newname
          input frame bfldprop b_Field._Order
          b_Field._Fld-Misc2[1] = CAPS(INPUT FRAME bfldprop blob-size:SCREEN-VALUE)
          b_Field._Width = wdth.
