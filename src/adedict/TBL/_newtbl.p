/***********************************************************************
* Copyright (C) 2000-2013,2020,2025 by Progress Software Corporation.       *
...
END.  
run prodict/pro/_pro_area_list.p(?,{&INVALID_AREAS},s_lst_file_Area:DELIMITER in frame newtbl,"Table", output  cAreaList).
