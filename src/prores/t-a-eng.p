...
/*    qbf-lang[13] = 'You have not purchased RESULTS.  Program terminated.' */
    ...
    qbf-lang[32] = "Your copy of the RESULTS is past it's experiration date"
    .
...
/*a-label.p*/
  ASSIGN            /* 1..8 use format x(78) */
    ...
    qbf-lang[ 9] = 'Name,Addr1,Addr2,Addr3,City,State,Zip,Zip+4,Postal,C-S-Z,Cntry'
...
IF qbf-s = 9 THEN
  ASSIGN           /* 1..6 format x(45) */
    ...
    qbf-lang[32] = 'Cannot build query form for this file.^^In order to '
                 ...
                 + 'ROWIDs or there must be a unique index on the file.'.
