/**********************************************************************
* Copyright (C) 2005-2016,2018,2022 by Progress Software Corporation. *
...
procedure destroyObject:
    ...
    /**
     * When QUIT is executed from within a procedure running on a PAS for OpenEdge instance,
     * the ABL session is reset to its initial state, which includes deletion of persistent
     * procedures and static ABL objects, the disconnection of databases (or re-connection
     * if the databases were connected at startup), and the clean-up of all global data,
     * such as shared variables.
     */
    quit. // Fully reset the session.
end.
