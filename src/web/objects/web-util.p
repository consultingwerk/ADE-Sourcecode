...
****************************************************************************/
   ...
   IF output-content-type EQ "" THEN DO:
      ...
      /* output-content-type BEGINS "text/html":U OR
         output-content-type BEGINS "text/x-server-parsed-html":U 
       */
      IF CAN-DO ("text/html*,text/x-server-parsed-html*",output-content-type) THEN
         {&OUT} 
           "<!-- Generated by Webspeed: http://www.webspeed.com/, http://www.possenet.org/ -->~n~n":U.
