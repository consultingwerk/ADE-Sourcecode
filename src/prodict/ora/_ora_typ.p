...
DEFINE VARIABLE gate-config AS CHARACTER EXTENT 18 NO-UNDO INITIAL [
...
/*"MLS Label       ,mlslbl    ,0,20480,character,0,|c", */
/*"RAW MLS Label   ,rwmlslbl  ,0,20480,character,0,|c", */
...
/*"Decimal         ,Decimal   ,0, 8192,decimal  ,0,|#",  */
/*"Integer         ,Integer   ,0, 8192,integer  ,0,|i",  */
  ?
].
