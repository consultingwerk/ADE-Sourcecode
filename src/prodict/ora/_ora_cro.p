...
/* _ora_cro - base objects for oracle meta-schema 
...
FIND _File
  WHERE _File._Db-recid = dbkey
    AND _File._File-name = "oracle_objects" 
...
ASSIGN
  ...
  _File._File-name   = "oracle_objects"
