...
FORM
   ...
   can_read   LABEL "Can-&Read"    {&STDPH_FILL} COLON 12 FORMAT "x(63)" 
	VIEW-AS FILL-IN SIZE 29 BY 1 SKIP({&VM_WID})
   can_write  LABEL "Can-&Write"   {&STDPH_FILL} COLON 12 FORMAT "x(63)" 
	VIEW-AS FILL-IN SIZE 29 BY 1 SKIP({&VM_WID})
   can_create LABEL "Can-&Create"  {&STDPH_FILL} COLON 12 FORMAT "x(63)" 
	VIEW-AS FILL-IN SIZE 29 BY 1 SKIP({&VM_WID})
   can_delete LABEL "Can-&Delete"  {&STDPH_FILL} COLON 12 FORMAT "x(63)" 
	VIEW-AS FILL-IN SIZE 29 BY 1 SKIP({&VM_WID})
   can_dump   LABEL "Can-Du&mp"    {&STDPH_FILL} COLON 12 FORMAT "x(63)" 
	VIEW-AS FILL-IN SIZE 29 BY 1 SKIP({&VM_WID})
   can_load   LABEL "Can-&Load"    {&STDPH_FILL} COLON 12 FORMAT "x(63)" 
