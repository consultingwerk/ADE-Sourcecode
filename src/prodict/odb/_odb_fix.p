...
/*
  ...
  History:  D. McMann 07/13/98 Added _Owner to _File finds.
            D. McMann 09/03/98 Added dbrecid to create _sequence.
            D. McMann 09/17/98 Removed default index from being created.
            D. McMann 02/22/99 Added check for files not pushed.
            D. McMann 03/16/99 Remove assignment of _Index._Idx-num
            D. McMann 11/24/99 Fixed to run either from ProToOdb or Adjust
                               Schema option
...
FORM
  ...
  TITLE " Updating ODBC Schema Holder".
...
FOR EACH DICTDB2._File WHERE DICTDB2._File._Owner = "PUB" 
  ...
  FOR EACH DICTDB2._Field OF DICTDB2._File:
    ...
    /* We have to do the same thing we do when running protoodb.
