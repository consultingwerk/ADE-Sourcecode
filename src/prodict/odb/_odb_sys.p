...
assign
  l_sys-obj   = {prodict/odb/odb_sys.i}
  l_sys-obj-f = "".
...
ELSE IF system BEGINS "a" THEN DO: /* add meta-schema definitions */
  ...
  RUN "prodict/odb/_odb_crp.p" (dbkey).
...
ELSE IF system BEGINS "q" THEN DO:
  system = "acdu,adgor,adnrsu#,100,2lp,16,?,?,odb,nors,iso8859-1".
END.
