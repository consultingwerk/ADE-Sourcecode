...
ON HELP OF FRAME frame_primary OR HELP OF FRAME frame_clustered OR HELP OF FRAME frame_unique OR HELP OF FRAME frame_foreign
 ...
 DO:   
    ...
    RUN adecomm/_adehelp.p (INPUT "admn", INPUT "CONTEXT", 
                              INPUT {&MS_SQL_Server_Data_Server_Create_Constraints_Dialog}, 
      	       	     	      INPUT ?).
 END.
&ENDIF
...
PROCEDURE Create_Const_Name:
 ...
 IF L_Idx_Type = "Clustered" THEN
    Assign L_Idx_Type = "_CKC_"
           N_Idx_Type = "M".
  ...
  IF L_Idx_Type = "Default" THEN
    Assign L_Idx_Type = "_DC_"
           N_Idx_Type = "D".
 ...
 IF N_Idx_Type = "M" THEN
   ASSIGN name:SCREEN-VALUE IN FRAME frame_clustered = L_Idx_Type.
   
 IF N_Idx_Type = "U" THEN
   ASSIGN name:SCREEN-VALUE IN FRAME frame_unique = L_Idx_Type.
   
 IF N_Idx_Type = "D" THEN
   ASSIGN name:SCREEN-VALUE IN FRAME frame_default = L_Idx_Type.
