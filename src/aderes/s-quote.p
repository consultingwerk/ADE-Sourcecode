...
DEFINE OUTPUT PARAMETER qbf-o AS CHARACTER NO-UNDO. /*outline*/
...
ELSE DO:
  IF INDEX(qbf-i,qbf-t) > 0 THEN
    DO qbf-j = 1 TO LENGTH(qbf-i,"CHARACTER":u):
      qbf-o = qbf-o + (IF SUBSTRING(qbf-i,qbf-j,1,"CHARACTER":u) = qbf-t
                       THEN qbf-t + qbf-t ELSE SUBSTRING(qbf-i,qbf-j,1,"CHARACTER":u)).
    END.
  ELSE
    qbf-o = qbf-i.
