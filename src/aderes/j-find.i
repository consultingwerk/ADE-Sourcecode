...
DEFINE {1} SHARED TEMP-TABLE qbf-purge
  FIELD p-item AS CHARACTER
  INDEX p-item p-item.
  
/*
qbf-subset is the list of joins for the current file.  it is a
           comma-separated list with each entry preceded by the join code:
           '=' for 1:1
           '<' for 1:M
           '>' for M:1
           '*' for M:M
