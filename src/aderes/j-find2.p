...
/* j-find2.p - inner loop for j-find.p */
...
/* for each field in this database matching name of  */
...
FOR EACH qbf-2a-field
  ...
  /* add this check to eliminate sql 92 views and tables */
  IF INTEGER(DBVERSION("QBF$2":U)) > 8 THEN 
      IF QBF$2._File._Owner <> "PUB":U AND QBF$2._File._Owner <> "_FOREIGN":U
       THEN NEXT.
