...
/*---------------------------------------------------------------------------------
  ...
  Description:  Astra Client Translation Manager

  Purpose:      This is the actual Client Side Translation Manager.
                The actual code for the Translation Manager is contained in the 
                include file af/app/aftrnmngrp.i
                This code is also used by the Server Side Translation Manager
                af/app/aftrnsrvrp.p
