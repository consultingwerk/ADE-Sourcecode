...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="08/08/2003" version_time="41924" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="1003504456" record_version_obj="3000033086.09" version_number_seq="5.09" secondary_key_value="afspfoldrw.w#CHR(1)#0" import_version_number_seq="5.09"><smartobject_obj>1003504456</smartobject_obj>
