...
/*---------------------------------------------------------------------------------
  ...
  (v:010004)    Task:         153   UserRef:    
                Date:   10/01/2001  Author:     Don Bulua

  Update Notes: Added handle as input parameter called to give-window-focus 
...
&scop object-name       afbldwindp2.p
...
&IF DEFINED(EXCLUDE-build-window-list-menu) = 0 &THEN
...
&IF DEFINED(EXCLUDE-is-window-enabled) = 0 &THEN
