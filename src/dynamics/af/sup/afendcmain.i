...
/*---------------------------------------------------------------------------------
  ...
  Description:  End of container main-block include file

  Purpose:      End of container main-block include file. Turns off egg-timer but could do more

  Parameters:   <none>

  History:
  --------
  (v:010000)    Task:         436   UserRef:    Astra
                Date:   14/07/1998  Author:     Anthony Swindells
