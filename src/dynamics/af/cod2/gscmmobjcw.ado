...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/20/2003" version_time="80504" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="1004833700.09" record_version_obj="3000049984.09" version_number_seq="14.09" secondary_key_value="gscmmobjcw#CHR(1)#0" import_version_number_seq="14.09"><smartobject_obj>1004833700.09</smartobject_obj>
