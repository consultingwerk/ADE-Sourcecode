...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/20/2003" version_time="80503" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="1000000525.28" record_version_obj="1000000526.28" version_number_seq="24.09" secondary_key_value="gscgcfoldw#CHR(1)#0" import_version_number_seq="24.09"><smartobject_obj>1000000525.28</smartobject_obj>
