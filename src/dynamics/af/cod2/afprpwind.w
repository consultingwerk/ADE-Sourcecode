...
/*---------------------------------------------------------------------------------
  ...
  Description:  Properies dialog dummy window

  Purpose:      Properies dialog dummy window
...
ON END-ERROR OF wiWin /* Propety Sheet */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wiWin wiWin
ON WINDOW-CLOSE OF wiWin /* Propety Sheet */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE hideThisWindow wiWin 
PROCEDURE hideThisWindow :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
