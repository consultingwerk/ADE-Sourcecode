...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/20/2003" version_time="80500" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="1004928233.09" record_version_obj="3000050024.09" version_number_seq="7.09" secondary_key_value="gstrvobjcw#CHR(1)#0" import_version_number_seq="7.09"><smartobject_obj>1004928233.09</smartobject_obj>
