...
&Scoped-Define ENABLED-OBJECTS fiFileName buFile fiSaveIn coSaveIn buSavein ~
...
DEFINE FRAME diDialog
     ...
     TogMan AT ROW 19.81 COL 24
     TogIndex AT ROW 19.81 COL 40.2
     buOk AT ROW 21.48 COL 84
     buCancel AT ROW 22.91 COL 84
     ...
     fiFlag AT ROW 19.91 COL 6.2 COLON-ALIGNED NO-LABEL
...
------------------------------------------------------------------------------*/
  DISPLAY fiFileName fiSaveIn coSaveIn ToRelative fiObjectName fiObjectDesc 
      ...
      WITH FRAME diDialog.
  ENABLE fiFileName buFile fiSaveIn coSaveIn buSavein ToRelative fiObjectName 
