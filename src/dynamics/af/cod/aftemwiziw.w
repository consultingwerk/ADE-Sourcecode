...
/*---------------------------------------------------------------------------------
  ...
  Description:  Wizard introduction window

  Purpose:      Wizard introduction window
  ...
  (v:010009)    Task:        1527   UserRef:    
                Date:   14/06/1999  Author:     Anthony Swindells

  Update Notes: Change the wizard
...
DEFINE SHARED VARIABLE intro-text AS CHARACTER NO-UNDO.
...
&Scoped-Define ENABLED-OBJECTS e_Intro IMAGE-2 
&Scoped-Define DISPLAYED-OBJECTS e_Intro 
...
DEFINE VARIABLE e_Intro AS CHARACTER 
     VIEW-AS EDITOR SCROLLBAR-VERTICAL LARGE
     SIZE 78.4 BY 9.29
     BGCOLOR 8  NO-UNDO.

DEFINE IMAGE IMAGE-2
     FILENAME "adeicon/wizard.bmp":U CONVERT-3D-COLORS
     SIZE 43.4 BY 9.05.
...
DEFINE FRAME DEFAULT-FRAME
     e_Intro AT ROW 1 COL 48.2 NO-LABEL
     IMAGE-2 AT ROW 1.04 COL 3
...
/* SETTINGS FOR FRAME DEFAULT-FRAME
   UNDERLINE                                                            */
ASSIGN 
       e_Intro:READ-ONLY IN FRAME DEFAULT-FRAME        = TRUE.
