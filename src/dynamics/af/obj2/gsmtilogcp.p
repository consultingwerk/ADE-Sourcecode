...
/*---------------------------------------------------------------------------------
  ...
  Description:  gsm_translated_menu_item Data Logic Procedure Library Template

  Purpose:      A procedure library (PLIP) to support the maintenance of the gsm_translated_menu_item table
...
&GLOB DATA-LOGIC-TABLE gsm_translated_menu_item
&GLOB DATA-FIELD-DEFS  "af/obj2/gsmtifullo.i"
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN cDescription = "gsm_translated_menu_item Data Logic Procedure".
...
------------------------------------------------------------------------------*/
  ...
  IF CAN-FIND(FIRST gsm_translated_menu_item 
              WHERE gsm_translated_menu_item.menu_item_obj = b_gsm_translated_menu_item.menu_item_obj
                AND gsm_translated_menu_item.language_obj = b_gsm_translated_menu_item.language_obj) THEN
  DO:
     ASSIGN
        cValueList   = STRING(b_gsm_translated_menu_item.menu_item_obj) + ', ' + STRING(b_gsm_translated_menu_item.language_obj)
        cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                      {aferrortxt.i 'AF' '8' 'gsm_translated_menu_item' '' "'menu_item_obj, language_obj, '" cValueList }.
  END.
...
------------------------------------------------------------------------------*/
  ...
  IF NOT isCreate() AND CAN-FIND(FIRST gsm_translated_menu_item 
              WHERE gsm_translated_menu_item.menu_item_obj = b_gsm_translated_menu_item.menu_item_obj
                AND gsm_translated_menu_item.language_obj = b_gsm_translated_menu_item.language_obj
                AND ROWID(gsm_translated_menu_item) <> TO-ROWID(ENTRY(1,b_gsm_translated_menu_item.RowIDent))) THEN
  DO:
     ASSIGN
        cValueList   = STRING(b_gsm_translated_menu_item.menu_item_obj) + ', ' + STRING(b_gsm_translated_menu_item.language_obj)
        cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
...
------------------------------------------------------------------------------*/
  ...
  IF b_gsm_translated_menu_item.menu_item_obj = 0 OR b_gsm_translated_menu_item.menu_item_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'gsm_translated_menu_item' 'menu_item_obj' "'Include'"}.

  IF b_gsm_translated_menu_item.language_obj = 0 OR b_gsm_translated_menu_item.language_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'gsm_translated_menu_item' 'language_obj' "'Include'"}.

  IF b_gsm_translated_menu_item.source_language_obj = 0 OR b_gsm_translated_menu_item.source_language_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'gsm_translated_menu_item' 'source_language_obj' "'Include'"}.
