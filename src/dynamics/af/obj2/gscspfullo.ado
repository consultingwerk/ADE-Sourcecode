...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="10/08/2003" version_time="65700" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="1004914447.09" record_version_obj="3000001828.09" version_number_seq="4.09" secondary_key_value="gscspfullo.w#CHR(1)#0" import_version_number_seq="4.09"><smartobject_obj>1004914447.09</smartobject_obj>
...
<contained_record DB="icfdb" Table="ryc_attribute_value"><attribute_value_obj>3000060315.09</attribute_value_obj>
<object_type_obj>1003183339</object_type_obj>
