...
/*---------------------------------------------------------------------------------
  ...
  Description:  Deploy Dataset Static SmartDataViewer

  Purpose:      Static SmartDataViewer for maintaining gsc_deploy_dataset
...
DEFINE FRAME frMain
     RowObject.dataset_code AT ROW 1 COL 27.8 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 24 BY 1
     RowObject.dataset_description AT ROW 2.1 COL 29.8 NO-LABEL
          VIEW-AS EDITOR MAX-CHARS 500 SCROLLBAR-VERTICAL LARGE
          SIZE 78.4 BY 4
     RowObject.default_ado_filename AT ROW 6.19 COL 27.8 COLON-ALIGNED
          LABEL "Default ado filename"
          VIEW-AS FILL-IN 
          SIZE 78.4 BY 1
     RowObject.xml_generation_procedure AT ROW 7.29 COL 27.8 COLON-ALIGNED
          LABEL "Xml generation procedure"
          VIEW-AS FILL-IN 
          SIZE 78.4 BY 1
     RowObject.disable_ri AT ROW 8.33 COL 29.8
          LABEL "Disable ri"
          VIEW-AS TOGGLE-BOX
          SIZE 14.6 BY 1
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "af/obj2/gscddfullo.w"
...
/* SETTINGS FOR FILL-IN RowObject.dataset_code IN FRAME frMain
   EXP-LABEL                                                            */
/* SETTINGS FOR EDITOR RowObject.dataset_description IN FRAME frMain
   EXP-LABEL                                                            */
ASSIGN 
       RowObject.dataset_description:RETURN-INSERTED IN FRAME frMain  = TRUE.

/* SETTINGS FOR FILL-IN RowObject.default_ado_filename IN FRAME frMain
   EXP-LABEL                                                            */
/* SETTINGS FOR TOGGLE-BOX RowObject.deletion_dataset IN FRAME frMain
   EXP-LABEL                                                            */
/* SETTINGS FOR TOGGLE-BOX RowObject.deploy_additions_only IN FRAME frMain
   EXP-LABEL                                                            */
/* SETTINGS FOR TOGGLE-BOX RowObject.deploy_full_data IN FRAME frMain
   EXP-LABEL                                                            */
/* SETTINGS FOR TOGGLE-BOX RowObject.disable_ri IN FRAME frMain
   EXP-LABEL                                                            */
/* SETTINGS FOR TOGGLE-BOX RowObject.enable_data_versioning IN FRAME frMain
   EXP-LABEL                                                            */
...
/* SETTINGS FOR TOGGLE-BOX RowObject.source_code_data IN FRAME frMain
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN RowObject.xml_generation_procedure IN FRAME frMain
   EXP-LABEL                                                            */
