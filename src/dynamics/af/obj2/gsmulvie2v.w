...
------------------------------------------------------------------------------*/
  ...
  &IF DEFINED(UIB_IS_RUNNING) = 0 &THEN
    ...
    cLinkHandles   = DYNAMIC-FUNCTION('linkHandles' IN hContainerSource, 'ContainerToolbar-Source').
