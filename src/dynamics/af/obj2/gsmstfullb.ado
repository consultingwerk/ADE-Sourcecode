...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/20/2003" version_time="80496" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="1004833433.09" record_version_obj="3000047911.09" version_number_seq="4.09" secondary_key_value="gsmstfullb#CHR(1)#0" import_version_number_seq="4.09"><smartobject_obj>1004833433.09</smartobject_obj>
...
<contained_record DB="icfdb" Table="ryc_attribute_value"><attribute_value_obj>3000047910.09</attribute_value_obj>
<object_type_obj>1003498159</object_type_obj>
...
<character_value>35#CHR(5)#11#CHR(5)#10#CHR(5)#17#CHR(5)#35#CHR(5)#19#CHR(5)#14#CHR(5)#11</character_value>
