...
/*---------------------------------------------------------------------------------
  ...
  Description:  Session Property SmartDataField

  Purpose:      Session Property Static Decimal Combo SmartDataField
...
DEFINE VARIABLE coCombo AS DECIMAL FORMAT "->>>>>>>>>>>>>>>>>9.999999999":U INITIAL 0 
     ...
     LIST-ITEM-PAIRS "",0
     DROP-DOWN-LIST
     SIZE 82.8 BY 1.05 NO-UNDO.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME frMain
     coCombo AT ROW 1 COL 17.8 COLON-ALIGNED
...
ON VALUE-CHANGED OF coCombo IN FRAME frMain /* Session Property */
DO:
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  ASSIGN
    ...
    ttComboData.cForEach = "FOR EACH gsc_session_property NO-LOCK BY gsc_session_property.session_property_name":U
    ttComboData.cBufferList = "gsc_session_property":U
    ttComboData.cKeyFieldName = "gsc_session_property.session_property_obj":U
    ttComboData.cDescFieldNames = "gsc_session_property.session_property_name,gsc_session_property.session_property_description":U
