...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/08/2004" version_time="55522" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="124354.9875" record_version_obj="124355.9875" version_number_seq="2.19" secondary_key_value="gsmuslog2p#CHR(1)#0" import_version_number_seq="2.19"><smartobject_obj>124354.9875</smartobject_obj>
