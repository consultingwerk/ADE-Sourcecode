...
/*---------------------------------------------------------------------------------
  ...
  Description:  gsc_global_control Data Logic Procedure Library Template

  Purpose:      A procedure library (PLIP) to support the maintenance of the gsc_global_control table
...
&GLOB DATA-LOGIC-TABLE gsc_global_control
&GLOB DATA-FIELD-DEFS  "af/obj2/gscgcfullo.i"
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN cDescription = "gsc_global_control Data Logic Procedure".
