...
/*---------------------------------------------------------------------------------
  ...
  Description:  Login Company SDF Combo

  Purpose:      Login Company SmartDataField Combo
  ...
  (v:010000)    Task:    90000009   UserRef:    POSSE
                Date:   16/03/2001  Author:     Phillip Magnay

  Update Notes: Created from Template rysttdcsfv.w

  (v:010101)    Task:    90000012   UserRef:    posse
                Date:   30/03/2001  Author:     Tammy St Pierre

  Update Notes: Created Login Company SDF
...
&scop object-name       gsmlgdcsfv.w
DEFINE VARIABLE lv_this_object_name AS CHARACTER INITIAL "{&object-name}":U NO-UNDO.
&scop object-version    010101
...
DEFINE VARIABLE coCombo AS DECIMAL FORMAT "->>>>>>>>>>>>>>>>>9.999999999":U INITIAL 0 
     ...
     LIST-ITEM-PAIRS "",0
     DROP-DOWN-LIST
     SIZE 84.6 BY 1 NO-UNDO.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME frMain
     coCombo AT ROW 1 COL 18.6 COLON-ALIGNED
...
ON VALUE-CHANGED OF coCombo IN FRAME frMain /* Login Company */
DO:
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  ASSIGN
    ...
    ttComboData.cForEach = "FOR EACH gsm_login_company NO-LOCK BY gsm_login_company.login_company_code":U
    ttComboData.cBufferList = "gsm_login_company":U
    ttComboData.cKeyFieldName = "gsm_login_company.login_company_obj":U
    ttComboData.cDescFieldNames = "gsm_login_company.login_company_code,gsm_login_company.login_company_short_name":U
