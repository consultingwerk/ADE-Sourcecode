...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" deletion_flag="no" entity_mnemonic="rycso" import_version_number_seq="12.48" key_field_value="3000031496.09" record_version_obj="3000031497.09" secondary_key_value="gscotlogcp#CHR(1)#0" version_date="07/14/2005" version_number_seq="12.48" version_time="49559" version_user="admin"><smartobject_obj>3000031496.09</smartobject_obj>
