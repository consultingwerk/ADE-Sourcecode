...
DEFINE FRAME frMain
     RowObject.object_type_code AT ROW 1 COL 26 COLON-ALIGNED
          LABEL "Object type code" FORMAT "X(30)"
          VIEW-AS FILL-IN 
          SIZE 55.4 BY 1
     ...
     RowObject.static_object AT ROW 10.52 COL 27.8
          ...
          VIEW-AS TOGGLE-BOX
          SIZE 17.2 BY 1
     RowObject.cache_on_client AT ROW 10.52 COL 54
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN adjustTabOrder ( hClassObjectName ,
             RowObject.cache_on_client:HANDLE IN FRAME frMain , 'AFTER':U ).
