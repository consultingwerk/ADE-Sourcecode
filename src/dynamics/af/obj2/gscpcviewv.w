...
/*---------------------------------------------------------------------------------
  ...
  Description:  Profile Code SmartDataViewer

  Purpose:      Profile Code Static SmartDataViewer
...
&Scoped-Define ENABLED-FIELDS RowObject.profile_code ~
...
DEFINE FRAME frMain
     RowObject.profile_code AT ROW 1 COL 22 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 24 BY 1
     RowObject.profile_description AT ROW 2.1 COL 22 COLON-ALIGNED
          LABEL "Profile description"
          VIEW-AS FILL-IN 
          SIZE 78.4 BY 1
     RowObject.profile_narrative AT ROW 3.19 COL 24 NO-LABEL
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "af/obj2/gscpcfullo.w"
...
/* SETTINGS FOR FILL-IN RowObject.profile_code IN FRAME frMain
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN RowObject.profile_description IN FRAME frMain
   EXP-LABEL                                                            */
/* SETTINGS FOR EDITOR RowObject.profile_narrative IN FRAME frMain
   EXP-LABEL                                                            */
