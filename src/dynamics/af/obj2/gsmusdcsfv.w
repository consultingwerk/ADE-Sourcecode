...
/*---------------------------------------------------------------------------------
  ...
  Description:  User Smart Data Field

  Purpose:      Smart Data Field for looking up User ID
  ...
  (v:010000)    Task:    90000011   UserRef:    POSSE
                Date:   07/04/2001  Author:     Phil Magnay
...
ON VALUE-CHANGED OF coCombo IN FRAME frMain /* User ID */
DO:
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  ASSIGN
    ...
    ttComboData.cForEach = "FOR EACH gsm_user NO-LOCK BY gsm_user.user_login_name":U
    ttComboData.cBufferList = "gsm_user":U
    ttComboData.cKeyFieldName = "gsm_user.user_obj":U
    ttComboData.cDescFieldNames = "gsm_user.user_login_name,gsm_user.layout_name":U
