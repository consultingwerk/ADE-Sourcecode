...
&Scoped-Define ENABLED-FIELDS  session_type_obj startup_order manager_type_obj system_owned
&Scoped-define ENABLED-FIELDS-IN-gsm_required_manager session_type_obj ~
startup_order manager_type_obj system_owned 
&Scoped-Define DATA-FIELDS  required_manager_obj session_type_obj session_type_code startup_order~
 manager_type_obj manager_type_code system_owned
&Scoped-define DATA-FIELDS-IN-gsm_required_manager required_manager_obj ~
session_type_obj startup_order manager_type_obj system_owned 
...
gsm_session_type gsc_manager_type
...
DEFINE QUERY Query-Main FOR 
    ...
    FIELDS(gsm_session_type.session_type_code), 
      gsc_manager_type
    FIELDS(gsc_manager_type.manager_type_code) SCROLLING.
&ANALYZE-RESUME
{&DB-REQUIRED-END}
...
/* Query rebuild information for SmartDataObject Query-Main
     _TblList          = "icfdb.gsm_required_manager,icfdb.gsm_session_type WHERE icfdb.gsm_required_manager ...,icfdb.gsc_manager_type WHERE icfdb.gsm_required_manager ..."
...
"manager_type_code" "manager_type_code" ? ? "character" ? ? ? ? ? ? no ? no 56 yes
     _FldNameList[7]   > icfdb.gsm_required_manager.system_owned
