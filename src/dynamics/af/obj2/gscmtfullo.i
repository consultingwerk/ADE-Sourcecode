  ...
  FIELD db_bound_smartobject_obj LIKE gsc_manager_type.db_bound_smartobject_obj~
  FIELD db_unbound_smartobject_obj LIKE gsc_manager_type.db_unbound_smartobject_obj
