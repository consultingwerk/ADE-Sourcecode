...
&Scoped-Define ENABLED-OBJECTS fiDBName coNetwork fiHost fiService EdEditor 
&Scoped-Define DISPLAYED-OBJECTS fiDBName coNetwork fiHost fiService ~
EdEditor 
...
DEFINE FRAME frMain
     ...
     EdEditor AT ROW 6.71 COL 1.4 NO-LABEL
