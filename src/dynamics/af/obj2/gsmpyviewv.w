...
/*
    This code was originally included in this procedure, but an alteration to the code that initially
    establishes the contents of AllFieldNames and AllFieldHandles seems to mean that the AllFieldHandles
    property no longer contains the handle of the persistent procedure that is the connections field.
    
    I have deliberately left this code in here as if AllFieldNames and AllFieldHandles are later modified,
    it may be necessary to change this code back.
    
    See IssueZilla issue 1412 for more information. - Bruce Gruenbaum
...
-------------------------------------------------------------*/
  RUN "af\obj2\gscstdcsfv.w *RTB-SmObj* ".
  RUN "af\obj2\gsmpydatfv.w *RTB-SmObj* ".
