...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="10/08/2003" version_time="65700" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="1004910247.09" record_version_obj="3000001827.09" version_number_seq="5.09" secondary_key_value="gsmomfullo.w#CHR(1)#0" import_version_number_seq="5.09"><smartobject_obj>1004910247.09</smartobject_obj>
