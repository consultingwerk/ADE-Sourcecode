...
/*---------------------------------------------------------------------------------
  ...
  Description:  gsc_security_control Data Logic Procedure Library Template
 
  Purpose:      A procedure library (PLIP) to support the maintenance of the gsc_security_control table
...
&GLOB DATA-LOGIC-TABLE gsc_security_control
&GLOB DATA-FIELD-DEFS  "af/obj2/gscscful2o.i"
