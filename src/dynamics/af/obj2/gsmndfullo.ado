...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="10/08/2003" version_time="65714" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="1005096014.101" record_version_obj="3000033149.09" version_number_seq="3.09" secondary_key_value="gsmndfullo.w#CHR(1)#0" import_version_number_seq="3.09"><smartobject_obj>1005096014.101</smartobject_obj>
