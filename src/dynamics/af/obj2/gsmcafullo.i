  ...
  FIELD related_entity_mnemonic LIKE gsm_category.related_entity_mnemonic VALIDATE  LABEL "Related Entity"~
  ...
  FIELD owning_entity_mnemonic LIKE gsm_category.owning_entity_mnemonic VALIDATE  LABEL "Owning Entity"~
