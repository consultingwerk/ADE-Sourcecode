...
/*---------------------------------------------------------------------------------
  ...
  Description:  Language SDF

  Purpose:      Language SDF

  Parameters:   <none>

  History:
  --------
  (v:010000)    Task:    90000004   UserRef:    
                Date:   13/03/2001  Author:     Bruce Gruenbaum
...
ON VALUE-CHANGED OF coCombo IN FRAME frMain /* Language */
DO:
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  ASSIGN
    ...
    ttComboData.cDescFieldNames = "gsc_language.language_code,gsc_language.language_name":U
