...
/*---------------------------------------------------------------------------------
  ...
  Description:  Instance Attribute SmartDataViewer

  Purpose:      Instance Attribute Static SmartDataViewer
...
&Scoped-Define ENABLED-FIELDS RowObject.attribute_code ~
...
DEFINE FRAME frMain
     RowObject.attribute_code AT ROW 1 COL 23 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 78.4 BY 1
     RowObject.attribute_description AT ROW 2.1 COL 23 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 78.4 BY 1
     RowObject.attribute_type AT ROW 3.19 COL 23 COLON-ALIGNED
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "af/obj2/gsciafullo.w"
