...
ON VALUE-CHANGED OF coCombo IN FRAME frMain /* Manager Type */
DO:
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  ASSIGN
    ...
    ttComboData.cForEach = "FOR EACH gsc_manager_type NO-LOCK BY gsc_manager_type.manager_type_code":U
    ttComboData.cBufferList = "gsc_manager_type":U
    ttComboData.cKeyFieldName = "gsc_manager_type.manager_type_obj":U
    ttComboData.cDescFieldNames = "gsc_manager_type.manager_type_code,gsc_manager_type.manager_type_name":U
