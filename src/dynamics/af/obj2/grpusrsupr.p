...
"Super Procedure for Security Group User Allocations"
*/
&ANALYZE-RESUME
...
/*---------------------------------------------------------------------------------
  ...
  Description:  Security Group User Allocations
...
------------------------------------------------------------------------------*/
  ...
  {dynlaunch.i 
            ...
            &iProc    = "'getAllocatedUsers'"              
            &OnApp    = YES
            &AutoKill = YES
            &mode1    = INPUT  &parm1  = gdGroupObj         &dataType1  = DECIMAL
