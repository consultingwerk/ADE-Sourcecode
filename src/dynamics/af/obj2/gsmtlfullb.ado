...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/20/2003" version_time="80496" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="1004825310.09" record_version_obj="3000047902.09" version_number_seq="4.09" secondary_key_value="gsmtlfullb#CHR(1)#0" import_version_number_seq="4.09"><smartobject_obj>1004825310.09</smartobject_obj>
...
<contained_record DB="icfdb" Table="ryc_attribute_value"><attribute_value_obj>3000047901.09</attribute_value_obj>
<object_type_obj>1003498159</object_type_obj>
...
<character_value>15#CHR(5)#35#CHR(5)#35#CHR(5)#70#CHR(5)#12#CHR(5)#28#CHR(5)#28#CHR(5)#70#CHR(5)#70</character_value>
