...
object_type_description disabled layout_supported 
...
"object_type_obj" "object_type_obj" ? ? "decimal" ? ? ? ? ? ? no ? no 21 yes
     _FldNameList[2]   > icfdb.gsc_object_type.object_type_code
"object_type_code" "object_type_code" ? ? "character" ? ? ? ? ? ? yes ? no 30 yes
     _FldNameList[3]   > icfdb.gsc_object_type.object_type_description
"object_type_description" "object_type_description" ? ? "character" ? ? ? ? ? ? yes ? no 70 yes
...
"layout_supported" "layout_supported" ? ? "logical" ? ? ? ? ? ? yes ? no 1 yes
