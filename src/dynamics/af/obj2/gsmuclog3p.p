...
/*---------------------------------------------------------------------------------
  ...
  Description:  gsm_user_category Data Logic Procedure Library Template
 
  Purpose:      A procedure library (PLIP) to support the maintenance of the gsm_user_category table
...
&GLOB DATA-LOGIC-TABLE gsm_user_category
&GLOB DATA-FIELD-DEFS  "af/obj2/gsmucful3o.i"
