...
/*---------------------------------------------------------------------------------
  ...
  Description:  gsm_user_allocation Data Logic Procedure Library Template

  Purpose:      A procedure library (PLIP) to support the maintenance of the gsm_user_allocation table
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN cDescription = "Dynamics gsm_user_allocation Data Logic Procedure".
...
------------------------------------------------------------------------------*/
  ...
  IF b_gsm_user_allocation.login_organisation_obj = 0 OR b_gsm_user_allocation.login_organisation_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {af/sup2/aferrortxt.i 'AF' '1' 'gsm_user_allocation' 'login_organisation_obj' "'Login Organisation Obj'"}.

  IF b_gsm_user_allocation.user_obj = 0 OR b_gsm_user_allocation.user_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {af/sup2/aferrortxt.i 'AF' '1' 'gsm_user_allocation' 'user_obj' "'User Obj'"}.

  IF LENGTH(b_gsm_user_allocation.owning_entity_mnemonic) = 0 OR LENGTH(b_gsm_user_allocation.owning_entity_mnemonic) = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {af/sup2/aferrortxt.i 'AF' '1' 'gsm_user_allocation' 'owning_entity_mnemonic' "'Owning Entity Mnemonic'"}.

  IF b_gsm_user_allocation.owning_obj = 0 OR b_gsm_user_allocation.owning_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {af/sup2/aferrortxt.i 'AF' '1' 'gsm_user_allocation' 'owning_obj' "'Owning Obj'"}.
