...
/*---------------------------------------------------------------------------------
  ...
  Description:  Logical Service SmartDataViewer

  Purpose:      Logical Service Static SmartDataViewer
...
&Scoped-Define ENABLED-FIELDS RowObject.logical_service_code ~
...
DEFINE FRAME frMain
     ...
     RowObject.logical_service_description AT ROW 2.05 COL 32.2 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN 
          SIZE 78.4 BY 1
     RowObject.can_run_locally AT ROW 4.14 COL 34.2
          LABEL "Can run locally"
          VIEW-AS TOGGLE-BOX
          SIZE 20.6 BY 1
     RowObject.system_owned AT ROW 5.19 COL 34.2
          LABEL "System owned"
          VIEW-AS TOGGLE-BOX
          SIZE 19.2 BY 1
     RowObject.write_to_config AT ROW 6.24 COL 34.2
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "af/obj2/gsclsfullo.w"
