...
/*---------------------------------------------------------------------------------
  ...
  Description:  User Category combo

  Purpose:      Combo for User Category
...
DEFINE FRAME frMain
     coCombo AT ROW 1 COL 15.4 COLON-ALIGNED
...
ON VALUE-CHANGED OF coCombo IN FRAME frMain /* User Category */
DO:
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  ASSIGN
      ...
      ttComboData.cForEach = "FOR EACH gsm_user_category NO-LOCK":U
      ttComboData.cBufferList = "gsm_user_category":U
      ttComboData.cKeyFieldName = "gsm_user_category.user_category_obj":U
      ttComboData.cDescFieldNames = "gsm_user_category.user_category_code,gsm_user_category.user_category_description":U
