...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/20/2003" version_time="80495" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="1004930428.09" record_version_obj="3000047914.09" version_number_seq="5.09" secondary_key_value="gscdefullb#CHR(1)#0" import_version_number_seq="5.09"><smartobject_obj>1004930428.09</smartobject_obj>
...
<contained_record DB="icfdb" Table="ryc_attribute_value"><attribute_value_obj>3000047915.09</attribute_value_obj>
<object_type_obj>1003498159</object_type_obj>
...
<character_value>13#CHR(5)#8#CHR(5)#15#CHR(5)#12#CHR(5)#9#CHR(5)#70#CHR(5)#120#CHR(5)#21#CHR(5)#18#CHR(5)#17</character_value>
...
<character_value>dataset_code,entity_mnemonic,entity_sequence,primary_entity,join_entity_mnemonic,join_field_list,filter_where_clause,delete_related_records,keep_own_site_data,overwrite_records</character_value>
<integer_value>0</integer_value>
<date_value>?</date_value>
<decimal_value>0</decimal_value>
<logical_value>no</logical_value>
