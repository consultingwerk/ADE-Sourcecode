...
/*---------------------------------------------------------------------------------
  ...
  Description:  Session Type Combo SmartDataField

  Purpose:      Session Type Static Combo SmartDataField
  ...
  (v:010001)    Task:    90000035   UserRef:    posse
                Date:   17/04/2001  Author:     Tammy St Pierre

  Update Notes: Changed desc
...
DEFINE FRAME frMain
     coCombo AT ROW 1 COL 16.8 COLON-ALIGNED
...
ON VALUE-CHANGED OF coCombo IN FRAME frMain /* Session Type */
DO:
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  ASSIGN
    ...
    ttComboData.cForEach = "FOR EACH gsm_session_type NO-LOCK BY gsm_session_type.session_type_code":U
    ttComboData.cBufferList = "gsm_session_type":U
    ttComboData.cKeyFieldName = "gsm_session_type.session_type_obj":U
    ttComboData.cDescFieldNames = "gsm_session_type.session_type_code,gsm_session_type.session_type_description":U
