...
/*---------------------------------------------------------------------------------
  ...
  Description:  Physical Service Combo SmartDataField

  Purpose:      Physical Service Static Combo SmartDataField
...
DEFINE FRAME frMain
     coCombo AT ROW 1 COL 21.8 COLON-ALIGNED
...
ON VALUE-CHANGED OF coCombo IN FRAME frMain /* Physical Service */
DO:
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  ASSIGN
    ...
    ttComboData.cForEach = "FOR EACH gsm_physical_service NO-LOCK BY gsm_physical_service.physical_service_code":U
    ttComboData.cBufferList = "gsm_physical_service":U
    ttComboData.cKeyFieldName = "gsm_physical_service.physical_service_obj":U
    ttComboData.cDescFieldNames = "gsm_physical_service.physical_service_code,gsm_physical_service.physical_service_description":U
