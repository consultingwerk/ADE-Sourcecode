...
DEFINE FRAME frMain
     ...
     fiBandDesc AT ROW 3.14 COL 18.8 COLON-ALIGNED NO-LABEL
     RowObject.menu_structure_sequence AT ROW 4.14 COL 18.8 COLON-ALIGNED
          LABEL "Band sequence"
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     RowObject.menu_structure_spacing AT ROW 5.24 COL 18.8 COLON-ALIGNED
          LABEL "Band spacing"
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     RowObject.menu_structure_alignment AT ROW 6.33 COL 5
          LABEL "Band alignment"
          VIEW-AS COMBO-BOX 
          LIST-ITEMS "LEFT","RIGHT","CENTER" 
          DROP-DOWN-LIST
          SIZE 17 BY 1
     RowObject.insert_rule AT ROW 7.38 COL 20.6
