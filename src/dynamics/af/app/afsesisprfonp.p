...
/*---------------------------------------------------------------------------------
  File: afsesisprfonp.p

  Description:  isProfilingOn AppServer Proxy

  Purpose:      isProfilingOn AppServer Proxy
...
&scop object-name       afsesisprfonp.p
...
/* ***************************  Main Block  *************************** */
 ...
 RUN isProfilingOn IN gshSessionManager
   (INPUT  plRunOnServer,   
