...
*********************************************************************/
/*---------------------------------------------------------------------------------
  File: afttglobalctrl.i

  Description:  Global Control temp-table

  Purpose:      Global Control temp-table
...
&scop object-name       afttglobalctrl.i
...
&IF DEFINED(ttGlobalCtrl) = 0 &THEN
  DEFINE TEMP-TABLE ttGlobalControl NO-UNDO LIKE gsc_global_control.
  &GLOBAL-DEFINE ttGlobalCtrl
&ENDIF
