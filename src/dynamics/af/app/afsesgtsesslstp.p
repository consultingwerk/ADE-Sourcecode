...
/*---------------------------------------------------------------------------------
  File: afsesgtsesslstp.p

  Description:  getSessionList AppServer Proxy

  Purpose:      getSessionList AppServer Proxy
  ...
  (v:010000)    Task:           0   UserRef:    
                Date:   09/13/2003  Author:     Bruce S Gruenbaum
...
&scop object-name       afsesgtsesslstp.p
