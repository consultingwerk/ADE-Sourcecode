...
/*---------------------------------------------------------------------------------
  ...
  Description:  changePassword AppServer Proxy

  Purpose:      changePassword AppServer Proxy
...
&scop object-name       afsecchgpwdp.p
...
/* ***************************  Main Block  *************************** */
  ...
  RUN changePassword IN gshSecurityManager
    (INPUT pdUserObj,
     INPUT pcLoginName,
     INPUT pcOldPassword,
     INPUT pcNewPassword,
