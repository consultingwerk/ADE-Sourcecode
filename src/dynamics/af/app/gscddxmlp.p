...
------------------------------------------------------------------------------*/
  ...
  FOR EACH bgst_release_version NO-LOCK
    ...
    DO:
      ...
      CREATE BUFFER hBuffer FOR TABLE bgsc_entity_mnemonic.entity_dbname + ".":U + bgsc_entity_mnemonic.entity_mnemonic_description.
    END.
  ...
  FOR EACH bttTable
    ...
    REPEAT WHILE NOT hQuery:QUERY-OFF-END:
      ...
      DO TRANSACTION:
        ...
        DO:
          /* Build a for each statement for this buffer */
          CREATE BUFFER hDBBuff FOR TABLE bttTable.cDatabase + ".":U + bttTable.cTableName.
