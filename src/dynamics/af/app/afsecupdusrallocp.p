...
/*---------------------------------------------------------------------------------
  File: afsecupdusrallocp.p

  Description:  updateUserAllocations AppServer Proxy

  Purpose:      updateUserAllocations AppServer Proxy
...
&scop object-name       afsecupdusrallocp.p
