...
/*---------------------------------------------------------------------------------
  File: afgengtentdescp.p

  Description:  getEntityDescription AppServer Proxy

  Purpose:      getEntityDescription AppServer Proxy
...
&scop object-name       afgengtentdescp.p
...
/* ***************************  Main Block  *************************** */
      ...
      RUN getEntityDescription IN gshGenManager
