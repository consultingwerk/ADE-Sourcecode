...
/*---------------------------------------------------------------------------------
  ...
  Description:  Get session information from appserver

  Purpose:      Get session information from appserver

  Parameters:   OUTPUT pcNumericDecimalPoint 
                OUTPUT pcNumericSeparator    
                OUTPUT pcNumericFormat       
                OUTPUT pcDateFormat          
...
ASSIGN
  pcNumericDecimalPoint = SESSION:NUMERIC-DECIMAL-POINT
