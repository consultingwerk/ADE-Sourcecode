...
/*---------------------------------------------------------------------------------
  File: afsesdlactsessp.p

  Description:  deleteActiveSession AppServer Proxy

  Purpose:      deleteActiveSession AppServer Proxy
...
&scop object-name       afsesdlactsessp.p
...
/* ***************************  Main Block  *************************** */
  ...
  RUN deleteActiveSession IN gshSessionManager NO-ERROR.
