...
/*---------------------------------------------------------------------------------
  File: afprochkpedxp.p

  Description:  afchkpedxp AppServer Proxy

  Purpose:      afchkpedxp AppServer Proxy
...
&scop object-name       afprochkpedxp.p
...
/* ***************************  Main Block  *************************** */
    ...
    RUN afchkpdexp IN gshProfileManager
