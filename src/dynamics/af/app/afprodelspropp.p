...
/*---------------------------------------------------------------------------------
  File: afprodelspropp.p

  Description:  afdelsprop AppServer Proxy

  Purpose:      afdelsprop AppServer Proxy
...
&scop object-name       afprodelspropp.p
...
RUN afdelsprop IN gshProfileManager NO-ERROR.
