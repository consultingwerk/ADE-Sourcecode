...
/*---------------------------------------------------------------------------------
  File: afgengtfltrsetclsp.p

  Description:  getFilterSetClause AppServer Proxy

  Purpose:      getFilterSetClause AppServer Proxy
...
&scop object-name       afgengtfltrsetclsp.p
...
/* ***************************  Main Block  *************************** */
        ...
        RUN getFilterSetClause IN gshGenManager
