...
/*---------------------------------------------------------------------------------
  File: afgengtentdispfldp.p

  Description:  getEntityDisplayField AppServer Proxy

  Purpose:      getEntityDisplayField AppServer Proxy
...
&scop object-name       afgengtentdispfldp.p
...
/* ***************************  Main Block  *************************** */
      ...
      RUN getEntityDisplayFields IN gshGenManager
