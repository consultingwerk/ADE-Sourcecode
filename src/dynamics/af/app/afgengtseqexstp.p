...
/*---------------------------------------------------------------------------------
  File: afgengtseqexstp.p

  Description:  getSequenceExist AppServer Proxy

  Purpose:      getSequenceExist AppServer Proxy
...
&scop object-name       afgengtseqexstp.p
...
/* ***************************  Main Block  *************************** */
        ...
        RUN getSequenceExist IN gshGenManager
               (INPUT pdCompanyObj,
