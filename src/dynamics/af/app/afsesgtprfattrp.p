...
/*---------------------------------------------------------------------------------
  File: afsesgtprfattrp.p

  Description:  getProfilerAttrs AppServer Proxy

  Purpose:      getProfilerAttrs AppServer Proxy
...
&scop object-name       afsesgtprfattrp.p
...
/* ***************************  Main Block  *************************** */
        ...
        RUN getProfilerAttrs IN gshSessionManager
          (INPUT  plRunOnServer, 
