          ...
          DO:
              ...
              DO:
                  ...
                  ELSE DO:
                     ...
                     ELSE
                         ASSIGN ttTranslate.hWidgetHandle:SIDE-LABEL-HANDLE:WIDTH-CHARS = 
                                FONT-TABLE:GET-TEXT-WIDTH-CHARS(ttTranslate.cTranslatedLabel, ttTranslate.hWidgetHandle:FONT)
  ...
  DO WHILE VALID-HANDLE (hWidget):
    ...
    DO:
      ASSIGN
        ...
        cFieldName = ENTRY(iFieldPos,cAllFieldNames) NO-ERROR.
    ...
    AND CAN-QUERY(hWidget, "DATA-TYPE":U) 
    AND LOOKUP(hWidget:DATA-TYPE, "DATE,DECIMAL,INTEGER":U) NE 0 
    ...
    DO:
      ...
      DO:
        ...
        AND hWidget:DATA-TYPE  EQ "INTEGER":U THEN 
        DO:
          ASSIGN hWidget = hWidget:NEXT-SIBLING.
          NEXT widget-walk.
        END.    /* integer default. */
