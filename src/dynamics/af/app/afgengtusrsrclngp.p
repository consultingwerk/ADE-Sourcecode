...
/*---------------------------------------------------------------------------------
  File: afgengtusrsrclngp.p

  Description:  getUserSourceLanguage AppServer Proxy

  Purpose:      getUserSourceLanguage AppServer Proxy
...
&scop object-name       afgengtusrsrclngp.p
...
RUN getUserSourceLanguage IN gshGenManager
       (INPUT pdUserObj,
