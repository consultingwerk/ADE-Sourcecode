...
/*---------------------------------------------------------------------------------
  File: afsesdelsessp.p

  Description:  deleteSession AppServer Proxy

  Purpose:      deleteSession AppServer Proxy
  ...
  (v:010000)    Task:           0   UserRef:    
                Date:   08/13/2003  Author:     Bruce S Gruenbaum
...
&scop object-name       afsesdelsessp.p
...
RUN deleteSession IN gshSessionManager
