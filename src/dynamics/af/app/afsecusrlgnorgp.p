...
/*---------------------------------------------------------------------------------
  File: afsecusrlgnorgp.p

  Description:  userLoginOrganisations AppServer Proxy

  Purpose:      userLoginOrganisations AppServer Proxy
...
&scop object-name       afsecusrlgnorgp.p
...
/* ***************************  Main Block  *************************** */
  ...
  RUN userLoginOrganisations IN gshSecurityManager
    (INPUT  pdUserObj,   
