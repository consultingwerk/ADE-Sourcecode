...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="08/04/2003" version_time="42652" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="902234.24" record_version_obj="902235.24" version_number_seq="3.24" secondary_key_value="afsecupdusrallocp#CHR(1)#0" import_version_number_seq="3.24"><smartobject_obj>902234.24</smartobject_obj>
<object_filename>afsecupdusrallocp</object_filename>
...
<object_description>updateUserAllocations AppServer Proxy</object_description>
...
<security_smartobject_obj>902234.24</security_smartobject_obj>
