...
/*---------------------------------------------------------------------------------
  File: afgengtrecdetp.p

  Description:  getRecordDetail AppServer Proxy

  Purpose:      getRecordDetail AppServer Proxy

  Parameters:   pcQuery     - a valid for each ... query
                pcFieldList - returns a chr(3) seperated list of all fields in 
                              the query and their values

  History:
  --------
  (v:010000)    Task:           0   UserRef:    
                Date:   07/17/2003  Author:     
...
&scop object-name       afgengtrecdetp.p
