...
/*---------------------------------------------------------------------------------
  File: afgengtentexstp.p

  Description:  getEntityExists AppServer Proxy

  Purpose:      getEntityExists AppServer Proxy
...
&scop object-name       afgengtentexstp.p
...
/* ***************************  Main Block  *************************** */
RUN getEntityExists IN gshGenManager
     (INPUT pcTableName,
      INPUT pdTableObj,
      OUTPUT plExists,
