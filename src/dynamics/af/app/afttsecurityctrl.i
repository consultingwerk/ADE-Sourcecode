...
*********************************************************************/
/*---------------------------------------------------------------------------------
  File: afttsecurityctrl.i

  Description:  Security Control temp-table

  Purpose:      Security Control temp-table
...
&scop object-name       afttsecurityctrl.i
...
&IF DEFINED(ttSecurityCtrl) = 0 &THEN
  DEFINE TEMP-TABLE ttSecurityControl NO-UNDO LIKE gsc_security_control.
  &GLOBAL-DEFINE ttSecurityCtrl
&ENDIF
