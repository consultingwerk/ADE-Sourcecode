...
/*---------------------------------------------------------------------------------
  File: afseccrtgrpfusrp.p

  Description:  createGroupFromUser AppServer Proxy

  Purpose:      createGroupFromUser AppServer Proxy
...
&scop object-name       afseccrtgrpfusrp.p
...
/* ***************************  Main Block  *************************** */
  ...
  RUN createGroupFromUser IN gshSecurityManager
    (INPUT  pdUserObj,
