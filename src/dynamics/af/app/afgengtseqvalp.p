...
/*---------------------------------------------------------------------------------
  File: afgengtseqvalp.p

  Description:  getSequenceValue AppServer Proxy

  Purpose:      getSequenceValue AppServer Proxy
...
&scop object-name       afgengtseqvalp.p
...
/* ***************************  Main Block  *************************** */
	...
	RUN getSequenceValue IN gshGenManager
	       (INPUT pdCompanyObj,
