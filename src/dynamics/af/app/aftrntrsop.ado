...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/05/2003" version_time="50865" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="62.48" record_version_obj="63.48" version_number_seq="2.48" secondary_key_value="aftrntrsop#CHR(1)#0" import_version_number_seq="2.48"><smartobject_obj>62.48</smartobject_obj>
