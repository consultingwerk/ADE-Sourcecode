...
/*---------------------------------------------------------------------------------
  File: afsescrtctxtscpp.p

  Description:  createContextScope AppServer Proxy

  Purpose:      createContextScope AppServer Proxy
...
&scop object-name       afsescrtctxtscpp.p
...
/* ***************************  Main Block  *************************** */
  ...
  RUN createContextScope IN gshSessionManager
