...
/*---------------------------------------------------------------------------------
  File: afseccrtgrpallocp.p

  Description:  createGroupAllocation AppServer Proxy

  Purpose:      createGroupAllocation AppServer Proxy
...
&scop object-name       afseccrtgrpallocp.p
...
/* ***************************  Main Block  *************************** */
  ...
  RUN createGroupAllocation IN gshSecurityManager
    (INPUT  pdUserObj,
