...
/*---------------------------------------------------------------------------------
  File: afgengsgetstatpp.p

  Description:  gsgetstatp AppServer Proxy

  Purpose:      gsgetstatp AppServer Proxy
...
&scop object-name       afgengsgetstatpp.p
...
/* ***************************  Main Block  *************************** */
    	...
    	RUN gsgetstatp IN gshGenManager
