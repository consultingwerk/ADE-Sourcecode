...
/*---------------------------------------------------------------------------------
  File: afsecgtmndtblp.p

  Description:  getMandatoryTables AppServer Proxy

  Purpose:      getMandatoryTables AppServer Proxy
...
&scop object-name       afsecgtmndtblp.p
...
/* ***************************  Main Block  *************************** */
      ...
      RUN getMandatoryTables IN gshSecurityManager
        (INPUT  pcFieldName,
