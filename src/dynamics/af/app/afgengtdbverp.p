...
/*---------------------------------------------------------------------------------
  File: afgengtdbverp.p

  Description:  getDBVersion AppServer Proxy

  Purpose:      getDBVersion AppServer Proxy
...
&scop object-name       afgengtdbverp.p
...
/* ***************************  Main Block  *************************** */
    ...
    RUN getDBVersion IN gshGenManager
