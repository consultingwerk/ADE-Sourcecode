...
/*---------------------------------------------------------------------------------
  File: afsecfldsecchkp.p

  Description:  fieldSecurityCheck AppServer Proxy

  Purpose:      fieldSecurityCheck AppServer Proxy
...
&scop object-name       afsecfldsecchkp.p
...
/* ***************************  Main Block  *************************** */
      ...
      RUN fieldSecurityCheck IN gshSecurityManager
        (INPUT  pcObjectName,
