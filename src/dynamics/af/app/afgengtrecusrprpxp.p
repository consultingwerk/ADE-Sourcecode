...
/*---------------------------------------------------------------------------------
  File: afgengtrecusrprpxp.p

  Description:  getRecordUserPropx AppServer Proxy

  Purpose:      getRecordUserPropx AppServer Proxy
...
&scop object-name       afgengtrecusrprpxp.p
...
/* ***************************  Main Block  *************************** */
	...
	RUN getRecordUserPropx IN gshGenManager
