...
/*---------------------------------------------------------------------------------
  File: afgengtrecchkcmntp.p

  Description:  getRecordCheckComment AppServer Proxy

  Purpose:      getRecordCheckComment AppServer Proxy
  ...
  (v:010000)    Task:           0   UserRef:    
                Date:   07/17/2003  Author:     Bruce S Gruenbaum
...
&scop object-name       afgengtrecchkcmntp.p
...
/* ***************************  Main Block  *************************** */
 RUN getRecordCheckComment IN gshGenManager
