...
/*---------------------------------------------------------------------------------
  File: aftrnupdmtrnp.p

  Description:  afupdmtrnp AppServer Proxy

  Purpose:      afupdmtrnp AppServer Proxy
...
&scop object-name       aftrnupdmtrnp.p
...
/* ***************************  Main Block  *************************** */
  ...
  RUN afupdmtrnp IN gshTranslationManager
