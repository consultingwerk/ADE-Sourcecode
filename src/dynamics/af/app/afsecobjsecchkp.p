...
/*---------------------------------------------------------------------------------
  File: afsecobjsecchkp.p

  Description:  objectSecurityCheck AppServer Proxy

  Purpose:      objectSecurityCheck AppServer Proxy
...
&scop object-name       afsecobjsecchkp.p
...
/* ***************************  Main Block  *************************** */
  RUN objectSecurityCheck IN gshSecurityManager
