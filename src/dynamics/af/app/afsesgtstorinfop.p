...
/*---------------------------------------------------------------------------------
  File: afsesgtstorinfop.p

  Description:  getSessTypeOverrideInfo AppServer Proxy

  Purpose:      getSessTypeOverrideInfo AppServer Proxy
...
&scop object-name       afsesgtstorinfop.p
