...
/*---------------------------------------------------------------------------------
  File: afgengtrecchkaudp.p

  Description:  getRecordCheckAudit AppServer Proxy

  Purpose:      getRecordCheckAudit AppServer Proxy
...
&scop object-name       afgengtrecchkaudp.p
...
/* ***************************  Main Block  *************************** */
     ...
     RUN getRecordCheckAudit IN gshGenManager
