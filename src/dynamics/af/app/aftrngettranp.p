...
/*---------------------------------------------------------------------------------
  File: aftrngettranp.p

  Description:  afgettranp AppServer Proxy

  Purpose:      afgettranp AppServer Proxy
...
&scop object-name       aftrngettranp.p
...
/* ***************************  Main Block  *************************** */
  RUN afgettranp IN gshTranslationManager
    (INPUT pdLanguageObj,      
     INPUT pcWidgetType,       
     INPUT pcWidgetName,       
     INPUT pcWidgetEntry,      
