...
/*---------------------------------------------------------------------------------
  File: afsecrngsecchkp.p

  Description:  rangeSecurityCheck AppServer Proxy
  ...
  Notes:       See Security Documentation for full information.
...
&scop object-name       afsecrngsecchkp.p
...
/* ***************************  Main Block  *************************** */
      RUN rangeSecurityCheck IN gshSecurityManager
        (INPUT  pcRangeCode,
         INPUT  pcObjectName,   
