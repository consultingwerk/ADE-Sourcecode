...
/*---------------------------------------------------------------------------------
  File: afsecauthuserp.p

  Description:  authenticateUser AppServer Proxy

  Purpose:      authenticateUser AppServer Proxy
  ...
  (v:010000)    Task:           0   UserRef:    
                Date:   08/28/2003  Author:     Bruce S Gruenbaum
...
&scop object-name       afsecauthuserp.p
