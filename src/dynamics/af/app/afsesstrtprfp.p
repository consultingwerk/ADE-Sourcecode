...
/*---------------------------------------------------------------------------------
  File: afsesstrtprfp.p

  Description:  startProfiling AppServer Proxy

  Purpose:      startProfiling AppServer Proxy
...
&scop object-name       afsesstrtprfp.p
...
/* ***************************  Main Block  *************************** */
   ...
   RUN startProfiling IN gshSessionManager
