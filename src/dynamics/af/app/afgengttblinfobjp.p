...
/*---------------------------------------------------------------------------------
  File: afgengttblinfobjp.p

  Description:  getTableInfoObj AppServer Proxy

  Purpose:      getTableInfoObj AppServer Proxy
...
&scop object-name       afgengttblinfobjp.p
...
/* ***************************  Main Block  *************************** */
    	...
    	RUN getTableInfoObj IN gshGenManager
