...
TRIGGER PROCEDURE FOR CREATE OF ryc_render_type .
...
ASSIGN ryc_render_type.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "ryc_render_type|the specified object number.  Please ensure your database sequences have been set correctly":U.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "rycrt":U, INPUT BUFFER ryc_render_type:HANDLE, INPUT BUFFER o_ryc_render_type:HANDLE).
