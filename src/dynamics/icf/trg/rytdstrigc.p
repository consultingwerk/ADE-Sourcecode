...
TRIGGER PROCEDURE FOR CREATE OF ryt_dbupdate_status .
...
/* gsm_user updated ryt_dbupdate_status ON CHILD INSERT SET NULL */
IF NOT(CAN-FIND(FIRST gsm_user WHERE
    ryt_dbupdate_status.run_by_user_obj = gsm_user.user_obj)) THEN
  DO:
...
ASSIGN ryt_dbupdate_status.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "ryt_dbupdate_status|the specified object number.  Please ensure your database sequences have been set correctly":U.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "rytds":U, INPUT BUFFER ryt_dbupdate_status:HANDLE, INPUT BUFFER o_ryt_dbupdate_status:HANDLE).
