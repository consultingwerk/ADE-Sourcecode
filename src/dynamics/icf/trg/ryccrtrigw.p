...
TRIGGER PROCEDURE FOR WRITE OF ryc_customization_result OLD BUFFER o_ryc_customization_result.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afpropfrmp.p (INPUT BUFFER ryc_customization_result:HANDLE).
  



/* Generated by ICF ERwin Template */
/* ryc_customization_type supports ryc_customization_result ON CHILD UPDATE RESTRICT */
IF NEW ryc_customization_result OR  ryc_customization_result.customization_type_obj <> o_ryc_customization_result.customization_type_obj  THEN
  DO:
    IF NOT(CAN-FIND(FIRST ryc_customization_type WHERE
        ryc_customization_result.customization_type_obj = ryc_customization_type.customization_type_obj)) THEN
              DO:
                ...
                ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 103 lv-include = "ryc_customization_result|ryc_customization_type":U.
...
IF NOT NEW ryc_customization_result AND ryc_customization_result.{&TRIGGER_OBJ} <> o_ryc_customization_result.{&TRIGGER_OBJ} THEN
    DO:
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "WRITE":U, INPUT "ryccr":U, INPUT BUFFER ryc_customization_result:HANDLE, INPUT BUFFER o_ryc_customization_result:HANDLE).
