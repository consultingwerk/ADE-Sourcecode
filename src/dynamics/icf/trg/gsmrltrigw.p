...
TRIGGER PROCEDURE FOR WRITE OF gsm_release OLD BUFFER o_gsm_release.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afpropfrmp.p (INPUT BUFFER gsm_release:HANDLE).
...
IF NOT NEW gsm_release AND gsm_release.{&TRIGGER_OBJ} <> o_gsm_release.{&TRIGGER_OBJ} THEN
    DO:
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "WRITE":U, INPUT "gsmrl":U, INPUT BUFFER gsm_release:HANDLE, INPUT BUFFER o_gsm_release:HANDLE).
