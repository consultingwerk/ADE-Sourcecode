...
TRIGGER PROCEDURE FOR CREATE OF gsc_delivery_method .
...
ASSIGN gsc_delivery_method.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "gsc_delivery_method|the specified object number.  Please ensure your database sequences have been set correctly":U.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "gscdm":U, INPUT BUFFER gsc_delivery_method:HANDLE, INPUT BUFFER o_gsc_delivery_method:HANDLE).
