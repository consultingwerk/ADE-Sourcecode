...
TRIGGER PROCEDURE FOR CREATE OF gsc_profile_code .
...
/* gsc_profile_type consists of gsc_profile_code ON CHILD INSERT RESTRICT */
IF 
    ( gsc_profile_code.profile_type_obj <> 0 ) THEN
  DO:
    IF NOT(CAN-FIND(FIRST gsc_profile_type WHERE
        ...
        DO:
          ...
          ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 102 lv-include = "gsc_profile_code|gsc_profile_type":U.
...
ASSIGN gsc_profile_code.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "gsc_profile_code|the specified object number.  Please ensure your database sequences have been set correctly":U.
    RUN error-message (lv-errgrp, lv-errnum, lv-include).
END.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "gscpc":U, INPUT BUFFER gsc_profile_code:HANDLE, INPUT BUFFER o_gsc_profile_code:HANDLE).
