...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afpropfrmp.p (INPUT BUFFER gsm_user_category:HANDLE).
...
IF NOT NEW gsm_user_category AND gsm_user_category.{&TRIGGER_OBJ} <> o_gsm_user_category.{&TRIGGER_OBJ} THEN
    DO:
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "WRITE":U, INPUT "gsmuc":U, INPUT BUFFER gsm_user_category:HANDLE, INPUT BUFFER o_gsm_user_category:HANDLE).
