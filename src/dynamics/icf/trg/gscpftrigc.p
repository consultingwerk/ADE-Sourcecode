...
TRIGGER PROCEDURE FOR CREATE OF gsc_profile_type .
...
ASSIGN gsc_profile_type.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "gsc_profile_type|the specified object number.  Please ensure your database sequences have been set correctly":U.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "gscpf":U, INPUT BUFFER gsc_profile_type:HANDLE, INPUT BUFFER o_gsc_profile_type:HANDLE).
