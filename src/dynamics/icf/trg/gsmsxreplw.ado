...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="05/28/2003" version_time="44517" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="3000050674.09" record_version_obj="3000050675.09" version_number_seq="3.09" secondary_key_value="gsmsxreplw#CHR(1)#0" import_version_number_seq="3.09"><smartobject_obj>3000050674.09</smartobject_obj>
