...
TRIGGER PROCEDURE FOR CREATE OF gsc_entity_mnemonic .
...
ASSIGN gsc_entity_mnemonic.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "gsc_entity_mnemonic|the specified object number.  Please ensure your database sequences have been set correctly":U.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "gscem":U, INPUT BUFFER gsc_entity_mnemonic:HANDLE, INPUT BUFFER o_gsc_entity_mnemonic:HANDLE).
