...
TRIGGER PROCEDURE FOR CREATE OF gst_context_scope .
...
/* gst_context_scope is the parent  scope for gst_context_scope ON CHILD INSERT SET NULL */

IF NOT(CAN-FIND(FIRST lb_table WHERE
    gst_context_scope.parent_context_scope_obj = lb_table.context_scope_obj)) THEN
  DO:
...
/* Generated by ICF ERwin Template */
/* gsm_user has gst_context_scope ON CHILD INSERT SET NULL */
IF NOT(CAN-FIND(FIRST gsm_user WHERE
    gst_context_scope.user_obj = gsm_user.user_obj)) THEN
  DO:
...
/* Generated by ICF ERwin Template */
/* gst_session has gst_context_scope ON CHILD INSERT SET NULL */
IF NOT(CAN-FIND(FIRST gst_session WHERE
    gst_context_scope.session_obj = gst_session.session_obj)) THEN
  DO:
...
ASSIGN gst_context_scope.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "gst_context_scope|the specified object number.  Please ensure your database sequences have been set correctly":U.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "gstcs":U, INPUT BUFFER gst_context_scope:HANDLE, INPUT BUFFER o_gst_context_scope:HANDLE).
