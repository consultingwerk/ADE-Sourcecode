...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="05/28/2003" version_time="44514" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="3000050636.09" record_version_obj="3000050637.09" version_number_seq="3.09" secondary_key_value="gsmfirepld#CHR(1)#0" import_version_number_seq="3.09"><smartobject_obj>3000050636.09</smartobject_obj>
