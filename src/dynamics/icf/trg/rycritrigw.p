...
TRIGGER PROCEDURE FOR WRITE OF ryc_ri_default OLD BUFFER o_ryc_ri_default.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afpropfrmp.p (INPUT BUFFER ryc_ri_default:HANDLE).
...
IF NOT NEW ryc_ri_default AND ryc_ri_default.{&TRIGGER_OBJ} <> o_ryc_ri_default.{&TRIGGER_OBJ} THEN
    DO:
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "WRITE":U, INPUT "rycri":U, INPUT BUFFER ryc_ri_default:HANDLE, INPUT BUFFER o_ryc_ri_default:HANDLE).
