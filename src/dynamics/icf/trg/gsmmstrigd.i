...
AND  gsm_user.maintain_system_data   = NO
AND  gsm_menu_structure.system_owned = YES
THEN DO:
    /* Cannot modify as user is not allowed to maintain system data ! */
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 17 lv-include = "You are not authorised to delete system owned menu structure records.":U.
