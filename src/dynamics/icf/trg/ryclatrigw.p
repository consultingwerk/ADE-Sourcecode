...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afpropfrmp.p (INPUT BUFFER ryc_layout:HANDLE).
...
IF NOT NEW ryc_layout AND ryc_layout.{&TRIGGER_OBJ} <> o_ryc_layout.{&TRIGGER_OBJ} THEN
    DO:
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "WRITE":U, INPUT "rycla":U, INPUT BUFFER ryc_layout:HANDLE, INPUT BUFFER o_ryc_layout:HANDLE).
