...
TRIGGER PROCEDURE FOR CREATE OF gsm_currency .
...
ASSIGN gsm_currency.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "gsm_currency|the specified object number.  Please ensure your database sequences have been set correctly":U.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "gsmcr":U, INPUT BUFFER gsm_currency:HANDLE, INPUT BUFFER o_gsm_currency:HANDLE).
