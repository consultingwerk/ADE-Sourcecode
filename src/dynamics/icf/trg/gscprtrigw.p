...
TRIGGER PROCEDURE FOR WRITE OF gsc_product OLD BUFFER o_gsc_product.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afpropfrmp.p (INPUT BUFFER gsc_product:HANDLE).
  



/* Generated by ICF ERwin Template */
/* gsm_login_company supplied gsc_product ON CHILD UPDATE SET NULL */
IF NEW gsc_product OR  gsc_product.supplier_organisation_obj <> o_gsc_product.supplier_organisation_obj  THEN
  DO:
    IF NOT(CAN-FIND(FIRST gsm_login_company WHERE
        gsc_product.supplier_organisation_obj = gsm_login_company.login_company_obj)) THEN DO:
...
IF NOT NEW gsc_product AND gsc_product.{&TRIGGER_OBJ} <> o_gsc_product.{&TRIGGER_OBJ} THEN
    DO:
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "WRITE":U, INPUT "gscpr":U, INPUT BUFFER gsc_product:HANDLE, INPUT BUFFER o_gsc_product:HANDLE).
