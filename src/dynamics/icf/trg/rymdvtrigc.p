...
TRIGGER PROCEDURE FOR CREATE OF rym_data_version .
...
ASSIGN rym_data_version.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "rym_data_version|the specified object number.  Please ensure your database sequences have been set correctly":U.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "rymdv":U, INPUT BUFFER rym_data_version:HANDLE, INPUT BUFFER o_rym_data_version:HANDLE).
