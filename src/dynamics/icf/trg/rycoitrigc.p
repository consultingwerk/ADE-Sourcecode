...
/* ryc_smartobject container ryc_object_instance ON CHILD INSERT RESTRICT */
IF 
    ( ryc_object_instance.container_smartobject_obj <> 0 ) THEN
  DO:
    IF NOT(CAN-FIND(FIRST ryc_smartobject WHERE
        ...
        DO:
          ...
          ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 102 lv-include = "ryc_object_instance|ryc_smartobject":U.
...
ASSIGN ryc_object_instance.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "ryc_object_instance|the specified object number.  Please ensure your database sequences have been set correctly":U.
    RUN error-message (lv-errgrp, lv-errnum, lv-include).
END.
