...
TRIGGER PROCEDURE FOR CREATE OF gsc_global_default .
...
ASSIGN gsc_global_default.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "gsc_global_default|the specified object number.  Please ensure your database sequences have been set correctly":U.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "gscgd":U, INPUT BUFFER gsc_global_default:HANDLE, INPUT BUFFER o_gsc_global_default:HANDLE).
