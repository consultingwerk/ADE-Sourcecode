...
TRIGGER PROCEDURE FOR CREATE OF gsc_multi_media_type .
...
ASSIGN gsc_multi_media_type.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "gsc_multi_media_type|the specified object number.  Please ensure your database sequences have been set correctly":U.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "gscmm":U, INPUT BUFFER gsc_multi_media_type:HANDLE, INPUT BUFFER o_gsc_multi_media_type:HANDLE).
