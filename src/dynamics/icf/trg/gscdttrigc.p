...
TRIGGER PROCEDURE FOR CREATE OF gsc_document_type .
...
/* gsc_delivery_method is the default for gsc_document_type ON CHILD INSERT RESTRICT */
IF 
    ( gsc_document_type.default_delivery_method <> 0 ) THEN
  DO:
    IF NOT(CAN-FIND(FIRST gsc_delivery_method WHERE
        ...
        DO:
          ...
          ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 102 lv-include = "gsc_document_type|gsc_delivery_method":U.
...
ASSIGN gsc_document_type.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "gsc_document_type|the specified object number.  Please ensure your database sequences have been set correctly":U.
    RUN error-message (lv-errgrp, lv-errnum, lv-include).
END.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "gscdt":U, INPUT BUFFER gsc_document_type:HANDLE, INPUT BUFFER o_gsc_document_type:HANDLE).
