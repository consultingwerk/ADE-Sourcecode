...
TRIGGER PROCEDURE FOR CREATE OF gsc_scm_tool .
...
ASSIGN gsc_scm_tool.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "gsc_scm_tool|the specified object number.  Please ensure your database sequences have been set correctly":U.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "gscsm":U, INPUT BUFFER gsc_scm_tool:HANDLE, INPUT BUFFER o_gsc_scm_tool:HANDLE).
