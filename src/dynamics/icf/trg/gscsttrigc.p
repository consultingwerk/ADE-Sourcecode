...
TRIGGER PROCEDURE FOR CREATE OF gsc_service_type .
...
/* ryc_smartobject is the management object for gsc_service_type ON CHILD INSERT RESTRICT */
IF 
    ( gsc_service_type.management_object_obj <> 0 ) THEN
  DO:
    IF NOT(CAN-FIND(FIRST ryc_smartobject WHERE
        ...
        DO:
          ...
          ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 102 lv-include = "gsc_service_type|ryc_smartobject":U.
...
/* Generated by ICF ERwin Template */
/* ryc_smartobject maintains gsc_service_type ON CHILD INSERT RESTRICT */
IF 
    ( gsc_service_type.maintenance_object_obj <> 0 ) THEN
  DO:
    IF NOT(CAN-FIND(FIRST ryc_smartobject WHERE
...
/* Generated by ICF ERwin Template */
/* gsc_logical_service specifies the default for the gsc_service_type ON CHILD INSERT SET NULL */
...
ASSIGN gsc_service_type.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "gsc_service_type|the specified object number.  Please ensure your database sequences have been set correctly":U.
    RUN error-message (lv-errgrp, lv-errnum, lv-include).
END.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "gscst":U, INPUT BUFFER gsc_service_type:HANDLE, INPUT BUFFER o_gsc_service_type:HANDLE).
