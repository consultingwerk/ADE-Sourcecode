...
TRIGGER PROCEDURE FOR WRITE OF gsc_data_tag OLD BUFFER o_gsc_data_tag.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afpropfrmp.p (INPUT BUFFER gsc_data_tag:HANDLE).
...
IF NOT NEW gsc_data_tag AND gsc_data_tag.{&TRIGGER_OBJ} <> o_gsc_data_tag.{&TRIGGER_OBJ} THEN
    DO:
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "WRITE":U, INPUT "gsctg":U, INPUT BUFFER gsc_data_tag:HANDLE, INPUT BUFFER o_gsc_data_tag:HANDLE).
