...
TRIGGER PROCEDURE FOR CREATE OF gsm_release .
...
ASSIGN gsm_release.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "gsm_release|the specified object number.  Please ensure your database sequences have been set correctly":U.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "gsmrl":U, INPUT BUFFER gsm_release:HANDLE, INPUT BUFFER o_gsm_release:HANDLE).
