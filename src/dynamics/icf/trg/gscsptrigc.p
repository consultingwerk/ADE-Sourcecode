...
ASSIGN gsc_session_property.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "gsc_session_property|the specified object number.  Please ensure your database sequences have been set correctly":U.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "gscsp":U, INPUT BUFFER gsc_session_property:HANDLE, INPUT BUFFER o_gsc_session_property:HANDLE).
