...
TRIGGER PROCEDURE FOR CREATE OF gsm_profile .
...
/* gsm_category of gsm_profile ON CHILD INSERT RESTRICT */
IF 
    ( gsm_profile.category_obj <> 0 ) THEN
  DO:
    IF NOT(CAN-FIND(FIRST gsm_category WHERE
        ...
        DO:
          ...
          ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 102 lv-include = "gsm_profile|gsm_category":U.
...
ASSIGN gsm_profile.{&TRIGGER_OBJ} = getNextObj() NO-ERROR.
IF ERROR-STATUS:ERROR THEN 
DO:
    ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 31 lv-include = "gsm_profile|the specified object number.  Please ensure your database sequences have been set correctly":U.
    RUN error-message (lv-errgrp, lv-errnum, lv-include).
END.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "gsmpr":U, INPUT BUFFER gsm_profile:HANDLE, INPUT BUFFER o_gsm_profile:HANDLE).
