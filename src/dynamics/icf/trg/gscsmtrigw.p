...
TRIGGER PROCEDURE FOR WRITE OF gsc_scm_tool OLD BUFFER o_gsc_scm_tool.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afpropfrmp.p (INPUT BUFFER gsc_scm_tool:HANDLE).
...
IF NOT NEW gsc_scm_tool AND gsc_scm_tool.{&TRIGGER_OBJ} <> o_gsc_scm_tool.{&TRIGGER_OBJ} THEN
    DO:
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "WRITE":U, INPUT "gscsm":U, INPUT BUFFER gsc_scm_tool:HANDLE, INPUT BUFFER o_gsc_scm_tool:HANDLE).
