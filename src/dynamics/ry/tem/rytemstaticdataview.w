...
Use this template to create a new DataView with the assistance of a Wizard. When completed, this object can be drawn onto any 'smart' container such as a SmartWindow, SmartDialog or SmartFrame. Non-smart objects, such as web objects, can also access a DataView object by running it persistently and calling its methods."
*/
&ANALYZE-RESUME
