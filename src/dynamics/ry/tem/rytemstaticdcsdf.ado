...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/23/2005" version_time="57650" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="13914.81" record_version_obj="13915.81" version_number_seq="3.48" secondary_key_value="rytemstaticdcsdf#CHR(1)#0" import_version_number_seq="3.48"><smartobject_obj>13914.81</smartobject_obj>
