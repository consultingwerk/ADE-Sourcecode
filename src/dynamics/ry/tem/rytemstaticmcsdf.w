...
"Character Combo SmartDataField Template.

Use this template as a starting point for creating  Character Combo SmartDataField Objects."
*/
&ANALYZE-RESUME
...
/*---------------------------------------------------------------------------------
  ...
  Description:  Template Character Combo SmartDataField

  Purpose:      Template Character Combo SmartDataField
  ...
  (v:010001)    Task:        7787   UserRef:    
                Date:   01/02/2001  Author:     Anthony Swindells

  Update Notes: Remove comma and replace with delimiter
...
DEFINE FRAME frMain
     coCombo AT ROW 1 COL 17.4 COLON-ALIGNED
