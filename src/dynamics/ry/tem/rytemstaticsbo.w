...
" Static SmartBusinessObject Template with wizard.

Use this template to create a new  SmartBusinessObject. When completed, this object can be drawn onto any 'smart' container such as a SmartWindow, SmartDialog or SmartFrame. Non-smart objects, such as web objects, can also access a SmartBusinessObject by running it persistently and calling its methods."
*/
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _XFTR " Static SmartBusinessObject Wizard" sbo _INLINE
/* Actions: af/cod/aftemwizcw.w ? ? ? af/sup/afwizdeltp.p */
/*  Static SmartBusinessObject Wizard
Welcome to the  Static SmartBusinessObject Wizard! During the next few steps, the wizard will lead you through all the stages necessary to create this type of object. If you cancel the wizard at any time, then all your changes will be lost. Once the wizard is completed, it is possible to recall parts of the wizard using the LIST option from the section editor. Press Next to proceed.
...
/*---------------------------------------------------------------------------------
  ...
  Description:  Template  SmartBusinessObject Template

  Purpose:      Template  SmartBusinessObject Template
...
&glob   astra2-staticSmartBusinessObject yes
...
/* Settings for THIS-PROCEDURE
   Type: SmartBusinessObject Template
   Allow: Smart
