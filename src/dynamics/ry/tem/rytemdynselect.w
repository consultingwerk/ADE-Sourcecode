...
&IF DEFINED (ADM-PROPERTY-DLG) = 0 &THEN
  &SCOP ADM-PROPERTY-DLG adm2/support/selectd.w
&ENDIF
...
&ANALYZE-SUSPEND _QUERY-BLOCK FRAME frmSelection
/* Query rebuild information for FRAME frmSelection
     _Options          = "NO-LOCK"
