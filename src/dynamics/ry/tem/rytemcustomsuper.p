...
"Custom Super Procedure Template.

Use this template to create a new custom super Procedure file to compile and run PROGRESS 4GL code. All of the client APIs are available for writing UI logic for dynamic objects. "
*/
&ANALYZE-RESUME
...
/*---------------------------------------------------------------------------------
  ...
  Description:  template custom super procedure

  Purpose:      template custom super procedure
...
&scop object-name       rytemcustomsuper.p
