...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="05/27/2003" version_time="63937" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="3861.19" record_version_obj="3000001741.09" version_number_seq="50.09" secondary_key_value="gsc_package_dataset.deploy_full_data#CHR(1)#0" import_version_number_seq="50.09"><smartobject_obj>3861.19</smartobject_obj>
