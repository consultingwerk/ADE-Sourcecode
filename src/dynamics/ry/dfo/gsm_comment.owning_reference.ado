...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="08/05/2003" version_time="24030" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="3000015164.09" record_version_obj="3000015165.09" version_number_seq="58.09" secondary_key_value="gsm_comment.owning_reference#CHR(1)#0" import_version_number_seq="58.09"><smartobject_obj>3000015164.09</smartobject_obj>
