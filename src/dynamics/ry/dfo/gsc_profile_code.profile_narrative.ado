...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="08/05/2003" version_time="24071" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="3000013629.09" record_version_obj="3000013630.09" version_number_seq="57.09" secondary_key_value="gsc_profile_code.profile_narrative#CHR(1)#0" import_version_number_seq="57.09"><smartobject_obj>3000013629.09</smartobject_obj>
