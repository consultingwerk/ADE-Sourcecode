...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="08/05/2003" version_time="24207" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="13518.81" record_version_obj="3000044510.09" version_number_seq="91.09" secondary_key_value="ryc_attribute_value#CHR(1)#0" import_version_number_seq="91.09"><smartobject_obj>13518.81</smartobject_obj>
