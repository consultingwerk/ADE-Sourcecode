...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="05/27/2003" version_time="63942" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="3000020200.09" record_version_obj="3000020201.09" version_number_seq="39.09" secondary_key_value="gsm_profile_numeric_value.numeric_value_to#CHR(1)#0" import_version_number_seq="39.09"><smartobject_obj>3000020200.09</smartobject_obj>
