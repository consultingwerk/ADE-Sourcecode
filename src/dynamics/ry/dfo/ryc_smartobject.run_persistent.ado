...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="05/27/2003" version_time="63946" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="3000029398.09" record_version_obj="3000029399.09" version_number_seq="40.09" secondary_key_value="ryc_smartobject.run_persistent#CHR(1)#0" import_version_number_seq="40.09"><smartobject_obj>3000029398.09</smartobject_obj>
