...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="08/05/2003" version_time="24198" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="13488.81" record_version_obj="3000044332.09" version_number_seq="189.09" secondary_key_value="gsm_user#CHR(1)#0" import_version_number_seq="189.09"><smartobject_obj>13488.81</smartobject_obj>
