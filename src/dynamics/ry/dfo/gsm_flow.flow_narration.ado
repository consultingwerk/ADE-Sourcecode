...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="08/05/2003" version_time="24078" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="3000016552.09" record_version_obj="3000016553.09" version_number_seq="57.09" secondary_key_value="gsm_flow.flow_narration#CHR(1)#0" import_version_number_seq="57.09"><smartobject_obj>3000016552.09</smartobject_obj>
