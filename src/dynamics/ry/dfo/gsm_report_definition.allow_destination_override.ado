...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="05/27/2003" version_time="63942" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="3000020622.09" record_version_obj="3000020623.09" version_number_seq="40.09" secondary_key_value="gsm_report_definition.allow_destination_override#CHR(1)#0" import_version_number_seq="40.09"><smartobject_obj>3000020622.09</smartobject_obj>
