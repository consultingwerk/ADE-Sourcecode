...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="08/05/2003" version_time="24141" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="3000023200.09" record_version_obj="3000023201.09" version_number_seq="56.09" secondary_key_value="gsm_translated_menu_item.item_narration#CHR(1)#0" import_version_number_seq="56.09"><smartobject_obj>3000023200.09</smartobject_obj>
