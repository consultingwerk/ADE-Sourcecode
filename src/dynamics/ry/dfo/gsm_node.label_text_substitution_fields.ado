...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="08/05/2003" version_time="24135" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="3000018629.09" record_version_obj="3000018630.09" version_number_seq="53.09" secondary_key_value="gsm_node.label_text_substitution_fields#CHR(1)#0" import_version_number_seq="53.09"><smartobject_obj>3000018629.09</smartobject_obj>
