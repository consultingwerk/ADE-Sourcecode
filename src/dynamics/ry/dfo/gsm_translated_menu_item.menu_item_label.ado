...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="05/27/2003" version_time="63943" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="3000022960.09" record_version_obj="3000022961.09" version_number_seq="37.09" secondary_key_value="gsm_translated_menu_item.menu_item_label#CHR(1)#0" import_version_number_seq="37.09"><smartobject_obj>3000022960.09</smartobject_obj>
