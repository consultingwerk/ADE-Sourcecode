...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="05/27/2003" version_time="63937" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="7217.38" record_version_obj="3000001750.09" version_number_seq="43.09" secondary_key_value="gst_deployment.deployment_obj#CHR(1)#0" import_version_number_seq="43.09"><smartobject_obj>7217.38</smartobject_obj>
