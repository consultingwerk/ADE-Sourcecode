...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="08/05/2003" version_time="24098" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="3000012359.09" record_version_obj="3000012360.09" version_number_seq="54.09" secondary_key_value="gsc_language_text.text_content#CHR(1)#0" import_version_number_seq="54.09"><smartobject_obj>3000012359.09</smartobject_obj>
