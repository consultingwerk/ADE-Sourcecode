...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="08/05/2003" version_time="24193" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="13464.81" record_version_obj="3000044234.09" version_number_seq="36.09" secondary_key_value="gsm_security_structure#CHR(1)#0" import_version_number_seq="36.09"><smartobject_obj>13464.81</smartobject_obj>
