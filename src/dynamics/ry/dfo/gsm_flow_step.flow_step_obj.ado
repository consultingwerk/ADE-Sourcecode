...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="05/27/2003" version_time="63938" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="3000008402.09" record_version_obj="3000008403.09" version_number_seq="39.09" secondary_key_value="gsm_flow_step.flow_step_obj#CHR(1)#0" import_version_number_seq="39.09"><smartobject_obj>3000008402.09</smartobject_obj>
