...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="05/27/2003" version_time="63939" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="3000010478.09" record_version_obj="3000010479.09" version_number_seq="38.09" secondary_key_value="gsc_deploy_dataset.default_ado_filename#CHR(1)#0" import_version_number_seq="38.09"><smartobject_obj>3000010478.09</smartobject_obj>
