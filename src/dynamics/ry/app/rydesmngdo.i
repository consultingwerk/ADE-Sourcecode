            ...
            DO:
                DO iExtent = 2 TO hFieldBuffer:BUFFER-FIELD("_Extent":U):BUFFER-VALUE:
                    ...
                    ASSIGN bttDataObjectField.tFieldName = ttDataObjectField.tFieldName + STRING(iExtent)
                           cExtentFieldList = cExtentFieldList + ",":U
                                            + bttDataObjectField.tFieldName + ",":U
                                            + ttDataObjectField.tFieldName + "[":U + STRING(iExtent) + "]":U.
                END.    /* loop through extents */

                ASSIGN cExtentFieldList = ttDataObjectField.tFieldName + "1":U + ",":U
                                        + ttDataObjectField.tFieldName + "[":U + "1":U + "]":U
                                        + cExtentFieldList                       
                       ttDataObjectField.tFieldName = ttDataObjectField.tFieldName + "1":U.
