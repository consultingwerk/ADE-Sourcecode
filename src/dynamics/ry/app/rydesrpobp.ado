...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="05/19/2003" version_time="55857" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="17130.48" record_version_obj="17131.48" version_number_seq="3.48" secondary_key_value="rydesrpobp#CHR(1)#0" import_version_number_seq="3.48"><smartobject_obj>17130.48</smartobject_obj>
