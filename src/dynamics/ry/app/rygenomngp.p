...
------------------------------------------------------------------------------*/
    ...
    IF pcDatabaseName = "temp-db":U THEN
        ASSIGN cTempTable = "DEFINE TEMP-TABLE ":U + pcTableName + " NO-UNDO LIKE temp-db." + pcTableName + ".":U.
    ...
    DO iListLoop = 1 TO NUM-ENTRIES(pcDisplayedFields):
        ...
        DO:
            ASSIGN cDataFieldName  = ENTRY(1,pcDisplayedTables) + ".":U + ENTRY(iListLoop, pcDisplayedFields)
                   cPropertyNames  = "IncludeInDefaultListView,IncludeInDefaultView":U
                   cPropertyValues = "":U.
