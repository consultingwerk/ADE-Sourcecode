...
/*---------------------------------------------------------------------------------
  File: rycusfchcsttypp.p

  Description:  FetchCustomizationTypes AppServer Proxy

  Purpose:      FetchCustomizationTypes AppServer Proxy
...
&scop object-name       rycusfchcsttypp.p
...
/* ***************************  Main Block  *************************** */
  ...
  RUN FetchCustomizationTypes IN gshCustomizationManager
