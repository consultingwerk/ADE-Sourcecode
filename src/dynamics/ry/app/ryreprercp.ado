...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/12/2003" version_time="34389" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="67066.48" record_version_obj="67067.48" version_number_seq="2.48" secondary_key_value="ryreprercp#CHR(1)#0" import_version_number_seq="2.48"><smartobject_obj>67066.48</smartobject_obj>
