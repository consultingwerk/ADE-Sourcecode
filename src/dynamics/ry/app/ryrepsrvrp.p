...
/*---------------------------------------------------------------------------------
  ...
  Description:  Dynamics Server Repository Manager

  Purpose:      This is the actual Server Side Repository Manager.
                The actual code for the Repository Manager is contained in the 
                include file ry/app/ryrepmngrp.i
                This code is also used by the Client Side Repository Manager
                ry/prc/ryrepclntp.p
