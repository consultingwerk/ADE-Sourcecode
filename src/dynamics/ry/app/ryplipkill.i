...
/*---------------------------------------------------------------------------------
  ...
  Description:  standard include for killPlip in a plip

  Purpose:      standard include for killPlip in a Astra 2 plip
...
/* ***************************  Main Block  *************************** */
    ...
    APPLY "CLOSE":U TO THIS-PROCEDURE. /* shut plip down nicely - runs plipShutdown in plip first */
