...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/05/2003" version_time="62226" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="3000051336.09" record_version_obj="3000051337.09" version_number_seq="3" secondary_key_value="rydesvaldfp#CHR(1)#0" import_version_number_seq="3"><smartobject_obj>3000051336.09</smartobject_obj>
