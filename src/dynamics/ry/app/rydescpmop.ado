...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/05/2003" version_time="61506" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="3000051332.09" record_version_obj="3000051333.09" version_number_seq="2" secondary_key_value="rydescpmop#CHR(1)#0" import_version_number_seq="2"><smartobject_obj>3000051332.09</smartobject_obj>
