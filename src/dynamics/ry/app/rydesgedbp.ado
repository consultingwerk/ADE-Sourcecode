...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="07/21/2003" version_time="48513" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="63534.48" record_version_obj="63535.48" version_number_seq="3.48" secondary_key_value="rydesgedbp#CHR(1)#0" import_version_number_seq="3.48"><smartobject_obj>63534.48</smartobject_obj>
