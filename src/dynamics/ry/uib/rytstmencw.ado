...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/23/2005" version_time="57655" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="1003555102" record_version_obj="3000033265.09" version_number_seq="4.48" secondary_key_value="rytstmencw.w#CHR(1)#0" import_version_number_seq="4.48"><smartobject_obj>1003555102</smartobject_obj>
