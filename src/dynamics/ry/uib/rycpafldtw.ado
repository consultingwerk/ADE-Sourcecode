...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/20/2003" version_time="80496" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="1005120203.101" record_version_obj="3000050042.09" version_number_seq="3.09" secondary_key_value="rycpafldtw#CHR(1)#0" import_version_number_seq="3.09"><smartobject_obj>1005120203.101</smartobject_obj>
