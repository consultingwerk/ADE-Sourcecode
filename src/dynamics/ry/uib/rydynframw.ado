...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="10/02/2003" version_time="49450" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="32210.48" record_version_obj="3000057797.09" version_number_seq="1.09" secondary_key_value="rydynframw#CHR(1)#0" import_version_number_seq="1.09"><smartobject_obj>32210.48</smartobject_obj>
