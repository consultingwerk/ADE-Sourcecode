...
&Scoped-Define ENABLED-OBJECTS toClass toEntity buCancel buGenerate RECT-3 
...
------------------------------------------------------------------------------*/
  ...
  PUBLISH "getEntityList":U FROM ghContainerSource (OUTPUT cEntityList).

  PUBLISH "getLogEditorHandle":U FROM ghContainerSource (OUTPUT hStatus).

  ASSIGN ERROR-STATUS:ERROR = NO.
  IF ( cClassList = "" AND cEntityList = "" ) THEN
  DO:
