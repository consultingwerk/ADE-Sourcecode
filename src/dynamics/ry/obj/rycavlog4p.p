...
/*---------------------------------------------------------------------------------
  ...
  Description:  SDO Logic for ryc_attribute_value

  Purpose:      A procedure library (PLIP) to support the maintenance of the ryc_attribute_value table
  ...
  (v:010002)    Task:   101000074   UserRef:    
...
------------------------------------------------------------------------------*/
  ...
  IF CAN-FIND(FIRST ryc_attribute_value 
              WHERE ryc_attribute_value.object_type_obj = b_ryc_attribute_value.object_type_obj
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN cDescription = "Astra 2 ryc_attribute_value Data Logic Procedure".
...
------------------------------------------------------------------------------*/
  ...
  IF b_ryc_attribute_value.object_type_obj = 0 OR b_ryc_attribute_value.object_type_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {af/sup2/aferrortxt.i 'AF' '1' 'ryc_attribute_value' 'object_type_obj' "'Object Type Obj'"}.

  IF b_ryc_attribute_value.smartobject_obj = 0 OR b_ryc_attribute_value.smartobject_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {af/sup2/aferrortxt.i 'AF' '1' 'ryc_attribute_value' 'smartobject_obj' "'SmartObject Obj'"}.

  IF b_ryc_attribute_value.object_instance_obj = 0 OR b_ryc_attribute_value.object_instance_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {af/sup2/aferrortxt.i 'AF' '1' 'ryc_attribute_value' 'object_instance_obj' "'Object Instance Obj'"}.

  IF LENGTH(b_ryc_attribute_value.attribute_label) = 0 OR LENGTH(b_ryc_attribute_value.attribute_label) = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {af/sup2/aferrortxt.i 'AF' '1' 'ryc_attribute_value' 'attribute_label' "'Attribute Label'"}.

  IF b_ryc_attribute_value.container_smartobject_obj = 0 OR b_ryc_attribute_value.container_smartobject_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
  ...
  IF b_ryc_attribute_value.smartobject_obj <> 0 THEN DO:
    ...
    IF NOT lFoundAttr THEN DO:
      ...
      lFoundAttr = DYNAMIC-FUNCTION("classHasAttribute" IN gshRepositoryManager, cObjectTypeCode,b_ryc_attribute_value.attribute_label,FALSE).
      IF NOT lFoundAttr THEN 
        lFoundAttr = DYNAMIC-FUNCTION("classHasAttribute" IN hDesignManager, cObjectTypeCode,b_ryc_attribute_value.attribute_label,FALSE).
    END.
    IF NOT lFoundAttr THEN DO:
...
------------------------------------------------------------------------------*/
  ...
  IF NOT isCreate() AND CAN-FIND(FIRST ryc_attribute_value 
              WHERE ryc_attribute_value.object_type_obj = b_ryc_attribute_value.object_type_obj
                ...
                AND ryc_attribute_value.object_instance_obj = b_ryc_attribute_value.object_instance_obj
                AND ryc_attribute_value.attribute_label = b_ryc_attribute_value.attribute_label
                AND ryc_attribute_value.container_smartobject_obj = b_ryc_attribute_value.container_smartobject_obj
