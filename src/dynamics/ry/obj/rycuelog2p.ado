...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/27/2003" version_time="40837" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="3000032954.09" record_version_obj="3000032955.09" version_number_seq="8" secondary_key_value="rycuelog2p#CHR(1)#0" import_version_number_seq="8"><smartobject_obj>3000032954.09</smartobject_obj>
