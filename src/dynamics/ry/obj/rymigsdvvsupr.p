...
/*---------------------------------------------------------------------------------
  File: C:/migration/ry/obj/rymigsdvvsupr.p rymigsdvv

  Description:  Migration tool SDV viewer

  Purpose:      Viewer used to edit user preferences for migrating static SmartDataViewers to
                dynamic SDVs
...
&scop object-name       rymigsdvvsupr.p
