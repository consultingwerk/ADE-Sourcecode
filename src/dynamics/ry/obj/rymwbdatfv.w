...
/*---------------------------------------------------------------------------------
  ...
  Description:  Wizard Browser Data Field

  Purpose:      Wizard Browser Data Field
...
DEFINE VARIABLE fiSelected AS CHARACTER FORMAT "X(256)":U INITIAL "Selected Fields (double-click to toggle):" 
      VIEW-AS TEXT 
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    fiSelected:SCREEN-VALUE = "Selected Fields (double-click to toggle):".
  END.
