...
&glob DATA-LOGIC-PROCEDURE       ry/obj/rycpalog2p.p
...
&Scoped-define INTERNAL-TABLES ryc_page
...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH ryc_page NO-LOCK ~
    BY ryc_page.page_sequence.
{&DB-REQUIRED-END}
&Scoped-define TABLES-IN-QUERY-Query-Main ryc_page
...
/* Query rebuild information for SmartDataObject Query-Main
     _TblList          = "icfdb.ryc_page"
     _Options          = "NO-LOCK"
     _OrdList          = "icfdb.ryc_page.page_sequence|yes"
