...
&glob DATA-LOGIC-PROCEDURE       ry/obj/rycuelog1p.p
...
&Scoped-define INTERNAL-TABLES ryc_ui_event gsc_object_type
...
&Scoped-Define DATA-FIELDS  ui_event_obj object_type_obj object_type_code container_smartobject_obj~
 smartobject_obj object_instance_obj event_name constant_value action_type~
...
&Scoped-Define DATA-FIELD-DEFS "ry/obj/rycueful1o.i"
&Scoped-define QUERY-STRING-Query-Main FOR EACH ryc_ui_event ~
      WHERE ryc_ui_event.container_smartobject_obj = 0 ~
 AND ryc_ui_event.object_instance_obj = 0 ~
 AND ryc_ui_event.smartobject_obj = 0 NO-LOCK, ~
      FIRST gsc_object_type WHERE gsc_object_type.object_type_obj = ryc_ui_event.object_type_obj NO-LOCK ~
    BY ryc_ui_event.event_name INDEXED-REPOSITION
{&DB-REQUIRED-START}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH ryc_ui_event ~
      WHERE ryc_ui_event.container_smartobject_obj = 0 ~
 AND ryc_ui_event.object_instance_obj = 0 ~
 AND ryc_ui_event.smartobject_obj = 0 NO-LOCK, ~
      FIRST gsc_object_type WHERE gsc_object_type.object_type_obj = ryc_ui_event.object_type_obj NO-LOCK ~
...
DEFINE QUERY Query-Main FOR 
      ryc_ui_event, 
      gsc_object_type
    FIELDS(gsc_object_type.object_type_code) SCROLLING.
&ANALYZE-RESUME
{&DB-REQUIRED-END}
...
/* Query rebuild information for SmartDataObject Query-Main
     _TblList          = "ICFDB.ryc_ui_event,ICFDB.gsc_object_type WHERE ICFDB.ryc_ui_event ..."
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _TblOptList       = ", FIRST USED, FIRST USED"
     _OrdList          = "ICFDB.ryc_ui_event.event_name|yes"
     _Where[1]         = "ryc_ui_event.container_smartobject_obj = 0
 AND ryc_ui_event.object_instance_obj = 0
...
"ui_event_obj" "ui_event_obj" ? ? "decimal" ? ? ? ? ? ? no ? no 24 yes
     _FldNameList[2]   > ICFDB.ryc_ui_event.object_type_obj
"object_type_obj" "object_type_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 24 yes
...
"container_smartobject_obj" "container_smartobject_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 24 yes
     _FldNameList[5]   > ICFDB.ryc_ui_event.smartobject_obj
"smartobject_obj" "smartobject_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 24 yes
     _FldNameList[6]   > ICFDB.ryc_ui_event.object_instance_obj
"object_instance_obj" "object_instance_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 24 yes
     _FldNameList[7]   > ICFDB.ryc_ui_event.event_name
"event_name" "event_name" ? ? "character" ? ? ? ? ? ? yes ? no 70 no
     _FldNameList[8]   > ICFDB.ryc_ui_event.constant_value
"constant_value" "constant_value" ? ? "logical" ? ? ? ? ? ? yes ? no 1 no
     _FldNameList[9]   > ICFDB.ryc_ui_event.action_type
"action_type" "action_type" ? ? "character" ? ? ? ? ? ? yes ? no 6 no
     _FldNameList[10]   > ICFDB.ryc_ui_event.action_target
"action_target" "action_target" ? ? "character" ? ? ? ? ? ? yes ? no 56 no
     _FldNameList[11]   > ICFDB.ryc_ui_event.event_action
"event_action" "event_action" ? ? "character" ? ? ? ? ? ? yes ? no 70 no
     _FldNameList[12]   > ICFDB.ryc_ui_event.event_parameter
"event_parameter" "event_parameter" ? ? "character" ? ? ? ? ? ? yes ? no 140 no
     _FldNameList[13]   > ICFDB.ryc_ui_event.event_disabled
"event_disabled" "event_disabled" ? ? "logical" ? ? ? ? ? ? yes ? no 1 no
     _FldNameList[14]   > ICFDB.ryc_ui_event.primary_smartobject_obj
"primary_smartobject_obj" "primary_smartobject_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 24 yes
