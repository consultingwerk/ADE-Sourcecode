...
------------------------------------------------------------------------------*/
  ...
  /* First check that we do not allow duplicate instances of DataFields on an object */
  IF b_ryc_object_instance.rowMod = "A":U 
  OR b_ryc_object_instance.rowMod = "C":U
  THEN DO:
      ...
      IF AVAILABLE bryc_smartobject THEN DO:
          ASSIGN cValueList = bryc_smartobject.object_filename.
    ...
    IF  AVAILABLE bgsc_object_type 
    AND bgsc_object_type.object_type_code = "DataField":U 
    AND CAN-FIND(FIRST b2ryc_object_instance
                 WHERE b2ryc_object_instance.container_smartobject_obj = b_ryc_object_instance.container_smartobject_obj
                   AND b2ryc_object_instance.smartobject_obj           = b_ryc_object_instance.smartobject_obj) THEN
