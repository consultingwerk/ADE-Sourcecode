...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="10/20/2003" version_time="39769" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="1000002001.48" record_version_obj="1000002002.48" version_number_seq="2.09" secondary_key_value="ryccylkupl#CHR(1)#0" import_version_number_seq="1.09"><smartobject_obj>1000002001.48</smartobject_obj>
