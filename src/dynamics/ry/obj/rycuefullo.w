...
&glob DATA-LOGIC-PROCEDURE       ry/obj/rycuelogcp.p
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH ryc_ui_event ~
 ...
 AND ryc_ui_event.object_instance_obj = 0 NO-LOCK, ~
...
/* Query rebuild information for SmartDataObject Query-Main
     ...
     _Where[1]         = "icfdb.ryc_ui_event.container_smartobject_obj = 0
 AND icfdb.ryc_ui_event.object_instance_obj = 0"
