...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/22/2003" version_time="62629" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="145.99" record_version_obj="3000050126.09" version_number_seq="3.09" secondary_key_value="rypagDynView#CHR(1)#0" import_version_number_seq="3.09"><smartobject_obj>145.99</smartobject_obj>
