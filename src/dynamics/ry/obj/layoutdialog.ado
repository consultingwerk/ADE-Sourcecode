...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/23/2005" version_time="57623" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="3000032908.09" record_version_obj="3000032909.09" version_number_seq="6.48" secondary_key_value="layoutdialog#CHR(1)#0" import_version_number_seq="6.48"><smartobject_obj>3000032908.09</smartobject_obj>
