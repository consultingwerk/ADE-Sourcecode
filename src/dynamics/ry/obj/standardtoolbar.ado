...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/20/2003" version_time="80496" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="36.66" record_version_obj="3000050116.09" version_number_seq="2.09" secondary_key_value="StandardToolbar#CHR(1)#0" import_version_number_seq="2.09"><smartobject_obj>36.66</smartobject_obj>
