...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/20/2003" version_time="80496" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="16211.53" record_version_obj="16212.53" version_number_seq="2.09" secondary_key_value="rycslfullb#CHR(1)#0" import_version_number_seq="2.09"><smartobject_obj>16211.53</smartobject_obj>
