...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="07/14/2004" version_time="58104" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="98459.48" record_version_obj="98460.48" version_number_seq="1.19" secondary_key_value="ryclspropologcp#CHR(1)#0" import_version_number_seq="3.48"><smartobject_obj>98459.48</smartobject_obj>
