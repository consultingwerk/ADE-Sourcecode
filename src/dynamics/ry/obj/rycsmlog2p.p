...
/*---------------------------------------------------------------------------------
  ...
  Description:  ryc_smartlink Data Logic Procedure Library Template

  Purpose:      A procedure library (PLIP) to support the maintenance of the ryc_smartlink table
...
&GLOB DATA-LOGIC-TABLE ryc_smartlink
&GLOB DATA-FIELD-DEFS  "ry/obj/rycsmful2o.i"
...
------------------------------------------------------------------------------*/
  ...
  IF CAN-FIND(FIRST ryc_smartlink 
              WHERE ryc_smartlink.container_smartobject_obj = b_ryc_smartlink.container_smartobject_obj
                AND ryc_smartlink.source_object_instance_obj = b_ryc_smartlink.source_object_instance_obj
                AND ryc_smartlink.link_name = b_ryc_smartlink.link_name
                AND ryc_smartlink.target_object_instance_obj = b_ryc_smartlink.target_object_instance_obj) THEN
  DO:
     ASSIGN
        cValueList   = STRING(b_ryc_smartlink.container_smartobject_obj) + ', ' + STRING(b_ryc_smartlink.source_object_instance_obj) + ', ' + STRING(b_ryc_smartlink.link_name) + ', ' + STRING(b_ryc_smartlink.target_object_instance_obj)
        cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                      {af/sup2/aferrortxt.i 'AF' '8' 'ryc_smartlink' '' "'container_smartobject_obj, source_object_instance_obj, link_name, target_object_instance_obj, '" cValueList }.
  END.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN cDescription = "Astra 2 ryc_smartlink Data Logic Procedure".
...
------------------------------------------------------------------------------*/
  ...
  IF b_ryc_smartlink.container_smartobject_obj = 0 OR b_ryc_smartlink.container_smartobject_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {af/sup2/aferrortxt.i 'AF' '1' 'ryc_smartlink' 'container_smartobject_obj' "'Container SmartObject Obj'"}.

  IF LENGTH(b_ryc_smartlink.link_name) = 0 OR LENGTH(b_ryc_smartlink.link_name) = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {af/sup2/aferrortxt.i 'AF' '1' 'ryc_smartlink' 'link_name' "'Link Name'"}.
...
------------------------------------------------------------------------------*/
  ...
  IF NOT isCreate() AND CAN-FIND(FIRST ryc_smartlink 
              WHERE ryc_smartlink.container_smartobject_obj = b_ryc_smartlink.container_smartobject_obj
                AND ryc_smartlink.source_object_instance_obj = b_ryc_smartlink.source_object_instance_obj
                AND ryc_smartlink.link_name = b_ryc_smartlink.link_name
                AND ryc_smartlink.target_object_instance_obj = b_ryc_smartlink.target_object_instance_obj
                AND ROWID(ryc_smartlink) <> TO-ROWID(ENTRY(1,b_ryc_smartlink.RowIDent))) THEN
  DO:
     ASSIGN
        cValueList   = STRING(b_ryc_smartlink.container_smartobject_obj) + ', ' + STRING(b_ryc_smartlink.source_object_instance_obj) + ', ' + STRING(b_ryc_smartlink.link_name) + ', ' + STRING(b_ryc_smartlink.target_object_instance_obj)
        cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
