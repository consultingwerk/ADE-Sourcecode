...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="10/08/2003" version_time="65642" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="16173.53" record_version_obj="16174.53" version_number_seq="3.09" secondary_key_value="rycslfullo#CHR(1)#0" import_version_number_seq="3.09"><smartobject_obj>16173.53</smartobject_obj>
