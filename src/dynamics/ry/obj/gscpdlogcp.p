...
/*---------------------------------------------------------------------------------
  ...
  Description:  gsc_package_dataset Data Logic Procedure Library Template

  Purpose:      A procedure library (PLIP) to support the maintenance of the gsc_package_dataset table
...
&GLOB DATA-LOGIC-TABLE gsc_package_dataset
&GLOB DATA-FIELD-DEFS  "ry/obj/gscpdfullo.i"
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN cDescription = "gsc_package_dataset Data Logic Procedure".
