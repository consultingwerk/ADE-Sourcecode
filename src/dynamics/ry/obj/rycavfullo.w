...
date_value decimal_value integer_value logical_value 
&Scoped-Define DATA-FIELDS  object_type_code instance_object_filename object_filename constant_value~
 attribute_group_name attribute_label container_smartobject_obj~
 object_instance_obj object_type_obj primary_smartobject_obj smartobject_obj~
 attribute_value_obj layout_position lContainer character_value date_value~
 decimal_value cContainedObject integer_value logical_value
...
"attribute_label" "attribute_label" ? ? "character" ? ? ? ? ? ? yes ? no 35 yes
     _FldNameList[7]   > icfdb.ryc_attribute_value.container_smartobject_obj
"container_smartobject_obj" "container_smartobject_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 25 yes
     _FldNameList[8]   > icfdb.ryc_attribute_value.object_instance_obj
"object_instance_obj" "object_instance_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 21.6 yes
     _FldNameList[9]   > icfdb.ryc_attribute_value.object_type_obj
"object_type_obj" "object_type_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 21.6 yes
     _FldNameList[10]   > icfdb.ryc_attribute_value.primary_smartobject_obj
"primary_smartobject_obj" "primary_smartobject_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 22.8 yes
     _FldNameList[11]   > icfdb.ryc_attribute_value.smartobject_obj
"smartobject_obj" "smartobject_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 21.6 yes
     _FldNameList[12]   > icfdb.ryc_attribute_value.attribute_value_obj
"attribute_value_obj" "attribute_value_obj" ? ? "decimal" ? ? ? ? ? ? no ? no 21.6 yes
     _FldNameList[13]   > icfdb.ryc_object_instance.layout_position
...
"containedObjectName()" "cContainedObject" "Contained Object" "x(70)" "character" ? ? ? ? ? ? no ? no 70 no
     _FldNameList[19]   > ICFDB.ryc_attribute_value.integer_value
"integer_value" "integer_value" ? ? "integer" ? ? ? ? ? ? yes ? no 12.6 yes
     _FldNameList[20]   > ICFDB.ryc_attribute_value.logical_value
