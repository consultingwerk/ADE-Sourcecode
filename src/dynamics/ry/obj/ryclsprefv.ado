...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/23/2005" version_time="57629" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="98754.48" record_version_obj="98755.48" version_number_seq="7.48" secondary_key_value="ryclsprefv#CHR(1)#0" import_version_number_seq="7.48"><smartobject_obj>98754.48</smartobject_obj>
