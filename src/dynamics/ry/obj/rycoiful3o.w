...
&Global-define DATA-LOGIC-PROCEDURE ry/obj/rycoilog3p.p
...
&Scoped-Define ENABLED-FIELDS  container_smartobject_obj smartobject_obj system_owned layout_position~
 page_obj object_sequence instance_description instance_name dObjectTypeObj
...
page_obj object_sequence instance_description instance_name 
&Scoped-Define DATA-FIELDS  container_smartobject_obj object_instance_obj smartobject_obj~
 ...
 object_sequence instance_description instance_name dObjectTypeObj~
 dObjectInstanceObj
&Scoped-define DATA-FIELDS-IN-ryc_object_instance container_smartobject_obj ~
object_instance_obj smartobject_obj system_owned layout_position page_obj ~
object_sequence instance_description instance_name 
...
DEFINE QUERY Query-Main FOR 
    ...
    FIELDS(ryc_smartobject.object_filename
      ryc_smartobject.object_type_obj) SCROLLING.
&ANALYZE-RESUME
{&DB-REQUIRED-END}
...
/* Query rebuild information for SmartDataObject Query-Main
     ...
     _OrdList          = "icfdb.ryc_object_instance.container_smartobject_obj|yes,rtb.ryc_object_instance.object_instance_obj|yes"
     _JoinCode[2]      = "icfdb.ryc_smartobject.smartobject_obj = icfdb.ryc_object_instance.smartobject_obj"
...
"object_type_obj" "object_type_obj" ? ? "decimal" ? ? ? ? ? ? no ? no 29.4 yes
     _FldNameList[8]   > icfdb.ryc_object_instance.page_obj
"page_obj" "page_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 33.6 no
     _FldNameList[9]   > icfdb.ryc_object_instance.object_sequence
"object_sequence" "object_sequence" ? ? "integer" ? ? ? ? ? ? yes ? no 16.2 no
     _FldNameList[10]   > icfdb.ryc_object_instance.instance_description
"instance_description" "instance_description" ? ? "character" ? ? ? ? ? ? yes ? no 70 yes
     _FldNameList[11]   > icfdb.ryc_object_instance.instance_name
