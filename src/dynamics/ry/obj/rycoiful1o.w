...
&glob DATA-LOGIC-PROCEDURE       ry/obj/rycoilog1p.p
...
&Scoped-Define ENABLED-FIELDS  container_smartobject_obj instance_description instance_name~
 layout_position object_instance_obj smartobject_obj system_owned
&Scoped-define ENABLED-FIELDS-IN-ryc_object_instance ~
container_smartobject_obj instance_description instance_name ~
layout_position object_instance_obj smartobject_obj system_owned 
&Scoped-Define DATA-FIELDS  object_filename object_description container_smartobject_obj~
 instance_description instance_name layout_position object_instance_obj~
 smartobject_obj system_owned
...
&Scoped-Define DATA-FIELD-DEFS "ry/obj/rycoiful1o.i"
...
DEFINE QUERY Query-Main FOR 
      ryc_object_instance
    FIELDS(ryc_object_instance.container_smartobject_obj
      ryc_object_instance.instance_description
      ...
      ryc_object_instance.system_owned), 
      ryc_smartobject
    FIELDS(ryc_smartobject.object_filename
      ryc_smartobject.object_description) SCROLLING.
&ANALYZE-RESUME
{&DB-REQUIRED-END}
...
/* Query rebuild information for SmartDataObject Query-Main
     ...
     _JoinCode[2]      = "ryc_smartobject.smartobject_obj = ryc_object_instance.container_smartobject_obj"
...
"object_description" "object_description" ? ? "character" ? ? ? ? ? ? no ? no 35 yes
     _FldNameList[3]   > ICFDB.ryc_object_instance.container_smartobject_obj
"container_smartobject_obj" "container_smartobject_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 33.6 yes
     _FldNameList[4]   > ICFDB.ryc_object_instance.instance_description
"instance_description" "instance_description" ? ? "character" ? ? ? ? ? ? yes ? no 70 yes
     _FldNameList[5]   > ICFDB.ryc_object_instance.instance_name
...
"layout_position" "layout_position" ? ? "character" ? ? ? ? ? ? yes ? no 15 yes
     _FldNameList[7]   > ICFDB.ryc_object_instance.object_instance_obj
"object_instance_obj" "object_instance_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 33.6 yes
     _FldNameList[8]   > ICFDB.ryc_object_instance.smartobject_obj
"smartobject_obj" "smartobject_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 33.6 yes
     _FldNameList[9]   > ICFDB.ryc_object_instance.system_owned
