...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="10/08/2003" version_time="65665" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="1003766705" record_version_obj="3000001791.09" version_number_seq="4.09" secondary_key_value="rycstfullo.w#CHR(1)#0" import_version_number_seq="4.09"><smartobject_obj>1003766705</smartobject_obj>
