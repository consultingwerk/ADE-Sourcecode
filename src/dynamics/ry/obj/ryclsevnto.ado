...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="05/20/2004" version_time="64000" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="98389.48" record_version_obj="98390.48" version_number_seq="33.48" secondary_key_value="ryclsevnto#CHR(1)#0" import_version_number_seq="33.48"><smartobject_obj>98389.48</smartobject_obj>
