...
"Decimal Combo SmartDataField Template.

Use this template as a starting point for creating  Decimal Combo SmartDataField Objects. "
*/
&ANALYZE-RESUME
...
/*---------------------------------------------------------------------------------
  ...
  Description:  Template Decimal Combo Smart Data Field

  Purpose:      Template Decimal Combo Smart Data Field
  ...
  (v:010000)    Task:        6621   UserRef:    
                Date:   04/09/2000  Author:     Jenny Bond
...
ON VALUE-CHANGED OF coCombo IN FRAME frMain /* Layout */
DO:
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  ASSIGN
    ...
    ttComboData.cForEach = "FOR EACH ryc_layout NO-LOCK BY ryc_layout.layout_code":U
    ttComboData.cBufferList = "ryc_layout":U
    ttComboData.cKeyFieldName = "ryc_layout.layout_obj":U
    ttComboData.cDescFieldNames = "ryc_layout.layout_code,ryc_layout.layout_name":U
