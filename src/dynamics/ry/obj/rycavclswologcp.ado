...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="05/20/2004" version_time="64000" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="97721.48" record_version_obj="97722.48" version_number_seq="2.48" secondary_key_value="rycavclswologcp#CHR(1)#0" import_version_number_seq="2.48"><smartobject_obj>97721.48</smartobject_obj>
