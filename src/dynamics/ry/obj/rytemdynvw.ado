...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/23/2005" version_time="57639" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="1007606293.08" record_version_obj="3000001732.09" version_number_seq="35.48" secondary_key_value="rytemdynvw#CHR(1)#0" import_version_number_seq="35.48"><smartobject_obj>1007606293.08</smartobject_obj>
