...
&Global-define DATA-LOGIC-PROCEDURE ry/obj/rycavlog5p.p
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH ryc_attribute_value ~
...
"RowObject.attribute_group_obj" "dAttributeGroupObj" "Attribute Group Obj" "->>>>>>>>>>>>>>>>>9.999999999" "Decimal" ? ? ? ? ? ? yes ? no 8 no
