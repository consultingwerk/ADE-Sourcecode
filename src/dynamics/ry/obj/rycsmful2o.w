...
&glob DATA-LOGIC-PROCEDURE       ry/obj/rycsmlog2p.p
...
&Scoped-define INTERNAL-TABLES ryc_smartlink

/* Definitions for QUERY Query-Main                                     */
&Scoped-Define ENABLED-FIELDS  container_smartobject_obj smartlink_type_obj link_name~
...
smartlink_type_obj link_name source_object_instance_obj ~
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH ryc_smartlink NO-LOCK ~
    BY ryc_smartlink.link_name INDEXED-REPOSITION
{&DB-REQUIRED-START}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH ryc_smartlink NO-LOCK ~
    BY ryc_smartlink.link_name INDEXED-REPOSITION.
{&DB-REQUIRED-END}
&Scoped-define TABLES-IN-QUERY-Query-Main ryc_smartlink
...
/* Query rebuild information for SmartDataObject Query-Main
     _TblList          = "icfdb.ryc_smartlink"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _TblOptList       = ", FIRST USED"
     _OrdList          = "rtb.ryc_smartlink.link_name|yes"
...
"smartlink_type_obj" "smartlink_type_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 21 yes
...
"source_object_instance_obj" "source_object_instance_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 21 yes
     _FldNameList[6]   > icfdb.ryc_smartlink.target_object_instance_obj
