...
DEFINE FRAME F-Main
     RowObject.smartlink_type_obj AT ROW 1 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 27.2 BY 1
     RowObject.link_name AT ROW 2 COL 21 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 30 BY 1
...
/* SETTINGS FOR FILL-IN RowObject.smartlink_type_obj IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
       RowObject.smartlink_type_obj:READ-ONLY IN FRAME F-Main        = TRUE.
