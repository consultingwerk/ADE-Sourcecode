...
/*---------------------------------------------------------------------------------
  ...
  Description:  ryc_customization_type Data Logic Procedure Library Template

  Purpose:      A procedure library (PLIP) to support the maintenance of the ryc_customization_type table
...
&GLOB DATA-LOGIC-TABLE ryc_customization_type
&GLOB DATA-FIELD-DEFS  "ry/obj/ryccyfullo.i"
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN cDescription = "ryc_customization_type Data Logic Procedure".
...
------------------------------------------------------------------------------*/
  ...
  IF CAN-FIND(FIRST ryc_customization_type 
              WHERE ryc_customization_type.customization_type_code = b_ryc_customization_type.customization_type_code) THEN
  DO:
     ASSIGN
        cValueList   = STRING(b_ryc_customization_type.customization_type_code)
        cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                      {aferrortxt.i 'AF' '8' 'ryc_customization_type' '' "'customization_type_code, '" cValueList }.
  END.
...
------------------------------------------------------------------------------*/
  ...
  IF NOT isCreate() AND CAN-FIND(FIRST ryc_customization_type 
              WHERE ryc_customization_type.customization_type_code = b_ryc_customization_type.customization_type_code
                AND ROWID(ryc_customization_type) <> TO-ROWID(ENTRY(1,b_ryc_customization_type.RowIDent))) THEN
  DO:
     ASSIGN
        cValueList   = STRING(b_ryc_customization_type.customization_type_code)
        cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
...
------------------------------------------------------------------------------*/
  ...
  IF isFieldBlank(b_ryc_customization_type.customization_type_code) THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'ryc_customization_type' 'customization_type_code' "'Customization Type Code'"}.

  IF isFieldBlank(b_ryc_customization_type.customization_type_desc) THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'ryc_customization_type' 'customization_type_desc' "'Customization Type Desc'"}.
