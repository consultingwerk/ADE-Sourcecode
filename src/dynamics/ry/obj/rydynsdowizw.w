...
"Dynamic SmartDataObject Template with wizard.

Use this template to create a new Dynamic SmartDataObject with the assistance of the SmartDataObject Wizard. When completed, this object can be referenced onto any Dynamic Smart container, such as a Dynamic Object Controller or Dynamic Folder. Non-smart objects, such as web objects, can also access a Dynamic SmartDataObject by running it persistently and calling its methods."
*/
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _XFTR "Dynamic SmartDataObject Wizard" dTables _INLINE
/* Actions: af/cod/aftemwizcw.w ? ? ? af/sup/afwizdeltp.p */
/* Dynamic SmartDataObject Wizard
Welcome to the Dynamic SmartDataObject Wizard! During the next few steps, the wizard will lead you through all the stages necessary to create this type of object. If you cancel the wizard at any time, then all your changes will be lost. Once the wizard is completed, it is possible to recall parts of the wizard using the LIST option from the section editor. Press Next to proceed.
...
/*---------------------------------------------------------------------------------
  ...
  Description:  Template Dynamic SmartDataObject Template

  Purpose:      Template Dynamic SmartDataObject Template
...
&glob   astra2-DynamicSmartDataObject yes
