...
/*---------------------------------------------------------------------------------
  ...
  Description:  ryc_supported_link Data Logic Procedure Library Template

  Purpose:      A procedure library (PLIP) to support the maintenance of the ryc_supported_link table
...
&GLOB DATA-LOGIC-TABLE ryc_supported_link
&GLOB DATA-FIELD-DEFS  "ry/obj/rycslfullo.i"
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN cDescription = "ryc_supported_link Data Logic Procedure".
...
------------------------------------------------------------------------------*/
  ...
  IF CAN-FIND(FIRST ryc_supported_link 
              WHERE ryc_supported_link.object_type_obj = b_ryc_supported_link.object_type_obj
                AND ryc_supported_link.smartlink_type_obj = b_ryc_supported_link.smartlink_type_obj) THEN
  DO:
     ASSIGN
        cValueList   = STRING(b_ryc_supported_link.object_type_obj) + ', ' + STRING(b_ryc_supported_link.smartlink_type_obj)
        cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                      {aferrortxt.i 'AF' '8' 'ryc_supported_link' '' "'object_type_obj, smartlink_type_obj, '" cValueList }.
  END.


  IF CAN-FIND(FIRST ryc_supported_link 
              WHERE ryc_supported_link.smartlink_type_obj = b_ryc_supported_link.smartlink_type_obj
                AND ryc_supported_link.object_type_obj = b_ryc_supported_link.object_type_obj) THEN
  DO:
     ASSIGN
        cValueList   = STRING(b_ryc_supported_link.smartlink_type_obj) + ', ' + STRING(b_ryc_supported_link.object_type_obj)
        cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                      {aferrortxt.i 'AF' '8' 'ryc_supported_link' '' "'smartlink_type_obj, object_type_obj, '" cValueList }.
  END.
...
------------------------------------------------------------------------------*/
  ...
  IF NOT isCreate() AND CAN-FIND(FIRST ryc_supported_link 
              WHERE ryc_supported_link.object_type_obj = b_ryc_supported_link.object_type_obj
                AND ryc_supported_link.smartlink_type_obj = b_ryc_supported_link.smartlink_type_obj
                AND ROWID(ryc_supported_link) <> TO-ROWID(ENTRY(1,b_ryc_supported_link.RowIDent))) THEN
  DO:
     ASSIGN
        cValueList   = STRING(b_ryc_supported_link.object_type_obj) + ', ' + STRING(b_ryc_supported_link.smartlink_type_obj)
        cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
  ...
  IF NOT isCreate() AND CAN-FIND(FIRST ryc_supported_link 
              WHERE ryc_supported_link.smartlink_type_obj = b_ryc_supported_link.smartlink_type_obj
                AND ryc_supported_link.object_type_obj = b_ryc_supported_link.object_type_obj
                AND ROWID(ryc_supported_link) <> TO-ROWID(ENTRY(1,b_ryc_supported_link.RowIDent))) THEN
  DO:
     ASSIGN
        cValueList   = STRING(b_ryc_supported_link.smartlink_type_obj) + ', ' + STRING(b_ryc_supported_link.object_type_obj)
...
------------------------------------------------------------------------------*/
  ...
  IF b_ryc_supported_link.object_type_obj = 0 OR b_ryc_supported_link.object_type_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'ryc_supported_link' 'object_type_obj' "'Object Type Obj'"}.

  IF b_ryc_supported_link.smartlink_type_obj = 0 OR b_ryc_supported_link.smartlink_type_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'ryc_supported_link' 'smartlink_type_obj' "'Smartlink Type Obj'"}.
