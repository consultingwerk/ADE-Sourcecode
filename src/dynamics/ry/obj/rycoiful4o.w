...
&Global-define DATA-LOGIC-PROCEDURE ry/obj/rycoilog4p.p
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH ryc_object_instance NO-LOCK, ~
    ...
    BY ryc_object_instance.object_sequence INDEXED-REPOSITION
{&DB-REQUIRED-START}
...
/* Query rebuild information for SmartDataObject Query-Main
     ...
     _OrdList          = "icfdb.ryc_object_instance.object_sequence|yes"
