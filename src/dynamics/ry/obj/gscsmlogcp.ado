...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/11/2003" version_time="59632" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="5033.81" record_version_obj="5034.81" version_number_seq="2.09" secondary_key_value="gscsmlogcp#CHR(1)#0" import_version_number_seq="2.09"><smartobject_obj>5033.81</smartobject_obj>
