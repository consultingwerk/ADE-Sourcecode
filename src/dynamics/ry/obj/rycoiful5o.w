...
&glob DATA-LOGIC-PROCEDURE       ry/obj/rycoilog5p.p
...
instance_name instance_description 
&Scoped-Define DATA-FIELDS  object_instance_obj container_smartobject_obj smartobject_obj system_owned~
 layout_position instance_name instance_description object_filename~
 object_description
&Scoped-define DATA-FIELDS-IN-ryc_object_instance object_instance_obj ~
container_smartobject_obj smartobject_obj system_owned layout_position ~
instance_name instance_description 
...
&Scoped-Define DATA-FIELD-DEFS "ry/obj/rycoiful5o.i"
...
DEFINE QUERY Query-Main FOR 
      ryc_object_instance
    FIELDS(ryc_object_instance.object_instance_obj
...
/* Query rebuild information for SmartDataObject Query-Main
     ...
     _FldNameList[1]   > ICFDB.ryc_object_instance.object_instance_obj
"object_instance_obj" "object_instance_obj" ? ? "decimal" ? ? ? ? ? ? no ? no 24 no
     _FldNameList[2]   > ICFDB.ryc_object_instance.container_smartobject_obj
"container_smartobject_obj" "container_smartobject_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 24 no
     _FldNameList[3]   > ICFDB.ryc_object_instance.smartobject_obj
"smartobject_obj" "smartobject_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 24 no
     _FldNameList[4]   > ICFDB.ryc_object_instance.system_owned
"system_owned" "system_owned" ? ? "logical" ? ? ? ? ? ? yes ? no 1 no
     _FldNameList[5]   > ICFDB.ryc_object_instance.layout_position
"layout_position" "layout_position" ? ? "character" ? ? ? ? ? ? yes ? no 30 no
     _FldNameList[6]   > ICFDB.ryc_object_instance.instance_name
"instance_name" "instance_name" ? ? "character" ? ? ? ? ? ? yes ? no 70 no
     _FldNameList[7]   > ICFDB.ryc_object_instance.instance_description
"instance_description" "instance_description" ? ? "character" ? ? ? ? ? ? yes ? no 140 no
     _FldNameList[8]   > ICFDB.ryc_smartobject.object_filename
"object_filename" "object_filename" ? ? "character" ? ? ? ? ? ? no ? no 70 yes
     _FldNameList[9]   > ICFDB.ryc_smartobject.object_description
