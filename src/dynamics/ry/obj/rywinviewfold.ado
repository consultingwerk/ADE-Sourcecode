...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/22/2003" version_time="62629" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="1007604676.08" record_version_obj="14960.0766" version_number_seq="30.09" secondary_key_value="rywinViewFold#CHR(1)#0" import_version_number_seq="30.09"><smartobject_obj>1007604676.08</smartobject_obj>
