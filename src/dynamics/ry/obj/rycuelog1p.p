...
&GLOB DATA-FIELD-DEFS  "ry/obj/rycueful1o.i"
  ...
  DO:
     ASSIGN
        ...
        cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                      {aferrortxt.i 'AF' '8' 'ryc_ui_event' '' "'object_type_obj, smartobject_obj, object_instance_obj, event_name, container_smartobject_obj, '" cValueList }.
  END.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN cDescription = "ryc_ui_event Data Logic Procedure".
...
------------------------------------------------------------------------------*/
  ...
  IF b_ryc_ui_event.object_type_obj = 0 OR b_ryc_ui_event.object_type_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'ryc_ui_event' 'object_type_obj' "'Object Type Obj'"}.

  IF isFieldBlank(b_ryc_ui_event.event_name) THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'ryc_ui_event' 'event_name' "'Event Name'"}.
