...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/22/2003" version_time="61890" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="5148.81" record_version_obj="5149.81" version_number_seq="4.81" secondary_key_value="gsmsxlogcp#CHR(1)#0" import_version_number_seq="4.81"><smartobject_obj>5148.81</smartobject_obj>
