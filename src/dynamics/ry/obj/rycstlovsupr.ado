...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/23/2005" version_time="57635" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="25827.409" record_version_obj="25828.409" version_number_seq="3.48" secondary_key_value="rycstlovsupr#CHR(1)#0" import_version_number_seq="3.48"><smartobject_obj>25827.409</smartobject_obj>
