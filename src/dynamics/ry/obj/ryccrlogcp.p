...
/*---------------------------------------------------------------------------------
  ...
  Description:  ryc_customization_result Data Logic Procedure Library Template

  Purpose:      A procedure library (PLIP) to support the maintenance of the ryc_customization_result table
...
&GLOB DATA-LOGIC-TABLE ryc_customization_result
&GLOB DATA-FIELD-DEFS  "ry/obj/ryccrfullo.i"
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN cDescription = "ryc_customization_result Data Logic Procedure".
...
------------------------------------------------------------------------------*/
  ...
  IF CAN-FIND(FIRST ryc_customization_result 
              WHERE ryc_customization_result.customization_result_code = b_ryc_customization_result.customization_result_code) THEN
  DO:
     ASSIGN
        cValueList   = STRING(b_ryc_customization_result.customization_result_code)
        cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                      {aferrortxt.i 'AF' '8' 'ryc_customization_result' '' "'customization_result_code, '" cValueList }.
  END.
...
------------------------------------------------------------------------------*/
  ...
  IF NOT isCreate() AND CAN-FIND(FIRST ryc_customization_result 
              WHERE ryc_customization_result.customization_result_code = b_ryc_customization_result.customization_result_code
                AND ROWID(ryc_customization_result) <> TO-ROWID(ENTRY(1,b_ryc_customization_result.RowIDent))) THEN
  DO:
     ASSIGN
        cValueList   = STRING(b_ryc_customization_result.customization_result_code)
        cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
...
------------------------------------------------------------------------------*/
  ...
  IF isFieldBlank(b_ryc_customization_result.customization_result_code) THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'ryc_customization_result' 'customization_result_code' "'Customization Result Code'"}.

  IF isFieldBlank(b_ryc_customization_result.customization_result_desc) THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'ryc_customization_result' 'customization_result_desc' "'Customization Result Desc'"}.

  IF b_ryc_customization_result.customization_type_obj = 0 OR b_ryc_customization_result.customization_type_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'ryc_customization_result' 'customization_type_obj' "'Customization Type Obj'"}.
