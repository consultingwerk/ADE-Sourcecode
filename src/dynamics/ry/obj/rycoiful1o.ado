...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="10/08/2003" version_time="65724" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="2000000413.28" record_version_obj="2000000414.28" version_number_seq="3.09" secondary_key_value="rycoiful1o#CHR(1)#0" import_version_number_seq="3.09"><smartobject_obj>2000000413.28</smartobject_obj>
