...
&GLOB DATA-FIELD-DEFS  "ry/obj/rycoiful5o.i"
  ...
  IF b_ryc_object_instance.smartobject_obj = 0 OR b_ryc_object_instance.smartobject_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'ryc_object_instance' 'smartobject_obj' "'SmartObject Obj'"}.

  IF b_ryc_object_instance.container_smartobject_obj = 0 OR b_ryc_object_instance.container_smartobject_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'ryc_object_instance' 'container_smartobject_obj' "'Container SmartObject Obj'"}.

  IF isFieldBlank(b_ryc_object_instance.layout_position) THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'ryc_object_instance' 'layout_position' "'Layout Position'"}.

  IF isFieldBlank(b_ryc_object_instance.instance_name) THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'ryc_object_instance' 'instance_name' "'Instance Name'"}.

  IF isFieldBlank(b_ryc_object_instance.instance_description) THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'ryc_object_instance' 'instance_description' "'Instance Description'"}.
