...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="10/01/2003" version_time="39956" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="910960.24" record_version_obj="910961.24" version_number_seq="1.24" secondary_key_value="gsmrllogcp#CHR(1)#0" import_version_number_seq="1.24"><smartobject_obj>910960.24</smartobject_obj>
