...
/*---------------------------------------------------------------------------------
  ...
  Description:  gst_dataset_file Data Logic Procedure Library Template

  Purpose:      A procedure library (PLIP) to support the maintenance of the gst_dataset_file table
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN cDescription = "gst_dataset_file Data Logic Procedure".
...
------------------------------------------------------------------------------*/
  ...
  IF b_gst_dataset_file.deployment_obj = 0 OR b_gst_dataset_file.deployment_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'gst_dataset_file' 'deployment_obj' "'Deployment Obj'"}.

  IF b_gst_dataset_file.deploy_dataset_obj = 0 OR b_gst_dataset_file.deploy_dataset_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'gst_dataset_file' 'deploy_dataset_obj' "'Deploy Dataset Obj'"}.

  IF isFieldBlank(b_gst_dataset_file.ado_filename) THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'gst_dataset_file' 'ado_filename' "'Ado Filename'"}.

  IF b_gst_dataset_file.loaded_date = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'gst_dataset_file' 'loaded_date' "'Loaded Date'"}.

  IF b_gst_dataset_file.loaded_time = 0 OR b_gst_dataset_file.loaded_time = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {aferrortxt.i 'AF' '1' 'gst_dataset_file' 'loaded_time' "'Loaded Time'"}.
