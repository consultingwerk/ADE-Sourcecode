  ...
  FIELD event_name LIKE ryc_ui_event.event_name~
  FIELD constant_value LIKE ryc_ui_event.constant_value~
  FIELD action_type LIKE ryc_ui_event.action_type~
  FIELD action_target LIKE ryc_ui_event.action_target~
  FIELD event_action LIKE ryc_ui_event.event_action~
  FIELD event_parameter LIKE ryc_ui_event.event_parameter~
  FIELD event_disabled LIKE ryc_ui_event.event_disabled~
