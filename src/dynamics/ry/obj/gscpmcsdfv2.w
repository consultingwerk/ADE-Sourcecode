...
&scop object-name       gscpmcsdfv2.w
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD setDataValue sObject  _DB-REQUIRED
...
IF pcKey <> "":U AND gcSaveKey = pcKey THEN RETURN.
...
/* parent info passed in - rebuild combo */
  ...
  ASSIGN
    ...
    ttComboData.cForEach = "FOR EACH gsc_product_module NO-LOCK " +
