...
DEFINE VARIABLE h_blayoutlookup AS HANDLE NO-UNDO.
DEFINE VARIABLE h_dlayoutlookup AS HANDLE NO-UNDO.
...
DEFINE FRAME gDialog
     Btn_OK AT ROW 7.91 COL 2
     Btn_Cancel AT ROW 7.91 COL 18
     Btn_Help AT ROW 7.91 COL 129
     SPACE(2.59) SKIP(0.08)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Choose a Layout Object"
...
ON WINDOW-CLOSE OF FRAME gDialog /* Choose a Layout Object */
DO:  
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             INPUT  'ry/obj/dlayoutlookup.wDB-AWARE':U ,
       ...
       RUN constructObject (
             ...
             OUTPUT h_blayoutlookup ).
       RUN repositionObject IN h_blayoutlookup ( 1.00 , 2.00 ) NO-ERROR.
       RUN resizeObject IN h_blayoutlookup ( 6.67 , 142.00 ) NO-ERROR.

       /* Links to SmartDataBrowser h_blayoutlookup. */
       RUN addLink ( h_dlayoutlookup , 'Data':U , h_blayoutlookup ).
       RUN addLink ( h_blayoutlookup , 'Update':U , h_dlayoutlookup ).

       /* Adjust the tab order of the smart objects. */
       RUN adjustTabOrder ( h_blayoutlookup ,
