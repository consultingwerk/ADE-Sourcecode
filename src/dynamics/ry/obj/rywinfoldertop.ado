...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/22/2003" version_time="62634" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="1007604621.08" record_version_obj="3000050054.09" version_number_seq="4.09" secondary_key_value="rywinFolderTop#CHR(1)#0" import_version_number_seq="4.09"><smartobject_obj>1007604621.08</smartobject_obj>
