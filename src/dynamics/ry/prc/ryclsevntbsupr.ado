...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/23/2005" version_time="57642" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="98492.48" record_version_obj="98493.48" version_number_seq="5.48" secondary_key_value="ryclsevntbsupr#CHR(1)#0" import_version_number_seq="5.48"><smartobject_obj>98492.48</smartobject_obj>
<object_filename>ryclsevntbsupr</object_filename>
...
<security_smartobject_obj>98492.48</security_smartobject_obj>
