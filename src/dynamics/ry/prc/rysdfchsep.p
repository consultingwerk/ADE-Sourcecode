...
/*---------------------------------------------------------------------------------
  ...
  Description:  Choose Existing SDF Browser Super Proc
  ...
  (v:010000)    Task:           0   UserRef:    
                Date:   02/07/2003  Author:     

  Update Notes: Created from Template rytemplipp.p
                Created from Template rysdfchseb.p
...
------------------------------------------------------------------------------*/
  ...
  ON "MOUSE-SELECT-DBLCLICK":U OF hBrowse
    PERSISTENT RUN selectionMade IN TARGET-PROCEDURE.
...
------------------------------------------------------------------------------*/
  ...
  PUBLISH "selected":U FROM hContainer.
