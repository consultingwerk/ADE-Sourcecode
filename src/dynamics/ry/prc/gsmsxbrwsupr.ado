...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/29/2003" version_time="59653" version_user="ADMIN" deletion_flag="no" entity_mnemonic="rycso" key_field_value="15983.81" record_version_obj="15984.81" version_number_seq="9.81" secondary_key_value="gsmsxbrwsupr#CHR(1)#0" import_version_number_seq="9.81"><smartobject_obj>15983.81</smartobject_obj>
