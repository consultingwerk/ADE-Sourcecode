...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="05/28/2004" version_time="33297" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="98715.48" record_version_obj="98716.48" version_number_seq="3.48" secondary_key_value="rycatcls2vsupr#CHR(1)#0" import_version_number_seq="3.48"><smartobject_obj>98715.48</smartobject_obj>
