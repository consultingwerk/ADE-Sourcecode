  ...
  DO:
    ...
    FOR EACH gsc_object_type NO-LOCK:
       ...
       FIND FIRST gsm_scm_xref WHERE gsm_scm_xref.scm_tool_obj           = gsc_scm_tool.scm_tool_obj AND
                                     gsm_scm_xref.owning_reference       = STRING(gsc_object_type.object_type_obj) AND
         ...
         */
         ...
         DO:
            ...
            ASSIGN gsm_scm_xref.scm_tool_obj            = gsc_scm_tool.scm_tool_obj
                   ...
                   gsm_scm_xref.owning_reference        = STRING(gsc_object_type.object_type_obj).
    ...
    FOR EACH gsc_product_module NO-LOCK: 
       ...
       DO:
          FIND FIRST gsm_scm_xref WHERE gsm_scm_xref.scm_tool_obj           = gsc_scm_tool.scm_tool_obj AND
                                        ...
                                        gsm_scm_xref.owning_reference       = STRING(gsc_product_module.product_module_obj) AND
          ...
          DO:        
            ...
            ASSIGN gsm_scm_xref.scm_tool_obj            = gsc_scm_tool.scm_tool_obj
                   ...
                   gsm_scm_xref.owning_reference        = STRING(gsc_product_module.product_module_obj)
