...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/22/2003" version_time="61895" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="15236.81" record_version_obj="15237.81" version_number_seq="6.81" secondary_key_value="gsmsxotviewvsupr#CHR(1)#0" import_version_number_seq="6.81"><smartobject_obj>15236.81</smartobject_obj>
