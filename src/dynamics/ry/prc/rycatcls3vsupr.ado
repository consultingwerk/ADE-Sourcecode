...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/01/2004" version_time="58302" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="99847.48" record_version_obj="99848.48" version_number_seq="6.48" secondary_key_value="rycatcls3vsupr#CHR(1)#0" import_version_number_seq="6.48"><smartobject_obj>99847.48</smartobject_obj>
