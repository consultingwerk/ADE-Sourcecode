...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="05/16/2003" version_time="58542" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="8100000011861.18" record_version_obj="8100000011862.18" version_number_seq="1.09" secondary_key_value="ryreplinstvp#CHR(1)#0" import_version_number_seq="1.09"><smartobject_obj>8100000011861.18</smartobject_obj>
