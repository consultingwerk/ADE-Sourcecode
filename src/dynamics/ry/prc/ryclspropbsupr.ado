...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/23/2005" version_time="57642" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="97598.48" record_version_obj="97599.48" version_number_seq="4.48" secondary_key_value="ryclspropbsupr#CHR(1)#0" import_version_number_seq="4.48"><smartobject_obj>97598.48</smartobject_obj>
<object_filename>ryclspropbsupr</object_filename>
...
<object_description>Custom Super Procedure for ryclspropbsupr.p</object_description>
...
<security_smartobject_obj>97598.48</security_smartobject_obj>
