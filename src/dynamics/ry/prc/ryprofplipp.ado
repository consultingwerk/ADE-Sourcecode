...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/23/2005" version_time="57644" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="722.1214" record_version_obj="723.1214" version_number_seq="2.48" secondary_key_value="ryprofplipp#CHR(1)#0" import_version_number_seq="2.48"><smartobject_obj>722.1214</smartobject_obj>
