...
&Scoped-Define ENABLED-OBJECTS edComment buPath1 fiPath1 buPath2 fiPath2 ~
buPath3 fiPath3 buPath4 fiPath4 
&Scoped-Define DISPLAYED-OBJECTS edComment fiPath1 fiPath2 fiPath3 fiPath4 
...
DEFINE VARIABLE fiPath3 AS CHARACTER FORMAT "X(256)":U 
     LABEL "Path 3" 
     VIEW-AS FILL-IN 
     SIZE 43.2 BY 1 NO-UNDO.
...
DEFINE FRAME fMain
     ...
     buPath1 AT ROW 10.52 COL 63.4
     fiPath1 AT ROW 10.57 COL 17.8 COLON-ALIGNED
     buPath2 AT ROW 11.81 COL 63.4
     fiPath2 AT ROW 11.86 COL 17.8 COLON-ALIGNED
     buPath3 AT ROW 13.1 COL 63.4
     fiPath3 AT ROW 13.14 COL 17.8 COLON-ALIGNED
     buPath4 AT ROW 14.38 COL 63.4
     fiPath4 AT ROW 14.43 COL 17.8 COLON-ALIGNED
...
&Scoped-define SELF-NAME fiPath3
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiPath3 fFrameWin
ON LEAVE OF fiPath3 IN FRAME fMain /* Path 3 */
DO:
  RUN eventProc IN THIS-PROCEDURE ("LEAVE":U,"{&SELF-NAME}":U) NO-ERROR.
  IF ERROR-STATUS:ERROR THEN
    RETURN NO-APPLY.
...
------------------------------------------------------------------------------*/
  DISPLAY edComment fiPath1 fiPath2 fiPath3 fiPath4 
      WITH FRAME fMain.
  ENABLE edComment buPath1 fiPath1 buPath2 fiPath2 buPath3 fiPath3 buPath4 
         fiPath4 
      WITH FRAME fMain.
