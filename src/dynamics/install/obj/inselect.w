...
&Scoped-Define ENABLED-OBJECTS edComment seList 
&Scoped-Define DISPLAYED-OBJECTS edComment seList 
...
DEFINE FRAME fMain
     ...
     seList AT ROW 7.57 COL 1.8 NO-LABEL
...
------------------------------------------------------------------------------*/
  DISPLAY edComment seList 
      WITH FRAME fMain.
  ENABLE edComment seList 
      WITH FRAME fMain.
