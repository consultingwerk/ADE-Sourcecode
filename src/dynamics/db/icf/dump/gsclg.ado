...
<dataset Transactions="1"><dataset_header DisableRI="yes" DatasetObj="1007600119.08" DateFormat="mdy" FullHeader="no" SCMManaged="no" YearOffset="1950" DatasetCode="GSCLG" NumericFormat="AMERICAN" NumericDecimal="." OriginatingSite="90" NumericSeparator=","/>
