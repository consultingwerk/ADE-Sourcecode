...
<dataset Transactions="1"><dataset_header DisableRI="yes" DatasetObj="1007600162.08" DateFormat="mdy" FullHeader="no" SCMManaged="no" YearOffset="1950" DatasetCode="GSCIA" NumericFormat="AMERICAN" NumericDecimal="." OriginatingSite="90" NumericSeparator=","/>
