...
<dataset Transactions="3"><dataset_header DisableRI="yes" DatasetObj="1007600117.08" DateFormat="mdy" FullHeader="no" SCMManaged="no" YearOffset="1950" DatasetCode="GSCNA" NumericFormat="AMERICAN" NumericDecimal="." OriginatingSite="90" NumericSeparator=","/>
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="gsc_nationality" version_date="10/02/2003" version_time="49459" version_user="admin" deletion_flag="no" entity_mnemonic="GSCNA" key_field_value="487" record_version_obj="3000058481.09" version_number_seq="1.09" secondary_key_value="ZA" import_version_number_seq="1.09"><nationality_obj>487</nationality_obj>
