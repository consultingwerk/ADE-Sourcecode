...
<dataset Transactions="1"><dataset_header DisableRI="yes" DatasetObj="1007600194.08" DateFormat="mdy" FullHeader="no" SCMManaged="no" YearOffset="1950" DatasetCode="GSCMM" NumericFormat="AMERICAN" NumericDecimal="." OriginatingSite="90" NumericSeparator=","/>
