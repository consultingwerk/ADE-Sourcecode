...
/*---------------------------------------------------------------------------------
  ...
  File: %EntityProp("TableFLA")trigd.i

  Description:  Dynamics Template delete trigger customisation

  Purpose:      This file is originally generated by ERwin from the template
                af/sup/aftemtrigd.i
                to hold customisations to the table delete trigger for additional
                validation, etc.
...
&scop object-name       %EntityProp("TableFLA")trigd.i
