...
/*---------------------------------------------------------------------------------
  ...
  File: %EntityProp("TableFLA")trigc.i

  Description:  Dynamics Template create trigger customisation

  Purpose:      This file is originally generated by ERwin from the template
                af/sup/aftemtrigc.i
                to hold customisations to the table create trigger for additional
                validation, etc.
  ...
  History:
  --------
  (v:010000)    Task:   ?           UserRef:    POSSE
                Date:   07/03/2002  Author:     Anthony Swindells
...
&scop object-name       %EntityProp("TableFLA")trigc.i
