...
"HTML Mapping Procedure Wizard

Use this wizard to create a new HTML Mapping procedure and associate form elements defined in a static HTML file with WebSpeed field objects, such as database or data object fields."
*/
&ANALYZE-RESUME
