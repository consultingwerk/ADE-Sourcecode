...
{&OUT} '  <tr> ~n'.
{&OUT} '    <td colspan="2" align="CENTER">' /*Tag=`*/ format-label('Procedure Settings', "COLUMN":U, "":U) /*Tag=`*/ '</td>   ~n'.
{&OUT} '  </tr>~n'.
{&OUT} '  <tr>~n'.
{&OUT} '    <td align="RIGHT">' /*Tag=`*/ format-label('Procedure Type', 'ROW':U, "":U) /*Tag=`*/ '</td>~n'.
{&OUT} '    <td><INPUT TYPE="TEXT" NAME="Type" VALUE="' /*Tag=`*/ html-encode(t-type) /*Tag=`*/ '" onChange="chkFld(this)~;">~n'.
{&OUT} '  </tr>~n'.
{&OUT} '  <tr>~n'.
{&OUT} '    <td>' /*Tag=`*/ format-label('Compile on Save', 'ROW':U, "":U) /*Tag=`*/ '</td>~n'.
{&OUT} '    <td><INPUT TYPE="RADIO" NAME="compile" VALUE="YES" ' /*Tag=`*/ 
         IF t-compile THEN " CHECKED":U ELSE "":U /*Tag=`*/ '>Yes~n'.
{&OUT} '        <INPUT TYPE="RADIO" NAME="compile" VALUE="NO"  ' /*Tag=`*/ 
        IF t-compile THEN "":U ELSE " CHECKED":U /*Tag=`*/ '>No~n'.
{&OUT} '    </td>~n'.
{&OUT} '  </tr>~n'.

 /*Tag=<script language="WebSpeed4GL">*/ 
...
/************************* END OF HTML *************************/
/*
** File: src/main/abl/workshop/_procset.w
** Generated on: 2021-03-15 16:17:37
** By: WebSpeed Embedded SpeedScript Preprocessor
** Version: 2
** Source file: src/main/abl/workshop/_procset.html
** Options: web-object
**
