...
PROCEDURE BuildPersistProc.
  /* Build a table of existing Persistent Procedures. After user's
...
PROCEDURE BuildAppServer.
  /* Build a table of existing AppServer connections. After user's
     code runs, any ones in addition to these are user created and
     will be deleted before ending. */
...
PROCEDURE BuildSocket.
  /* Build a table of existing Socket connections. After user's
     code runs, any ones in addition to these are user created and
     will be deleted before ending. */
...
PROCEDURE DeleteAppServer.
  /* Delete user-created AppServer connections by deleting the ones not
     in the table (ie, not present before running user's code). */
  DEFINE VARIABLE hAppServer AS HANDLE NO-UNDO.
...
PROCEDURE DeleteSocket.
  /* Delete user-created Socket connections by deleting the ones not
     in the table (ie, not present before running user's code). */
  DEFINE VARIABLE hSocket    AS HANDLE NO-UNDO.
