...
/*------------------------------------------------------------------------
  ...
  Description: Repository Static Data Load Window
...
DEFINE BUTTON buOK AUTO-GO DEFAULT 
     LABEL "&Import the Repository Static Data" 
     SIZE 85 BY 1.14
     BGCOLOR 8 .
...
DEFINE FRAME DEFAULT-FRAME
     ...
     "Select Root Directory Containing the Repository Static Data Dump Files to Load" VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Dynamics Repository Static Data Load"
         HEIGHT             = 13.24
         WIDTH              = 105.2
         MAX-HEIGHT         = 32.43
         MAX-WIDTH          = 163.8
...
ON END-ERROR OF C-Win /* ICF Repository Static Data Load */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* ICF Repository Static Data Load */
DO:
...
ON CHOOSE OF buOK IN FRAME DEFAULT-FRAME /* Import the Repository Static Data */
DO:
  ...
  MESSAGE "Do you wish to proceed with the loading of the repository static data using the" SKIP
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    IF edResults:INSERT-STRING("*** Start loading of ICF Repository Static Data ... (":U + STRING(TODAY) + " - " + STRING(TIME,"HH:MM:SS":U) + ")":U + "~n" + "~n") IN FRAME {&FRAME-NAME} THEN .
    ...
    THEN
    DO:
        IF edResults:INSERT-STRING("~n" + "*** ERROR with loading of Repository Static Data : ":U + cErrorValue + " ... (":U + STRING(TODAY) + " - " + STRING(TIME,"HH:MM:SS":U) + ")":U + "~n" + "~n") IN FRAME {&FRAME-NAME} THEN .
    END.

    /* Finish message */
    IF edResults:INSERT-STRING("~n" + "*** Finished load of ICF Repository Static Data ... (":U + STRING(TODAY) + " - " + STRING(TIME,"HH:MM:SS":U) + ")":U + "~n" + "~n") IN FRAME {&FRAME-NAME} THEN .
...
------------------------------------------------------------------------------*/
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        ASSIGN
            {&WINDOW-NAME}:TITLE = "Dynamics Repository Static Data Load":U
            .
