...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="04/02/2003" version_time="43291" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="1000000135.28" record_version_obj="1000000136.28" version_number_seq="28.09" secondary_key_value="gsc_global_control.default_language_obj#CHR(1)#0" import_version_number_seq="28.09"><smartobject_obj>1000000135.28</smartobject_obj>
