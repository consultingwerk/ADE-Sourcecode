...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="04/02/2003" version_time="43278" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="3000024505.09" record_version_obj="3000024506.09" version_number_seq="47.09" secondary_key_value="gst_audit.owning_reference#CHR(1)#0" import_version_number_seq="47.09"><smartobject_obj>3000024505.09</smartobject_obj>
