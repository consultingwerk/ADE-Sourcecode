...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="04/02/2003" version_time="43255" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="3892.19" record_version_obj="3000001742.09" version_number_seq="48.09" secondary_key_value="gsc_package_dataset.deploy_package_obj#CHR(1)#0" import_version_number_seq="48.09"><smartobject_obj>3892.19</smartobject_obj>
