...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="04/02/2003" version_time="43267" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="7372.38" record_version_obj="3000001751.09" version_number_seq="40.09" secondary_key_value="gst_deployment.originating_site_number#CHR(1)#0" import_version_number_seq="40.09"><smartobject_obj>7372.38</smartobject_obj>
