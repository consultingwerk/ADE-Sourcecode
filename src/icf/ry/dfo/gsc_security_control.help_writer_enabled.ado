...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="04/02/2003" version_time="43346" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="3000013873.09" record_version_obj="3000013874.09" version_number_seq="37.09" secondary_key_value="gsc_security_control.help_writer_enabled#CHR(1)#0" import_version_number_seq="37.09"><smartobject_obj>3000013873.09</smartobject_obj>
