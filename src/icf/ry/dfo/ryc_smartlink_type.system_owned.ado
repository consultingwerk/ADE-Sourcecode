...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="04/02/2003" version_time="43301" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="1005105028.101" record_version_obj="3000001730.09" version_number_seq="101.09" secondary_key_value="ryc_smartlink_type.system_owned#CHR(1)#0" import_version_number_seq="101.09"><smartobject_obj>1005105028.101</smartobject_obj>
