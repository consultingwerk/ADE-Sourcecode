...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="04/02/2003" version_time="43249" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="1005118143.101" record_version_obj="3000001774.09" version_number_seq="40.09" secondary_key_value="gsm_multi_media.category_obj#CHR(1)#0" import_version_number_seq="40.09"><smartobject_obj>1005118143.101</smartobject_obj>
