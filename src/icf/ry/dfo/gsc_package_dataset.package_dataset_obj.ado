...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="04/02/2003" version_time="43214" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="3923.19" record_version_obj="3000001743.09" version_number_seq="48.09" secondary_key_value="gsc_package_dataset.package_dataset_obj#CHR(1)#0" import_version_number_seq="48.09"><smartobject_obj>3923.19</smartobject_obj>
