...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="04/02/2003" version_time="43285" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="3728.19" record_version_obj="3000001747.09" version_number_seq="37.09" secondary_key_value="gst_dataset_file.ado_filename#CHR(1)#0" import_version_number_seq="37.09"><smartobject_obj>3728.19</smartobject_obj>
