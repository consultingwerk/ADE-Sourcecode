...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="03/19/2003" version_time="54094" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="3000028450.09" record_version_obj="3000028451.09" version_number_seq="35.09" secondary_key_value="ryc_relationship.model_external_reference#CHR(1)#0" import_version_number_seq="35.09"><smartobject_obj>3000028450.09</smartobject_obj>
...
<character_value>This is a unique reference from the entity model diagram to identify the reference. In ERwin this equates to the %RelId macro and is globally unique (a GUID).
