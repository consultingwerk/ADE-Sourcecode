...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="04/02/2003" version_time="43297" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="1000000584.48" record_version_obj="1000000585.48" version_number_seq="29.09" secondary_key_value="ryc_customization_type.api_name#CHR(1)#0" import_version_number_seq="29.09"><smartobject_obj>1000000584.48</smartobject_obj>
