...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="03/19/2003" version_time="53867" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="3000013482.09" record_version_obj="3000013483.09" version_number_seq="35.09" secondary_key_value="gsc_product_module.relative_path#CHR(1)#0" import_version_number_seq="35.09"><smartobject_obj>3000013482.09</smartobject_obj>
