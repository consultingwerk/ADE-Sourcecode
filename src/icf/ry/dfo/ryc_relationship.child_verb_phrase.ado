...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="03/19/2003" version_time="54086" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="3000028426.09" record_version_obj="3000028427.09" version_number_seq="34.09" secondary_key_value="ryc_relationship.child_verb_phrase#CHR(1)#0" import_version_number_seq="34.09"><smartobject_obj>3000028426.09</smartobject_obj>
