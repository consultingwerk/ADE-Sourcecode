...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="04/02/2003" version_time="43387" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="7341.38" record_version_obj="3000001763.09" version_number_seq="39.09" secondary_key_value="gst_deployment.manual_record_selection#CHR(1)#0" import_version_number_seq="39.09"><smartobject_obj>7341.38</smartobject_obj>
