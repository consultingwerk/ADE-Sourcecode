...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="04/02/2003" version_time="43384" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="3000026302.09" record_version_obj="3000026303.09" version_number_seq="37.09" secondary_key_value="gst_record_version.import_version_number_seq#CHR(1)#0" import_version_number_seq="37.09"><smartobject_obj>3000026302.09</smartobject_obj>
