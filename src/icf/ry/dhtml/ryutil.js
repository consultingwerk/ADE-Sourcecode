...
function escapedata(a){
  a.replace(/\r/g,'');   // get rid of automatically inserted Carriage-returns
  return a;
}
...
// Now that we are done loading all the files, start the application
apph.startApplication('prg.'+appcontrol.startprog); 
