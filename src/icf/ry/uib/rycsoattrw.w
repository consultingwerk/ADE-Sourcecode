...
&Scoped-define OPEN-QUERY-brObjectInstance OPEN QUERY brObjectInstance FOR EACH ryc_object_instance ~
      ...
      AND lb_ryc_smartobject.smartobject_obj = ryc_object_instance.container_smartobject_obj NO-LOCK INDEXED-REPOSITION.
...
&Scoped-define OPEN-QUERY-br_attributevalue OPEN QUERY br_attributevalue FOR EACH ryc_attribute_value ~
 ...
 AND ryc_attribute_value.object_instance_obj = 0 NO-LOCK INDEXED-REPOSITION.
...
/* Query rebuild information for BROWSE brObjectInstance
     ...
     _Where[2]         = "lb_ryc_smartobject.smartobject_obj = ryc_object_instance.container_smartobject_obj"
...
/* Query rebuild information for BROWSE br_attributevalue
 ...
 AND RYDB.ryc_attribute_value.object_instance_obj = 0"
...
DO:
    ...
    IF RETURN-VALUE <> "" OR ERROR-STATUS:ERROR THEN RUN display-errors.p.
