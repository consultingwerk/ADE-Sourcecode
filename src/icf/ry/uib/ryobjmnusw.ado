...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="03/20/2003" version_time="56933" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="16612.53" record_version_obj="16613.53" version_number_seq="2.09" secondary_key_value="ryobjmnusw#CHR(1)#0" import_version_number_seq="2.09"><smartobject_obj>16612.53</smartobject_obj>
