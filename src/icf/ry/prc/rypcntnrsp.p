...
------------------------------------------------------------------------------*/
  ...
  ASSIGN
      lSuccess = {fnarg disableActions 'New,cbCopy,cbDelete,cbSave,cbUndo,cbCancel,cbMoveUp,cbMoveDown' ghBrowseToolbar}
  ...
  IF iSequence <> ? THEN
    IF iSequence = 0 THEN
      {fnarg disableActions 'cbDelete' ghBrowseToolbar}.
    ELSE
