...
------------------------------------------------------------------------------*/
  ...
  IF pdObjectInstanceObj <> gdObjectInstanceObj OR glRefresh THEN
  DO:
    ASSIGN
...
------------------------------------------------------------------------------*/
  ...
  DO:
    ...
    IF pdHeight > dFrameHeight THEN ghFrame:HEIGHT-CHARS = pdHeight.
    IF pdWidth  > dFrameWidth  THEN ghFrame:WIDTH-CHARS  = pdWidth.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN
      ...
      ghSourceFieldLabel:WIDTH-CHARS = (pdWidth - ghBuMap:WIDTH-CHARS - 2.50) / 2 /* Wider Target: (pdWidth - ghBuMap:WIDTH-CHARS - 2.50) / 3  */
      ...
      ghSeMappedFields:WIDTH-CHARS   = pdWidth - ghBuUnMap:WIDTH-CHARS - 2.25
      ...
      ghBuUnMap:ROW                  = ghBuUnMap:ROW          + dDifference.
