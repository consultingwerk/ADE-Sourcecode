...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="02/14/2002" version_time="36362" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="4999.19" record_version_obj="3000001734.09" version_number_seq="16.09" secondary_key_value="gscdpviewv#CHR(1)#0" import_version_number_seq="16.09"><smartobject_obj>4999.19</smartobject_obj>
