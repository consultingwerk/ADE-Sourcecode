...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="02/14/2002" version_time="36370" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="7507.38" record_version_obj="3000001746.09" version_number_seq="72.09" secondary_key_value="gstdpviewv#CHR(1)#0" import_version_number_seq="72.09"><smartobject_obj>7507.38</smartobject_obj>
