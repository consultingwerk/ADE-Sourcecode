...
/*---------------------------------------------------------------------------------
  ...
  Description:  Attribute type SDF

  Purpose:      Attribute type SDF
...
DEFINE FRAME frMain
     coCombo AT ROW 1 COL 20.6 COLON-ALIGNED
...
ON VALUE-CHANGED OF coCombo IN FRAME frMain /* Attribute Type */
DO:
