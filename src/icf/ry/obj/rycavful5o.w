...
&glob DATA-LOGIC-PROCEDURE       ry/obj/rycavlog5p.p
...
&Scoped-Define DATA-FIELDS  attribute_value_obj object_type_obj container_smartobject_obj~
 smartobject_obj object_instance_obj collect_attribute_value_obj~
 collection_sequence inheritted_value constant_value attribute_group_obj~
 attribute_type_tla attribute_label primary_smartobject_obj attribute_value~
...
&Scoped-Define DATA-FIELD-DEFS "ry/obj/rycavful5o.i"
{&DB-REQUIRED-START}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH ryc_attribute_value ~
...
/* Query rebuild information for SmartDataObject Query-Main
     ...
     _Where[1]         = "ryc_attribute_value.smartobject_obj = 0
...
"object_instance_obj" "object_instance_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 21 yes
     _FldNameList[6]   > icfdb.ryc_attribute_value.collect_attribute_value_obj
"collect_attribute_value_obj" "collect_attribute_value_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 21 yes
     _FldNameList[7]   > icfdb.ryc_attribute_value.collection_sequence
"collection_sequence" "collection_sequence" ? ? "integer" ? ? ? ? ? ? yes ? no 4 yes
     _FldNameList[8]   > icfdb.ryc_attribute_value.inheritted_value
"inheritted_value" "inheritted_value" ? ? "logical" ? ? ? ? ? ? yes ? no 1 yes
     _FldNameList[9]   > icfdb.ryc_attribute_value.constant_value
"constant_value" "constant_value" ? ? "logical" ? ? ? ? ? ? yes ? no 1 yes
     _FldNameList[10]   > icfdb.ryc_attribute_value.attribute_group_obj
"attribute_group_obj" "attribute_group_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 21 yes
     _FldNameList[11]   > icfdb.ryc_attribute_value.attribute_type_tla
"attribute_type_tla" "attribute_type_tla" ? ? "character" ? ? ? ? ? ? yes ? no 6 yes
     _FldNameList[12]   > icfdb.ryc_attribute_value.attribute_label
"attribute_label" "attribute_label" ? ? "character" ? ? ? ? ? ? yes ? no 70 yes
     _FldNameList[13]   > icfdb.ryc_attribute_value.primary_smartobject_obj
"primary_smartobject_obj" "primary_smartobject_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 21 yes
     _FldNameList[14]   > icfdb.ryc_attribute_value.attribute_value
"attribute_value" "attribute_value" ? ? "character" ? ? ? ? ? ? yes ? no 70 yes
     _FldNameList[15]   > "_<CALC>"
"dynamic-function(""FormatAttributeValue"":U in gshRepositoryManager, input RowObject.attribute_type_tla, input RowObject.attribute_value)" "FormattedAttributeValue" "Formatted Attribute Value" "x(8)" "character" ? ? ? ? ? ? no ? no 23.8 no
