...
/* ***************************  Main Block  *************************** */
/* Start the super procedure that controls the behaviour of the Dynamics 
 * dynamic SmartDataViewer.                                              */
RUN start-super-proc IN TARGET-PROCEDURE ("ry/prc/rydynviewp.p":U).
