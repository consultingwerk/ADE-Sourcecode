...
RowObject.constant_level RowObject.is_private RowObject.runtime_only ~
RowObject.system_owned RowObject.derived_value RowObject.design_only ~
RowObject.lookup_type RowObject.lookup_value 
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN resizeObject IN h_dyncombo ( 1.00 , 74.80 ) NO-ERROR.
