...
&Scoped-define INTERNAL-TABLES ryc_smartobject

/* Definitions for QUERY Query-Main                                     */
&Scoped-Define ENABLED-FIELDS  layout_obj object_type_obj object_obj object_filename product_module_obj~
 static_object custom_super_procedure system_owned shutdown_message_text~
 sdo_smartobject_obj template_smartobject
&Scoped-define ENABLED-FIELDS-IN-ryc_smartobject layout_obj object_type_obj ~
object_obj object_filename product_module_obj static_object ~
custom_super_procedure system_owned shutdown_message_text ~
sdo_smartobject_obj template_smartobject 
&Scoped-Define DATA-FIELDS  smartobject_obj layout_obj object_type_obj object_obj object_filename~
 product_module_obj static_object custom_super_procedure system_owned~
 shutdown_message_text sdo_smartobject_obj template_smartobject
&Scoped-define DATA-FIELDS-IN-ryc_smartobject smartobject_obj layout_obj ~
object_type_obj object_obj object_filename product_module_obj static_object ~
custom_super_procedure system_owned shutdown_message_text ~
sdo_smartobject_obj template_smartobject 
...
"smartobject_obj" "smartobject_obj" ? ? "decimal" ? ? ? ? ? ? no ? no 29.4 yes
     _FldNameList[2]   > icfdb.ryc_smartobject.layout_obj
"layout_obj" "layout_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 29.4 yes
     _FldNameList[3]   > icfdb.ryc_smartobject.object_type_obj
"object_type_obj" "object_type_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 29.4 yes
     _FldNameList[4]   > icfdb.ryc_smartobject.object_obj
...
"object_filename" "object_filename" ? ? "character" ? ? ? ? ? ? yes ? no 70 yes
     _FldNameList[6]   > icfdb.ryc_smartobject.product_module_obj
...
"static_object" "static_object" ? ? "logical" ? ? ? ? ? ? yes ? no 12.2 yes
     _FldNameList[8]   > icfdb.ryc_smartobject.custom_super_procedure
...
"system_owned" "system_owned" ? ? "logical" ? ? ? ? ? ? yes ? no 14.2 yes
     _FldNameList[10]   > icfdb.ryc_smartobject.shutdown_message_text
"shutdown_message_text" "shutdown_message_text" ? ? "character" ? ? ? ? ? ? yes ? no 70 yes
     _FldNameList[11]   > icfdb.ryc_smartobject.sdo_smartobject_obj
"sdo_smartobject_obj" "sdo_smartobject_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 29.4 yes
     _FldNameList[12]   > icfdb.ryc_smartobject.template_smartobject
