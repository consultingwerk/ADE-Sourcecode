  ...
  FIELD collection_sequence LIKE ryc_attribute_value.collection_sequence VALIDATE ~
  ...
  FIELD FormattedAttributeValue AS CHARACTER FORMAT "x(8)" LABEL "Formatted Attribute Value"
