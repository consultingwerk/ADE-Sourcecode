  ...
  FIELD securityObject AS DECIMAL FORMAT "999999999999999999.999999999" LABEL "Security Object"~
  FIELD number_of_users-2 LIKE gsc_product.number_of_users VALIDATE ~
  FIELD toolbarMultiMedia AS DECIMAL FORMAT "999999999999999999.999999999" LABEL "Multi Media"~
  FIELD product_description LIKE gsc_product.product_description VALIDATE ~
  FIELD physicalObject AS DECIMAL FORMAT "999999999999999999.999999999" LABEL "Physical Object"~
  FIELD product_installed LIKE gsc_product.product_installed VALIDATE ~
  FIELD dObjectInstance AS DECIMAL FORMAT "999999999999999999.999999999" LABEL "Object Instance"~
