  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             INPUT  'DisplayedFieldryc_layout.layout_nameKeyFieldryc_layout.layout_objFieldLabelPage LayoutFieldTooltipSelect option from listKeyFormat>>>>>>>>>>>>>>>>>9.999999999KeyDatatypedecimalDisplayFormatX(28)DisplayDatatypecharacterBaseQueryStringFOR EACH ryc_layout NO-LOCKQueryTablesryc_layoutSDFFileNameSDFTemplateParentFieldParentFilterQueryDescSubstitute&1ComboDelimiterListItemPairsInnerLines5ComboFlagFlagValueBuildSequence1SecurednoCustomSuperProcPhysicalTableNamesTempTablesQueryBuilderJoinCodeQueryBuilderOptionListQueryBuilderOrderListQueryBuilderTableOptionListQueryBuilderTuneOptionsQueryBuilderWhereClausesFieldNamedPageLayoutDisplayFieldyesEnableFieldyesLocalFieldnoHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT hPageLayout ).
...
*/
    ...
    IF DYNAMIC-FUNCTION("getUserProperty":U IN ghContainerSource, "ContainerMode":U) <> "MODIFY":U THEN
    ...
    DO:
      ...
      IF dCustomizationResultObj <> 0.00 THEN
      DO:
        httPage:FIND-FIRST("WHERE i_page_sequence            = ":U + STRING(ghPage:BUFFER-FIELD("i_page_sequence":U):BUFFER-VALUE)
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    CASE pcAction:
      ...
      DO:
        ...
        END.
        ELSE
          httPage:FIND-FIRST("WHERE i_page_sequence = ":U + fiPageSequence:SCREEN-VALUE
                            + " AND c_action       <> 'D'":U
                            + " AND d_customization_result_obj = ":U + QUOTER(dCustomizationResultObj)).
