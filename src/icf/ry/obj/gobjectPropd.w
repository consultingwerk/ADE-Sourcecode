  ...
  CASE currentPage: 
    ...
    WHEN 1 THEN DO:
       RUN constructObject (
             ...
             INPUT  FRAME diDialog:HANDLE ,
             INPUT  'EnabledObjFldsToDisable(None)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNamegscobvietv.wDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_gscobvietv ).
       RUN repositionObject IN h_gscobvietv ( 4.81 , 3.80 ) NO-ERROR.
       /* Size in AB:  ( 15.10 , 97.20 ) */
