...
/*---------------------------------------------------------------------------------
  ...
  Description:  Customization Reference Static SDV

  Purpose:      Customization Reference Static SDV
...
&Scoped-Define ENABLED-FIELDS RowObject.customization_reference 
&Scoped-define ENABLED-TABLES RowObject
&Scoped-define FIRST-ENABLED-TABLE RowObject
&Scoped-Define DISPLAYED-FIELDS RowObject.customization_reference 
...
DEFINE VARIABLE hCustomizationResult AS HANDLE NO-UNDO.
...
/* Settings for THIS-PROCEDURE
   ...
   Data Source: "ry/obj/rymczfullo.w"
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN adjustTabOrder ( hCustomizationType ,
             RowObject.customization_reference:HANDLE IN FRAME frMain , 'BEFORE':U ).
       RUN adjustTabOrder ( hCustomizationResult ,
             hCustomizationType , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  RUN disableField IN hCustomizationResult.
