...
DO WHILE VALID-HANDLE(hWindow):
  IF LOOKUP("setMultiInstanceActivated":U, hWindow:INTERNAL-ENTRIES) > 0
     AND hWindow:FILE-NAME <> "adm2/containr.p":U THEN 
   DYNAMIC-FUNCTION("setMultiInstanceActivated":U IN hWindow,lOneWindow).
