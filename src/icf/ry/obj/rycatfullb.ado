...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="10/02/2002" version_time="54418" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="1003571985" record_version_obj="2000000108.28" version_number_seq="1.09" secondary_key_value="rycatfullb#CHR(1)#0" import_version_number_seq="1.09"><smartobject_obj>1003571985</smartobject_obj>
