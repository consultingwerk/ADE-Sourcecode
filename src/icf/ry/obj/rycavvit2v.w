...
RowObject.container_smartobject_obj RowObject.object_instance_obj ~
...
DEFINE FRAME frMain
     ...
     RowObject.smartobject_obj AT ROW 1 COL 89.4 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 1.6 BY 1
     RowObject.container_smartobject_obj AT ROW 2.05 COL 87.4 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 1.4 BY 1
     RowObject.object_instance_obj AT ROW 2.05 COL 89.4 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 1.4 BY 1
     ...
     RowObject.attribute_value AT ROW 4.14 COL 21 NO-LABEL
          ...
          SIZE 72 BY 8.76
     RowObject.constant_value AT ROW 12.91 COL 21
          VIEW-AS TOGGLE-BOX
          SIZE 19.4 BY .81
     RowObject.inheritted_value AT ROW 13.71 COL 21
          VIEW-AS TOGGLE-BOX
          SIZE 19.8 BY .81
