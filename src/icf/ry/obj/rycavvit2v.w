...
RowObject.character_value RowObject.integer_value RowObject.decimal_value ~
RowObject.date_value RowObject.logical_value 
...
RowObject.object_instance_obj RowObject.constant_value ~
RowObject.character_value RowObject.integer_value RowObject.decimal_value ~
RowObject.date_value RowObject.logical_value RowObject.data_type 
...
DEFINE VARIABLE toIncludeDesign AS LOGICAL INITIAL no 
     LABEL "Show Designtime Attributes for Lookup" 
     VIEW-AS TOGGLE-BOX
...
ON VALUE-CHANGED OF toIncludeDesign IN FRAME frMain /* Show Designtime Attributes for Lookup */
DO:
                ...
                DO:
                    ...
                    CASE cLevel:
                      WHEN "ObjectType":U THEN DO:
                        DO WITH FRAME {&FRAME-NAME}:
                          ASSIGN RowObject.primary_smartobject_obj:SCREEN-VALUE   = "0.000000":U
                                 RowObject.container_smartobject_obj:SCREEN-VALUE = "0.000000":U
                                 RowObject.smartobject_obj:SCREEN-VALUE           = "0.000000":U
                                 RowObject.object_type_obj:SCREEN-VALUE           = ENTRY(2, cColValues, CHR(1))
                                 RowObject.object_instance_obj:SCREEN-VALUE       = "0.000000":U.
                        END.
                      END.
