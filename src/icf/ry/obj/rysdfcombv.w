...
&Scoped-Define ENABLED-OBJECTS buClear fiResizeBar 
...
DEFINE FRAME frPage2
     ...
     fiParentFilterQueryLabel AT ROW 4.19 COL 2.2 COLON-ALIGNED NO-LABEL
...
DO:
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    IF iEntry > 0 THEN DO:
      ...
      IF cLabel <> "":U AND (fiFieldLabel:SCREEN-VALUE = "":U OR gcSaveDisplayField <> coKeyField:SCREEN-VALUE) THEN
