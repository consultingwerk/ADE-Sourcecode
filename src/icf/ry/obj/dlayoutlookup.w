...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH gsc_object_type ~
      WHERE (gsc_object_type.object_type_code = "dynobjc" OR ~
 gsc_object_type.object_type_code = "dynmenc" OR ~
 gsc_object_type.object_type_code = "dynwind" OR ~
 gsc_object_type.object_type_code = "dynfold") NO-LOCK, ~
...
/* Query rebuild information for SmartDataObject Query-Main
     _TblList          = "ICFDB.gsc_object_type,ICFDB.ryc_smartobject OF ICFDB.gsc_object_type ,ICFDB.gsc_object OF ICFDB.gsc_object_type,ICFDB.gsc_product_module WHERE ICFDB.ryc_smartobject ..."
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _TblOptList       = ",, FIRST,"
     _Where[1]         = "(gsc_object_type.object_type_code = ""dynobjc"" OR
 gsc_object_type.object_type_code = ""dynmenc"" OR
 gsc_object_type.object_type_code = ""dynwind"" OR
 gsc_object_type.object_type_code = ""dynfold"")"
