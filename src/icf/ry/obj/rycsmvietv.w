...
------------------------------------------------------------------------------*/
  ...
  IF NOT glAdd THEN DO WITH FRAME {&FRAME-NAME}:
    ...
    IF dSourceObj <> 0 AND DECIMAL(cInstance) = 0 THEN
