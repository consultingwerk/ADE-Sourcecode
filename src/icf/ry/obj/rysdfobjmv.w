...
&Scoped-Define ENABLED-OBJECTS coObjType ToSave fiProdModObj 
&Scoped-Define DISPLAYED-OBJECTS coObjType ToSave fiObjectDescription 
...
DEFINE BUTTON buWhereUsed 
     LABEL "&Where Used" 
     SIZE 15 BY 1.14 TOOLTIP "Find out where this SDF is currently used."
     BGCOLOR 8 .
...
DO:
  ...
  THEN DO:
      ...
      IF glNew AND cDataValue <> "":U THEN DO:
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             INPUT  'DisplayedFieldryc_smartobject.object_filenameKeyFieldryc_smartobject.object_filenameFieldLabelSmartDataFieldFieldTooltipPress F4 to Lookup existing SmartDataFieldsKeyFormatX(70)KeyDatatypecharacterDisplayFormatX(70)DisplayDatatypecharacterBaseQueryStringFOR EACH gsc_object_type NO-LOCK, EACH ryc_smartobject NO-LOCK
                     ...
                     BY gsc_object_type.object_type_code BY ryc_smartobject.object_filename INDEXED-REPOSITIONQueryTablesgsc_object_type,ryc_smartobject,gsc_product_moduleBrowseFieldsryc_smartobject.object_filename,gsc_object_type.object_type_code,gsc_product_module.product_module_code,ryc_smartobject.object_descriptionBrowseFieldDataTypescharacter,character,character,characterBrowseFieldFormatsX(70)|X(15)|X(10)|X(35)RowsToBatch200BrowseTitleLookup SmartDataFieldViewerLinkedFieldsgsc_object_type.object_type_code,gsc_product_module.product_module_code,ryc_smartobject.object_descriptionLinkedFieldDataTypescharacter,character,characterLinkedFieldFormatsX(15),X(10),X(35)ViewerLinkedWidgetsraObjectType,?,fiObjectDescriptionColumnLabelsColumnFormatSDFFileNamemark1SDFTemplateLookupImageadeicon/select.bmpParentFieldfiValidTypesParentFilterQueryLOOKUP(gsc_object_type.object_type_code,~'&1~') > 0|MaintenanceObjectMaintenanceSDOCustomSuperProcPhysicalTableNamesTempTablesQueryBuilderJoinCodeQueryBuilderOptionListQueryBuilderOrderListQueryBuilderTableOptionListQueryBuilderTuneOptionsQueryBuilderWhereClausesPopupOnAmbiguousyesPopupOnUniqueAmbiguousnoPopupOnNotAvailnoBlankOnNotAvailnoFieldName<Local1>DisplayFieldyesEnableFieldyesLocalFieldyesHideOnInitnoDisableOnInitnoObjectLayout':U ,
       ...
       RUN constructObject (
             ...
             INPUT  'DisplayedFieldryc_smartobject.object_filenameKeyFieldryc_smartobject.object_filenameFieldLabelSuper ProcedureFieldTooltipPress F4 to Lookup a Super ProcedureKeyFormatX(70)KeyDatatypecharacterDisplayFormatX(70)DisplayDatatypecharacterBaseQueryStringFOR EACH gsc_object_type NO-LOCK
                     ...
                     WHERE ryc_smartobject.object_type_obj = gsc_object_type.object_type_obj,
                     FIRST gsc_product_module NO-LOCK
                     WHERE gsc_product_module.product_module_obj = ryc_smartobject.product_module_obj AND [EXCLUDE_REPOSITORY_PRODUCT_MODULES] INDEXED-REPOSITIONQueryTablesgsc_object_type,ryc_smartobject,gsc_product_moduleBrowseFieldsryc_smartobject.object_filename,ryc_smartobject.object_description,gsc_product_module.product_module_code,ryc_smartobject.template_smartobjectBrowseFieldDataTypescharacter,character,character,logicalBrowseFieldFormatsX(70)|X(35)|X(10)|YES/NORowsToBatch200BrowseTitleLookup Custom Super ProcedureViewerLinkedFieldsLinkedFieldDataTypesLinkedFieldFormatsViewerLinkedWidgetsColumnLabelsColumnFormatSDFFileNameSDFTemplateLookupImageadeicon/select.bmpParentFieldParentFilterQueryMaintenanceObjectMaintenanceSDOCustomSuperProcPhysicalTableNamesTempTablesQueryBuilderJoinCodeQueryBuilderOptionListQueryBuilderOrderListQueryBuilderTableOptionListQueryBuilderTuneOptionsQueryBuilderWhereClausesPopupOnAmbiguousyesPopupOnUniqueAmbiguousnoPopupOnNotAvailnoBlankOnNotAvailnoFieldName<Local5>DisplayFieldyesEnableFieldnoLocalFieldyesHideOnInitnoDisableOnInitnoObjectLayout':U ,
       ...
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'DisplayedFieldgsc_product_module.product_module_code,gsc_product_module.product_module_descriptionKeyFieldgsc_product_module.product_module_codeFieldLabelProduct Module CodeFieldTooltipSelect option from listKeyFormatX(10)KeyDatatypecharacterDisplayFormatX(10)DisplayDatatypecharacterBaseQueryStringFOR EACH gsc_product_module
                     WHERE [EXCLUDE_REPOSITORY_PRODUCT_MODULES] NO-LOCK BY gsc_product_module.product_module_code INDEXED-REPOSITIONQueryTablesgsc_product_moduleSDFFileNameSDFTemplateParentFieldParentFilterQueryDescSubstitute&1 / &2ComboDelimiterListItemPairsInnerLines5ComboFlagFlagValueBuildSequence1SecurednoCustomSuperProcPhysicalTableNamesTempTablesQueryBuilderJoinCodeQueryBuilderOptionListQueryBuilderOrderListQueryBuilderTableOptionListQueryBuilderTuneOptionsQueryBuilderWhereClausesFieldName<Local4>DisplayFieldyesEnableFieldyesLocalFieldyesHideOnInitnoDisableOnInitnoObjectLayout':U ,
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    ...
    fiObjectDescription:SCREEN-VALUE = ghDataTable:BUFFER-FIELD("cObjectDescription":U):BUFFER-VALUE.
...
------------------------------------------------------------------------------*/
  ...
  IF VALID-HANDLE(ghSDFObject) THEN DO:
    ...
    DO WITH FRAME {&FRAME-NAME}:
      ...
      ASSIGN fiValidTypes:SCREEN-VALUE IN FRAME {&FRAME-NAME} = cSDFType.
    END.
    ...
    IF VALID-HANDLE(ghDataTable) THEN DO:
      ...
      IF ghDataTable:AVAILABLE THEN DO:
        ...
        IF glIsDynView AND 
           TRIM(ghDataTable:BUFFER-FIELD("cBaseQueryString":U):BUFFER-VALUE) = "":U THEN
          glUpdateMasterOnly = TRUE.
        IF ghDataTable:BUFFER-FIELD("cSDFFileName":U):BUFFER-VALUE = "":U THEN DO:
...
IF glNew AND (LASTKEY = KEYCODE("TAB") OR LASTKEY = 609 OR LASTKEY = -1) AND NOT glAppliedLeave THEN DO:
  glAppliedLeave = TRUE.
  RUN leavelookup IN hObjectFileName.
  RETURN.
END.
        ...
        IF pcKeyFieldValue <> "":U THEN DO:
          ...
          IF VALID-HANDLE(ghDataTable) THEN DO:
            ...
            IF ghDataTable:AVAILABLE AND 
               ghDataTable:BUFFER-FIELD("cBaseQueryString"):BUFFER-VALUE <> "":U THEN DO:
          ...
          IF VALID-HANDLE(ghDataTable) THEN DO:
            ...
            IF ghDataTable:AVAILABLE AND 
              ...
              ASSIGN toSave:CHECKED IN FRAME {&FRAME-NAME} = FALSE.
              DISABLE fiObjectDescription toSave buWhereUsed WITH FRAME {&FRAME-NAME}.
              PUBLISH "disableObject" FROM ghContainerSource.
              glNeedToSave = TRUE.
...
------------------------------------------------------------------------------*/
  ...
  CASE pcState:
    ...
    WHEN "Find":U THEN DO:
      ...
      RUN disableField IN hCustomSuperProcedure.
      RUN enableField IN hObjectFilename.
      DISABLE buWhereUsed coObjType fiObjectDescription WITH FRAME {&FRAME-NAME}.
      PUBLISH "disableObject" FROM ghContainerSource.
    ...
    WHEN "Modify":U THEN DO:
      IF NOT glStaticSDF THEN DO:
        ...
        RUN disableField IN hProductModule.
        RUN enableField IN hCustomSuperProcedure.
        ENABLE fiObjectDescription buWhereUsed WITH FRAME {&FRAME-NAME}.
      END.
      ELSE
    ...
    WHEN "Cancel":U THEN DO:
      ...
      RUN disableField IN hProductModule.
      DISABLE buWhereUsed coObjType fiObjectDescription 
              WITH FRAME {&FRAME-NAME}.
