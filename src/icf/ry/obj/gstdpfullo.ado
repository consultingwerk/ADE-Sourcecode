...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/30/2002" version_time="23755" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="7483.38" record_version_obj="3000001745.09" version_number_seq="106.09" secondary_key_value="gstdpfullo#CHR(1)#0" import_version_number_seq="106.09"><smartobject_obj>7483.38</smartobject_obj>
