...
/*---------------------------------------------------------------------------------
  ...
  Description:  ryc_page_object Data Logic Procedure Library Template

  Purpose:      A procedure library (PLIP) to support the maintenance of the ryc_page_object table
...
&GLOB DATA-LOGIC-TABLE ryc_page_object
&GLOB DATA-FIELD-DEFS  "ry/obj/rycpoful2o.i"
...
------------------------------------------------------------------------------*/
  ...
  IF CAN-FIND(FIRST ryc_page_object 
              WHERE ryc_page_object.container_smartobject_obj = b_ryc_page_object.container_smartobject_obj
                AND ryc_page_object.page_obj = b_ryc_page_object.page_obj
                AND ryc_page_object.page_object_sequence = b_ryc_page_object.page_object_sequence) THEN
  DO:
     ASSIGN
        cValueList   = STRING(b_ryc_page_object.container_smartobject_obj) + ', ' + STRING(b_ryc_page_object.page_obj) + ', ' + STRING(b_ryc_page_object.page_object_sequence)
        cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                      {af/sup2/aferrortxt.i 'AF' '8' 'ryc_page_object' '' "'container_smartobject_obj, page_obj, page_object_sequence, '" cValueList }.
  END.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN cDescription = "Astra 2 ryc_page_object Data Logic Procedure".
...
------------------------------------------------------------------------------*/
  ...
  IF b_ryc_page_object.container_smartobject_obj = 0 OR b_ryc_page_object.container_smartobject_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {af/sup2/aferrortxt.i 'AF' '1' 'ryc_page_object' 'container_smartobject_obj' "'Container SmartObject Obj'"}.

  IF b_ryc_page_object.page_obj = 0 OR b_ryc_page_object.page_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {af/sup2/aferrortxt.i 'AF' '1' 'ryc_page_object' 'page_obj' "'Page Obj'"}.

  IF b_ryc_page_object.page_object_sequence = 0 OR b_ryc_page_object.page_object_sequence = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {af/sup2/aferrortxt.i 'AF' '1' 'ryc_page_object' 'page_object_sequence' "'Page Object Sequence'"}.

  IF b_ryc_page_object.object_instance_obj = 0 OR b_ryc_page_object.object_instance_obj = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {af/sup2/aferrortxt.i 'AF' '1' 'ryc_page_object' 'object_instance_obj' "'Object Instance Obj'"}.
...
------------------------------------------------------------------------------*/
  ...
  IF NOT isCreate() AND CAN-FIND(FIRST ryc_page_object 
              WHERE ryc_page_object.container_smartobject_obj = b_ryc_page_object.container_smartobject_obj
                AND ryc_page_object.page_obj = b_ryc_page_object.page_obj
                AND ryc_page_object.page_object_sequence = b_ryc_page_object.page_object_sequence
                AND ROWID(ryc_page_object) <> TO-ROWID(ENTRY(1,b_ryc_page_object.RowIDent))) THEN
  DO:
     ASSIGN
        cValueList   = STRING(b_ryc_page_object.container_smartobject_obj) + ', ' + STRING(b_ryc_page_object.page_obj) + ', ' + STRING(b_ryc_page_object.page_object_sequence)
        cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
