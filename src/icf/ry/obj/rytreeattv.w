...
ON VALUE-CHANGED OF ToShowRootLines IN FRAME frMain /* ShowRootLines */
DO:
  IF glTrackChanges THEN DO:
    PUBLISH "changesMade":U FROM ghContainerSource.
