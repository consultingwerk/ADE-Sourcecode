...
DEFINE VARIABLE gcFetchObjectBufferHandles AS CHARACTER  NO-UNDO.
...
/* TEMP-TABLE definition needed to load the correct application icon */
...
CASE pcNodeType:
  ...
  DO:
    ...
    ASSIGN hKey:BUFFER-VALUE             = DYNAMIC-FUNC('getNextNodeKey':U IN h_dyntreeview)
     ...
     RUN populatetree IN h_dyntreeview (hTable,cParentKey).
     DYNAMIC-FUNCTION("setProperty":U IN h_dyntreeview,"SELECTEDITEM":U,ckey,"").
     RUN treeClick (ckey,hTag:BUFFER-VALUE).
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             INPUT  'AppServiceAstraASUsePromptnoASInfoDataColumnscontrol_padding,control_spacing,disabled,menu_item_obj,menu_structure_code,menu_structure_description,menu_structure_hidden,menu_structure_obj,menu_structure_type,product_module_obj,product_obj,system_owned,under_development,menu_structure_narrativeForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamegsmmsfulloUpdateFromSourcenoToggleDataTargetsyesOpenOnInityesPromptOnDeleteyesPromptColumns(NONE)':U ,
             OUTPUT h_gsmmsfullo ).
       ...
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'AppServiceAstraASUsePromptASInfoDataColumnschild_menu_structure_obj,menu_item_obj,menu_item_sequence,menu_structure_item_obj,menu_structure_obj,item_control_type,item_toolbar_label,menu_item_label,menu_item_description,menu_item_referenceForeignFieldsgsm_menu_structure_item.menu_structure_obj,menu_structure_objRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamegsmitfulloUpdateFromSourcenoToggleDataTargetsyesOpenOnInityesPromptOnDeleteyesPromptColumns(NONE)':U ,
             OUTPUT h_gsmitfullo ).
       ...
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'AppServiceAstraASUsePromptnoASInfoDataColumnsobject_filename,object_description,container_object,menu_structure_code,menu_structure_type,object_obj,menu_structure_obj,instance_attribute_obj,object_menu_structure_obj,menu_item_obj,insert_submenu,menu_structure_sequence,dummy_fieldForeignFieldsgsm_object_menu_structure.menu_structure_obj,menu_structure_objRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamegsmomfulloUpdateFromSourcenoToggleDataTargetsyesOpenOnInityesPromptOnDeleteyesPromptColumns(NONE)':U ,
             OUTPUT h_gsmomfullo ).
       ...
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'AppServiceAstraASUsePromptASInfoDataColumnsitem_category_description,item_category_label,item_category_obj,item_link,parent_item_category_obj,system_ownedForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamegscicfulloUpdateFromSourcenoToggleDataTargetsyesOpenOnInityesPromptOnDeleteyesPromptColumns(NONE)':U ,
             OUTPUT h_gscicfullo ).
       ...
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'AppServiceAstraASUsePromptnoASInfoDataColumnsdisabled,disable_rule,enable_rule,hide_if_disabled,hide_rule,image1_down_filename,image1_insensitive_filename,image1_up_filename,image2_down_filename,image2_insensitive_filename,image2_up_filename,instance_attribute_obj,item_category_obj,item_control_style,item_control_type,item_link,item_menu_drop,item_select_action,item_select_parameter,item_select_type,item_toolbar_label,menu_item_description,menu_item_label,menu_item_obj,menu_item_reference,object_obj,on_create_publish_event,product_module_obj,propagate_links,security_token,shortcut_key,substitute_text_property,system_owned,toggle_menu_item,tooltip_text,under_development,image_alternate_rule,item_narration,source_language_obj,language_code,language_nameForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamegsmmifulloUpdateFromSourcenoToggleDataTargetsyesOpenOnInityesPromptOnDeleteyesPromptColumns(NONE)':U ,
             OUTPUT h_gsmmifullo ).
       ...
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'AppServiceAstraASUsePromptnoASInfoDataColumnssmartobject_obj,object_type_obj,product_obj,dProductObj,product_module_obj,object_description,object_filename,object_path,runnable_from_menu,disabled,run_persistent,run_when,security_smartobject_obj,container_object,physical_smartobject_obj,generic_object,required_db_list,layout_obj,custom_smartobject_obj,sdo_smartobject_obj,shutdown_message_text,static_object,system_owned,template_smartobject,object_extension,product_module_code,product_module_description,customization_result_obj,deployment_type,design_only,extends_smartobject_obj,CustomizedResultCodeForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamerycsoful2oUpdateFromSourcenoToggleDataTargetsyesOpenOnInityesPromptOnDeleteyesPromptColumns(NONE)':U ,
             OUTPUT h_rycsoful2o ).
       ...
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'AppServiceAstraASUsePromptASInfoDataColumnstoolbar_menu_structure_obj,object_obj,menu_structure_sequence,menu_structure_obj,menu_structure_alignment,menu_structure_row,menu_structure_spacing,insert_rule,menu_structure_code,menu_structure_type,menu_structure_descriptionForeignFieldsgsm_toolbar_menu_structure.object_obj,smartobject_objRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamegsmtmfulloUpdateFromSourcenoToggleDataTargetsyesOpenOnInityesPromptOnDeleteyesPromptColumns(NONE)':U ,
             OUTPUT h_gsmtmfullo ).
       ...
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'AppServiceAstraASUsePromptASInfoDataColumnsdb_connection_pf_file,number_of_users,product_module_code,product_module_description,product_module_installed,product_module_obj,product_obj,relative_pathForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamegscpm2fulloUpdateFromSourcenoToggleDataTargetsyesOpenOnInityesPromptOnDeleteyesPromptColumns(NONE)':U ,
       ...
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'AppServiceAstraASUsePromptnoASInfoDataColumnsobject_type_obj,object_type_code,object_type_description,disabled,layout_supported,deployment_type,static_object,class_smartobject_obj,extends_object_type_objForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamegscotfulloUpdateFromSourcenoToggleDataTargetsyesOpenOnInityesPromptOnDeleteyesPromptColumns(NONE)':U ,
             OUTPUT h_gscotfullo ).
       ...
       RUN constructObject (
             INPUT  'src/adm2/dyntreeview.w':U ,
             INPUT  FRAME frMain:HANDLE ,
    ...
    WHEN 2 THEN DO:
       ...
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'EnabledObjFldsToDisable(None)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNamegsmomviewt.wDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_gsmomviewt ).
    ...
    WHEN 5 THEN DO:
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'EnabledObjFldsToDisable(None)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNamerysttviewv.wDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_gscicview ).
    ...
    WHEN 6 THEN DO:
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'EnabledObjFldsToDisable(None)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNamegsmmsview.wDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_gsmmsview ).
    ...
    WHEN 7 THEN DO:
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'EnabledObjFldsToDisable(None)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNamegsmmiview.wDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_gsmmiview ).
    ...
    WHEN 10 THEN DO:
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'EnabledObjFldsToDisable(None)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNamegsmtmview.wDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_gsmtmview ).
 ...
 /* Create dynamic Window and Help menu items off the main menubar. */
  ...
  CREATE MENU-ITEM hMenuWindow
     ASSIGN
       ...
       SENSITIVE = TRUE
       TRIGGERS:
           ON "CHOOSE":U PERSISTENT RUN helpHelp IN gshSessionManager  (THIS-PROCEDURE).
      END TRIGGERS.
 ...
 *  ----------------------------------------------------------------------- **/
DO iLoop = 1 TO NUM-ENTRIES(gcFetchObjectBufferHandles):
  ASSIGN hBufferCacheBuffer = widget-handle(ENTRY(iLoop,gcFetchObjectBufferHandles)).
  ...
  DO:    
      ...
      hObjectQuery:ADD-BUFFER(hBufferCacheBuffer).
      hObjectQuery:QUERY-PREPARE(" FOR EACH ":U + hBufferCacheBuffer:NAME).

      hObjectQuery:QUERY-OPEN().
      hObjectQuery:GET-FIRST().
      cObjectHandles = cObjectHandles + (IF NUM-ENTRIES(cObjectHandles) EQ 0 THEN "":U ELSE ",":U) + STRING(hBufferCacheBuffer).
      DO WHILE hBufferCacheBuffer:AVAILABLE:
          ASSIGN cObjectHandles = cObjectHandles + (IF NUM-ENTRIES(cObjectHandles) EQ 0 THEN "":U ELSE ",":U)
                                +  (IF hBufferCacheBuffer:BUFFER-FIELD("tBufferHandle":U):BUFFER-VALUE = ? THEN ""
                                   ELSE STRING(hBufferCacheBuffer:BUFFER-FIELD("tBufferHandle":U):BUFFER-VALUE)).
      ...
      /* Make sure that the buffer cache TT is also destroyed. */
      ASSIGN cObjectHandles = cObjectHandles + (IF NUM-ENTRIES(cObjectHandles) EQ 0 THEN "":U ELSE ",":U)
                            + STRING(hBufferCacheBuffer).
  END.    /* valid buffer cache. */
END.

/** Close all super procedures and Temp-tables marked for destruction. 
 *  ----------------------------------------------------------------------- **/
DO iHandleLoop = 1 TO NUM-ENTRIES(cObjectHandles):
    ASSIGN hDestroyObject = WIDGET-HANDLE(ENTRY(iHandleLoop, cObjectHandles)) NO-ERROR.

    IF VALID-HANDLE(hDestroyObject) THEN
    DO:
       IF hDestroyObject:TYPE = "BUFFER":U THEN
           hDestroyObject = hDestroyObject:TABLE-HANDLE.
...
DO:
  ...
  DO:
     ...
     DO:
        ...
        hAttributeBuffer:FIND-FIRST(" WHERE tRecordIdentifier = '" + STRING(hObjectBuffer:BUFFER-FIELD("tRecordIdentifier":U):BUFFER-VALUE) + "'").
        IF hAttributeBuffer:AVAILABLE THEN
        DO: 
           ASSIGN
           cRunTimeList = hAttributeBuffer:BUFFER-FIELD("tRuntimeList":U):BUFFER-VALUE
           cSystemList  = hAttributeBuffer:BUFFER-FIELD("tSystemList":U):BUFFER-VALUE NO-ERROR.
           DO iColumn = 1 TO hAttributeBuffer:NUM-FIELDS:
              ...
              ASSIGN
                ...
                cName =    hColumn:NAME
                cValue =   string(hColumn:BUFFER-VALUE).
              IF iColumn <= NUM-ENTRIES(hAttributeBuffer:BUFFER-FIELD("tWhereStored":U):BUFFER-VALUE) THEN
              DO:
                IF trim(ENTRY(iColumn,hAttributeBuffer:BUFFER-FIELD("tWhereStored":U):BUFFER-VALUE)) = "3":U THEN
                   cAttributeList = cAttributeList + (IF cAttributeList = "" THEN "" ELSE CHR(3))
                                  ...
                                  + cValue.
              END.
           END. /* End iColumn = 1 to .. */
        END. /* End If hAttributeBuffer:AVAILABLE */
     END. /* End Do while hObjectBuffer:Available */
  END.
...
------------------------------------------------------------------------------*/
  ...
  DYNAMIC-FUNC('setQuerySort':U IN h_gscpm2fullo,  'product_module_code':U).
...
ASSIGN hKey:BUFFER-VALUE             = "{&CATEGORY_NODE}":U
       ...
       hImage:BUFFER-VALUE           = "ry/img/folderopen.bmp":U
       hSelectedImage:BUFFER-VALUE   = "ry/img/folderclosed.bmp":U
       hExpanded:BUFFER-VALUE        = YES
...
DO WHILE lCatgAvailable:
    cCols = DYNAMIC-FUNC("colValues":U IN h_gscicfullo,"item_category_label,item_category_obj":U).
...
------------------------------------------------------------------------------*/
  ...
  DO:
    ASSIGN
        ...
        gdDifference  = {fn getInnerRow h_folder}.
...
CASE cNodeType:
  ...
  DO:
    {fnarg constructFolderLabels 'coObjType:SCREEN-VALUE IN FRAME {&FRAME-NAME}' h_folder}.
    ASSIGN giPageTab  = 1.
...
DO WHILE lBandAvailable:
  cCols = DYNAMIC-FUNC("colValues":U IN h_gsmmsfullo,"menu_structure_description,menu_structure_type,menu_structure_obj":U).
  hbuf:BUFFER-CREATE().
  ASSIGN hKey:BUFFER-VALUE             = DYNAMIC-FUNC('getNextNodeKey':U IN h_dyntreeview)
         cNodeKey                      = hKey:BUFFER-VALUE
...
DO WHILE lRowAvailable:
  ...
  ASSIGN hKey:BUFFER-VALUE             = DYNAMIC-FUNC('getNextNodeKey':U IN h_dyntreeview)
         ...
         hParentKey:BUFFER-VALUE       = pcKey
         hInsert:BUFFER-VALUE          = 4
         hLabel:BUFFER-VALUE           = ENTRY(4,cCols,CHR(1)) + IF ENTRY(5,cCols,CHR(1)) > "" THEN ENTRY(5,cCols,CHR(1))  ELSE ""
         hImage:BUFFER-VALUE           = "ry/img/menuobject.bmp":U
         hSelectedImage:BUFFER-VALUE   = hImage:BUFFER-VALUE
         hSort:BUFFER-VALUE            = TRUE
