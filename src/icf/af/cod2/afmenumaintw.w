...
&SCOPED-DEFINE WINDOW_HEIGHT_MIN 23.6
...
&Scoped-Define ENABLED-OBJECTS coModule btnSplitBar 
&Scoped-Define DISPLAYED-OBJECTS coModule 
...
DEFINE VARIABLE h_gscobful2o AS HANDLE NO-UNDO.
...
DEFINE BUTTON btnRefresh 
     IMAGE-UP FILE "icf/af/bmp/menurefresh.bmp":U NO-FOCUS FLAT-BUTTON
     LABEL "Refresh" 
     SIZE 4.8 BY 1.14 TOOLTIP "Refresh tree"
     BGCOLOR 8 .

DEFINE BUTTON buSearch 
     IMAGE-UP FILE "icf/af/bmp/afbinos.bmp":U NO-FOCUS FLAT-BUTTON
     LABEL "" 
     SIZE 4.8 BY 1.14 TOOLTIP "Search for items"
     BGCOLOR 8 .
...
DEFINE FRAME frmToolbar
     buSearch AT ROW 1.1 COL 6.4
     btnRefresh AT ROW 1.1 COL 1
     rctTbar AT ROW 1 COL 1
     rctTbar-2 AT ROW 2.24 COL 1
...
DEFINE FRAME frMain
     coModule AT ROW 1.1 COL 9 COLON-ALIGNED
...
CASE pcNodeType:
  ...
  DO:   
     ...
     ASSIGN hKey:BUFFER-VALUE             = DYNAMIC-FUNC('getNextNodeKey':U IN h_dyntreeview)
            ...
            hImage:BUFFER-VALUE           = "af/bmp/menucategory.bmp":U
            hSelectedImage:BUFFER-VALUE   = "af/bmp/menucategory.bmp":U
  ...
  DO:
    ...
    ASSIGN hKey:BUFFER-VALUE             = DYNAMIC-FUNC('getNextNodeKey':U IN h_dyntreeview)
           ...
           hInsert:BUFFER-VALUE          = 4
           hLabel:BUFFER-VALUE           = Entry(1,pcNodeValue,CHR(1))
           hImage:BUFFER-VALUE           = "af/bmp/menuobject.bmp":U
           hSelectedImage:BUFFER-VALUE   = hImage:BUFFER-VALUE
           hSort:BUFFER-VALUE            = TRUE
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             INPUT  'AppServiceAstraASUsePromptASInfoForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamegsmmsfulloUpdateFromSourceno':U ,
             OUTPUT h_gsmmsfullo ).
       ...
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'AppServiceAstraASUsePromptASInfoForeignFieldsgsm_menu_structure_item.menu_structure_obj,menu_structure_objRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamegsmitfulloUpdateFromSourceno':U ,
             OUTPUT h_gsmitfullo ).
       RUN repositionObject IN h_gsmitfullo ( 19.10 , 77.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 14.00 ) */

       RUN constructObject (
             INPUT  'af/obj2/gsmomfullo.wDB-AWARE':U ,
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'AppServiceAstraASUsePromptASInfoForeignFieldsgsm_object_menu_structure.menu_structure_obj,menu_structure_objRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamegsmomfulloUpdateFromSourceno':U ,
             OUTPUT h_gsmomfullo ).
       RUN repositionObject IN h_gsmomfullo ( 19.10 , 48.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 13.00 ) */

       RUN constructObject (
             INPUT  'af/obj2/gscicfullo.wDB-AWARE':U ,
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'AppServiceAstraASUsePromptASInfoForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamegscicfulloUpdateFromSourceno':U ,
             OUTPUT h_gscicfullo ).
       RUN repositionObject IN h_gscicfullo ( 19.10 , 117.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 13.00 ) */

       RUN constructObject (
             INPUT  'af/obj2/gscobful2o.wDB-AWARE':U ,
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'AppServiceAstraASUsePromptASInfoForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamegscobful2oUpdateFromSourceno':U ,
             OUTPUT h_gscobful2o ).
       RUN repositionObject IN h_gscobful2o ( 19.10 , 90.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 14.00 ) */

       RUN constructObject (
             INPUT  'af/obj2/gsmtmfullo.wDB-AWARE':U ,
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'AppServiceAstraASUsePromptASInfoForeignFieldsgsm_toolbar_menu_structure.object_obj,object_objRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamegsmtmfulloUpdateFromSourceno':U ,
             OUTPUT h_gsmtmfullo ).
       RUN repositionObject IN h_gsmtmfullo ( 19.10 , 62.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 14.00 ) */

       RUN constructObject (
             INPUT  'af/obj2/gsmmifullo.wDB-AWARE':U ,
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'AppServiceAstraASUsePromptASInfoForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamegsmmifulloUpdateFromSourceno':U ,
             OUTPUT h_gsmmifullo ).
       RUN repositionObject IN h_gsmmifullo ( 19.10 , 105.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 12.00 ) */

       RUN constructObject (
             INPUT  'af/obj2/gscpm2fullo.wDB-AWARE':U ,
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'AppServiceAstraASUsePromptASInfoForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamegscpm2fulloUpdateFromSourceno':U ,
             OUTPUT h_gscpm2fullo ).
       RUN repositionObject IN h_gscpm2fullo ( 19.10 , 144.00 ) NO-ERROR.
       /* Size in AB:  ( 1.86 , 15.00 ) */

       RUN constructObject (
             INPUT  'af/obj2/gscotfullo.wDB-AWARE':U ,
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'AppServiceAstraASUsePromptASInfoForeignFieldsRowsToBatch200CheckCurrentChangedyesRebuildOnReposnoServerOperatingModeNONEDestroyStatelessnoDisconnectAppServernoObjectNamegscotfulloUpdateFromSourceno':U ,
             OUTPUT h_gscotfullo ).
       ...
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'FolderLabels':U + 'Toolbar && Menu Designer' + 'FolderTabWidth0FolderFont-1HideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_folder ).
       RUN repositionObject IN h_folder ( 1.00 , 48.00 ) NO-ERROR.
       RUN resizeObject IN h_folder ( 17.86 , 109.00 ) NO-ERROR.
       ...
       RUN repositionObject IN h_dyntreeview ( 2.19 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_dyntreeview ( 20.71 , 44.00 ) NO-ERROR.

       RUN constructObject (
             INPUT  'adm2/pupdsav.w':U ,
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'AddFunctionOne-RecordEdgePixels0PanelTypeSaveDeactivateTargetOnHidenoHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_pupdsav ).
       RUN repositionObject IN h_pupdsav ( 21.29 , 71.00 ) NO-ERROR.
       ...
       RUN addLink ( h_gscobful2o , 'Data':U , h_gsmtmfullo ).
    ...
    WHEN 2 THEN DO:
       ...
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNamegsmomviewt.wDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_gsmomviewt ).
       RUN repositionObject IN h_gsmomviewt ( 10.05 , 50.00 ) NO-ERROR.
       /* Size in AB:  ( 10.00 , 104.00 ) */
    ...
    WHEN 5 THEN DO:
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNamerysttviewv.wDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_gscicview ).
       RUN repositionObject IN h_gscicview ( 4.57 , 48.00 ) NO-ERROR.
       /* Size in AB:  ( 9.05 , 104.00 ) */
    ...
    WHEN 6 THEN DO:
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNamegsmmsview.wDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_gsmmsview ).
       RUN repositionObject IN h_gsmmsview ( 4.81 , 50.00 ) NO-ERROR.
       /* Size in AB:  ( 11.43 , 105.00 ) */
    ...
    WHEN 7 THEN DO:
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNamegsmmiview.wDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_gsmmiview ).
       RUN repositionObject IN h_gsmmiview ( 2.43 , 47.00 ) NO-ERROR.
       /* Size in AB:  ( 18.76 , 109.40 ) */
    ...
    WHEN 9 THEN DO:
       ...
       /* Size in AB:  ( 10.24 , 98.00 ) */

       /* Links to SmartDataViewer h_gscobviewt. */
       RUN addLink ( h_gscobful2o , 'Data':U , h_gscobviewt ).
       RUN addLink ( h_gscobviewt , 'Update':U , h_gscobful2o ).
    ...
    WHEN 10 THEN DO:
       RUN constructObject (
             ...
             INPUT  FRAME frMain:HANDLE ,
             INPUT  'DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNamegsmtmview.wDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_gsmtmview ).
       RUN repositionObject IN h_gsmtmview ( 4.81 , 48.00 ) NO-ERROR.
       /* Size in AB:  ( 12.91 , 104.00 ) */
...
ASSIGN hKey:BUFFER-VALUE             = "{&CATEGORY_NODE}":U
       ...
       hImage:BUFFER-VALUE           = "af/bmp/folderopen.bmp":U
       hSelectedImage:BUFFER-VALUE   = "af/bmp/folderclosed.bmp":U
       hExpanded:BUFFER-VALUE        = YES
...
ASSIGN hKey:BUFFER-VALUE             = "{&SMARTTOOLBAR_NODE}":U 
       ...
       hInsert:BUFFER-VALUE          = 4
       hLabel:BUFFER-VALUE           = "SmartToolbars"
       hImage:BUFFER-VALUE           = "af/bmp/folderclosed.bmp":U
       hSelectedImage:BUFFER-VALUE   = "af/bmp/folderopen.bmp":U
       hExpanded:BUFFER-VALUE        = YES
...
------------------------------------------------------------------------------*/
  ...
  DYNAMIC-FUNC('setQueryWhere':U IN h_gscobful2o, '').
  ...
  IF VALID-HANDLE(h_gscobviewt)THEN RUN removeLink (h_gscobful2o, 'Data':U, h_gscobviewt).
 ...
 {fn OpenQuery h_gscicfullo}.
  ...
  IF VALID-HANDLE(h_gscobviewt)THEN RUN addLink (h_gscobful2o, 'Data':U, h_gscobviewt).
...
ASSIGN btnSplitBar:COL IN FRAME {&FRAME-NAME} = MAX(btnSplitBar:COL  ,dMinWidth)
       ...
       NO-ERROR.
RUN resizeObject IN h_dyntreeview (INPUT {&WINDOW-NAME}:HEIGHT - FRAME {&FRAME-NAME}:ROW - .19,
...
DO: 
     RUN resizeObject IN h_folder (INPUT {&WINDOW-NAME}:HEIGHT - FRAME {&FRAME-NAME}:ROW + 1, 
...
CASE cNodeType:
  ...
  DO:
    IF NUM-ENTRIES(cTabFolder,"|") > 1 THEN
      RUN deleteFolderPage IN h_folder (2).
    IF ENTRY(1,cTabFolder,"|") <> "Category" THEN
      RUN create-Folder-Page IN h_folder (1,"Category").
    ASSIGN giPageTab  = 1.
  ...
  DO:
    ...
    DO:
      IF ENTRY(1,cTabFolder,"|") <> "Band":U THEN
        RUN create-Folder-Page IN h_folder (1,"Band").
      IF NUM-ENTRIES(cTabFolder,"|") = 1  OR TRIM(ENTRY(2,cTabFolder,"|")) <> "Band Object" THEN
        RUN create-Folder-Page IN h_folder (2," Band Object").
      ASSIGN giPageTab  = 1.
  ...
  DO: 
    IF NUM-ENTRIES(cTabFolder,"|") > 1 THEN
      RUN deleteFolderPage IN h_folder (2).
    IF ENTRY(1,cTabFolder,"|") <> "Item" THEN
       RUN create-Folder-Page IN h_folder (1,"Item").
    ASSIGN giPageTab  = 1.
  ...
  DO:
    IF TRIM(ENTRY(1,cTabFolder,"|")) <> "Band Item" THEN
       RUN create-Folder-Page IN h_folder (2," Item (add to Band) ").
    IF TRIM(ENTRY(1,cTabFolder,"|")) <> "Band Item" THEN
         RUN create-Folder-Page IN h_folder (1,"Band Item").
  ...
  DO:
    RUN deleteFolderPage IN h_folder (2).
    {get FolderLabels cTabFolder h_folder}.
    IF ENTRY(1,cTabFolder,"|") <> "SmartToolBar" THEN
       RUN create-Folder-Page IN h_folder (1,"SmartToolbar").
    ASSIGN giPageTab  = 1.
    ...
    DYNAMIC-FUNC('assignQuerySelection':U IN h_gscobful2o, 'object_obj':U, ENTRY(2,pcTag,"|"),"EQ":U).
    {fn OpenQuery h_gscobful2o} .
    DYNAMIC-FUNC('removeQuerySelection':U IN h_gscobful2o, 'object_obj':U,"EQ":U).
    RUN viewObject IN h_pupdsav.
  END. /* END WHEN "TBAROBJ" */
  ...
  DO:
    RUN deleteFolderPage IN h_folder (2).
    {get FolderLabels cTabFolder h_folder}.
    IF ENTRY(1,cTabFolder,"|") <> "SmartToolBar Bands" THEN
       RUN create-Folder-Page IN h_folder (1,"SmartToolBar Bands").
    ASSIGN giPageTab  = 1.
    ...
    DYNAMIC-FUNC('assignQuerySelection':U IN h_gscobful2o, 'object_obj':U, ENTRY(5,pcTag,"|"),"EQ":U).
    {fn OpenQuery h_gscobful2o} .
    DYNAMIC-FUNC('removeQuerySelection':U IN h_gscobful2o, 'object_obj':U, "EQ":U).
  ...
  DO:
    ...
    RUN create-Folder-Page IN h_folder (1,cKey).
    RUN ShowCurrentPage IN h_folder(1).
    IF valid-handle(ghTableIOTarget) THEN 
...
IF VALID-HANDLE(h_gscobviewt) THEN 
  RUN removeLink (h_gscobful2o, 'Data':U, h_gscobviewt).
  
IF VALID-HANDLE(h_gsmtmfullo) THEN 
  RUN removeLink (h_gscobful2o, 'Data':U, h_gsmtmfullo).

IF gcModuleObj > "0":U THEN
   DYNAMIC-FUNC('assignQuerySelection':U IN h_gscobful2o,'product_module_obj':U,gcModuleObj,'EQ':U).
    
/* Get logical objects */
IF gcObjectTypeObj = "" THEN
    setObjectType().
    
DYNAMIC-FUNC('assignQuerySelection':U IN h_gscobful2o,
              'object_type_obj,logical_object':U,gcObjectTypeObj + CHR(1) + "Yes":U,'EQ':U).
{fn OpenQuery h_gscobful2o}.
DYNAMIC-FUNC('removeQuerySelection':U IN h_gscobful2o, 'object_type_obj,logical_object':U,'EQ':U).

lRowAvailable = DYNAMIC-FUNCTION('rowAvailable':U in h_gscobful2o,"CURRENT":U).
/* Add all items for specific category that was expanded */
DO WHILE lRowAvailable:
  cCols = DYNAMIC-FUNC("colValues":U IN h_gscobful2o,"object_description,object_obj":U).
  hbuf:BUFFER-CREATE().
  ASSIGN hKey:BUFFER-VALUE             = DYNAMIC-FUNC('getNextNodeKey':U IN h_dyntreeview)
         cNodeKey                      = hkey:BUFFER-VALUE
         hParentKey:BUFFER-VALUE       = pcKey
         ...
         hSelectedImage:BUFFER-VALUE   = hImage:BUFFER-VALUE
         hSort:BUFFER-VALUE            = TRUE
         hTag:BUFFER-VALUE             = "@TBAROBJ|":U +  ENTRY(3,cCols,CHR(1)) 
         NO-ERROR.
  ...
  DO:
      ...
      ASSIGN hKey:BUFFER-VALUE             = DYNAMIC-FUNC('getNextNodeKey':U IN h_dyntreeview)
             ...
             NO-ERROR.
  END.
  lRowAvailable = DYNAMIC-FUNCTION('rowAvailable':U in h_gscobful2o,"NEXT":U).
  IF lRowAvailable THEN
     RUN fetchNext IN h_gscobful2o.    
END.
...
CASE pcItemType:
    WHEN "Action":U THEN
        RETURN "af/bmp/itemaction.bmp":U.
    WHEN "Label":U THEN
        RETURN "af/bmp/itemtext.bmp":U.
    WHEN "Separator":U THEN
        RETURN "af/bmp/itemseparator.bmp":U.
    WHEN "EditField":U THEN
        RETURN "af/bmp/itemedit.bmp":U.
    WHEN "ComboBox":U THEN
        RETURN "af/bmp/itemcombo.bmp":U.
    WHEN "placeholder":U THEN
        RETURN "af/bmp/itemdynamic.bmp":U.
    OTHERWISE
        RETURN "af/bmp/itemaction.bmp":U.
END CASE.
...
------------------------------------------------------------------------------*/
  ...
  DYNAMIC-FUNC('assignQuerySelection':U IN h_gscotfullo,'object_type_code':U,"SmartToolbar":U,'EQ':U).
  ...
  DYNAMIC-FUNC('assignQuerySelection':U IN h_gscobful2o,'object_type_obj,logical_object':U,gcObjectTypeObj + CHR(1) + "No":U,'EQ':U).
  {fn OpenQuery h_gscobful2o}.
  DYNAMIC-FUNC('removeQuerySelection':U IN h_gscobful2o,'object_type_obj,logical_object':U,'EQ':U).
  lRowAvailable = DYNAMIC-FUNCTION('rowAvailable':U in h_gscobful2o,"CURRENT":U).
  IF lRowAvailable THEN
     ASSIGN cCols                = DYNAMIC-FUNC("colValues":U IN h_gscobful2o,"product_module_obj,product_module_code,product_module_description":U)
