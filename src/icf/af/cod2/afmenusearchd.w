...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN resizeObject IN h_folder ( 16.19 , 121.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN repositionObject IN h_dyntreeview ( 3.14 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_dyntreeview ( 13.81 , 37.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN repositionObject IN h_dyntreeview-2 ( 3.38 , 1.00 ) NO-ERROR.
       RUN resizeObject IN h_dyntreeview-2 ( 13.57 , 45.00 ) NO-ERROR.
...
RUN resizeObject IN h_dyntreeview (13.81, btnSplitBar:COL ).
