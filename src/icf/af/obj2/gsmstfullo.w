...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH gsm_status NO-LOCK, ~
      FIRST gsm_category WHERE gsm_category.category_obj = gsm_status.category_obj NO-LOCK ~
...
/* Query rebuild information for SmartDataObject Query-Main
     _TblList          = "afdb.gsm_status,afdb.gsm_category WHERE afdb.gsm_status ..."
