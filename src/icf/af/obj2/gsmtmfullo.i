  ...
  FIELD insert_rule LIKE gsm_toolbar_menu_structure.insert_rule VALIDATE ~
  ...
  FIELD menu_structure_description LIKE gsm_menu_structure.menu_structure_description VALIDATE 
