...
------------------------------------------------------------------------------*/
  ...
  IF VALID-HANDLE(hDataSource) THEN DO:
    ...
    ASSIGN cWhere = "menu_item_obj = ":U + STRING(dMenuItemObj) + CHR(3) + CHR(3) + "AND":U.
