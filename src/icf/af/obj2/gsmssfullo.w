...
gsc_object gsc_instance_attribute
...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH gsm_security_structure NO-LOCK, ~
      ...
      FIRST gsc_object WHERE gsc_object.object_obj = gsm_security_structure.object_obj OUTER-JOIN NO-LOCK, ~
...
gsc_product_module gsc_object gsc_instance_attribute
...
/* Query rebuild information for SmartDataObject Query-Main
     _TblList          = "afdb.gsm_security_structure,asdb.gsc_product_module WHERE afdb.gsm_security_structure ...,asdb.gsc_object WHERE afdb.gsm_security_structure ...,asdb.gsc_instance_attribute WHERE afdb.gsm_security_structure ..."
     ...
     _JoinCode[3]      = "asdb.gsc_object.object_obj = afdb.gsm_security_structure.object_obj"
     _JoinCode[4]      = "asdb.gsc_instance_attribute.instance_attribute_obj = afdb.gsm_security_structure.instance_attribute_obj"
     _FldNameList[1]   > afdb.gsm_security_structure.security_structure_obj
"security_structure_obj" "security_structure_obj" ? ? "decimal" ? ? ? ? ? ? no ? no 21 yes
     _FldNameList[2]   > afdb.gsm_security_structure.owning_entity_mnemonic
"owning_entity_mnemonic" "owning_entity_mnemonic" ? ? "character" ? ? ? ? ? ? yes ? no 10 yes
     _FldNameList[3]   > afdb.gsm_security_structure.owning_obj
"owning_obj" "owning_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 21 yes
     _FldNameList[4]   > afdb.gsm_security_structure.product_module_obj
"product_module_obj" "product_module_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 21 yes
     _FldNameList[5]   > asdb.gsc_product_module.product_module_code
...
ELSE product_module_code)" "product_module_display" "Product Module Code" "x(10)" "character" ? ? ? ? ? ? no ? no 20.6 no
     _FldNameList[7]   > afdb.gsm_security_structure.object_obj
"object_obj" "object_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 21 yes
     _FldNameList[8]   > asdb.gsc_object.object_filename
...
ELSE object_filename)" "object_filename_display" "Object Filename" "x(35)" "character" ? ? ? ? ? ? no ? no 35 no
     _FldNameList[10]   > afdb.gsm_security_structure.instance_attribute_obj
"instance_attribute_obj" "instance_attribute_obj" ? ? "decimal" ? ? ? ? ? ? yes ? no 21 yes
     _FldNameList[11]   > asdb.gsc_instance_attribute.attribute_code
...
ELSE attribute_code)" "attribute_code_display" "Attribute Code" "x(35)" "character" ? ? ? ? ? ? no ? no 35 no
     _FldNameList[13]   > afdb.gsm_security_structure.disabled
...
DEFINE VARIABLE cValueList      AS CHARACTER    NO-UNDO.
  ...
  FOR EACH RowObjUpd WHERE CAN-DO('A,C,U':U,RowObjUpd.RowMod): 
    ...
    THEN
      ASSIGN
        cValueList   = STRING(RowObjUpd.owning_entity_mnemonic) + ', ' + STRING(RowObjUpd.owning_obj) + ', ' + STRING(RowObjUpd.product_module_obj) + ', ' + STRING(RowObjUpd.object_obj) + ', ' + STRING(RowObjUpd.instance_attribute_obj)
