...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS NO-COLUMN-SCROLLING SEPARATORS SIZE 41 BY 6.86 ROW-HEIGHT-CHARS .62.
...
/* BROWSE-TAB BrBrowse fiObjectDesc frMain */
ASSIGN 
...
ASSIGN cObjectObj = ENTRY(4,pcCols)
       cObjectObj = ENTRY(4,cObjectObj,CHR(1))
