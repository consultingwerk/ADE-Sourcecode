...
&Scoped-Define ENABLED-OBJECTS fiInputDirectory buRootDirectory lRecurse ~
fiModDate fiModTime lMod lOverwrite lSetModified lRemoveDeletes brAvailable ~
brSelected buAddAll buAdd buRemove buRemoveAll buSelAllAvail ~
buDeselAllAvail buSelAllSelect buDeselAllSelect buImport fiProcessing ~
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 61.4 BY 16.
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 61.4 BY 16 ROW-HEIGHT-CHARS .62.
...
DEFINE FRAME frMain
     ...
     buAddAll AT ROW 11.05 COL 67
     buAdd AT ROW 12.67 COL 67
     buRemove AT ROW 14.19 COL 67
     buRemoveAll AT ROW 15.71 COL 67
     ...
     "File List:" VIEW-AS TEXT
          SIZE 9 BY .62 AT ROW 6.24 COL 4.6
     "Selected Files:" VIEW-AS TEXT
          SIZE 15.8 BY .62 AT ROW 6.24 COL 87.8
