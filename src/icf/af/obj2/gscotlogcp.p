...
&GLOB DATA-FIELD-DEFS  "af\obj2\gscotful1o.i"
  ...
  DO:
     ASSIGN
        ...
        cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                      {af/sup2/aferrortxt.i 'AF' '8' 'gsc_object_type' '' "'object_type_code, '" cValueList }.
  END.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN cDescription = "Astra 2 gsc_object_type Data Logic Procedure".
...
------------------------------------------------------------------------------*/
  ...
  IF LENGTH(b_gsc_object_type.object_type_code) = 0 OR LENGTH(b_gsc_object_type.object_type_code) = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
                    {af/sup2/aferrortxt.i 'AF' '1' 'gsc_object_type' 'object_type_code' "'Object Type Code'"}.

  IF LENGTH(b_gsc_object_type.object_type_description) = 0 OR LENGTH(b_gsc_object_type.object_type_description) = ? THEN
    ASSIGN
      cMessageList = cMessageList + (IF NUM-ENTRIES(cMessageList,CHR(3)) > 0 THEN CHR(3) ELSE '':U) + 
