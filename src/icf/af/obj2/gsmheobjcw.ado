...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="03/20/2003" version_time="56944" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="1004837652.09" record_version_obj="14148.0766" version_number_seq="1.09" secondary_key_value="gsmheobjcw#CHR(1)#0" import_version_number_seq="1.09"><smartobject_obj>1004837652.09</smartobject_obj>
