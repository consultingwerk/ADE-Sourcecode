...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="10/02/2002" version_time="55548" version_user="admin" deletion_flag="no" entity_mnemonic="RYCSO" key_field_value="1004929061.09" record_version_obj="3000040649.09" version_number_seq="1.09" secondary_key_value="gscddfullb#CHR(1)#0" import_version_number_seq="1.09"><smartobject_obj>1004929061.09</smartobject_obj>
