...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/30/2002" version_time="23740" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="8.009" record_version_obj="2000011008.28" version_number_seq="2.09" secondary_key_value="afgenlogsv2.w#CHR(1)#0" import_version_number_seq="2.09"><smartobject_obj>8.009</smartobject_obj>
