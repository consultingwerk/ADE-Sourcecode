...
DEFINE FRAME frMain
     ...
     RowObject.menu_structure_spacing AT ROW 5.24 COL 18.8 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 9 BY 1
     RowObject.menu_structure_alignment AT ROW 6.33 COL 4.8
          VIEW-AS COMBO-BOX 
