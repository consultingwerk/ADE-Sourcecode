...
/*---------------------------------------------------------------------------------
  ...
  Description:  Build Translation client cache temp-tab

  Purpose:      Build client cache temp-table of translations for
                current logged in language or all languages if passed in as 0.
                Run from buildClientCache in Translation Manager.

  Parameters:   input language object or 0 for all
                output temp-table of language translations.
