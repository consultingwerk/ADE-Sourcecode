...
/*---------------------------------------------------------------------------------
  ...
  Description:  Properform fields in passed in buffer

  Purpose:      To auto tidy up fields in passed in buffer. Usually run from write trigger
                if enabled for entity in entity mnemonic table.

  Parameters:   input buffer handle
