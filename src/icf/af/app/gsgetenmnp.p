...
/*---------------------------------------------------------------------------------
  ...
  Description:  Get gsc_Entity_Mnemonic records

  Purpose:      To build a cache of gsc_Entity_Mnemonic records to be accessed both on the
                client and server side.  The cache in a temp-table named ttEntityMnemonic
                which is LIKE gsc_Entity_Mnemonic
  ...
  Parameters:   OUTPUT Table FOR ttEntityMnemonic
