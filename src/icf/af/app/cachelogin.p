...
RUN af/app/gsgetenmnp.p (OUTPUT TABLE ttEntityMnemonic).
...
/* 9 - Translate the login screen.  Note that this is only going to work for aftemlognw.w, and only while it stays *
 *     in it's original format.  We'll make sure.                                                                  */

IF  ttSecurityControl.translation_enabled = YES 
AND ttSecurityControl.login_filename      = "af/cod/gsmuslognw.w":U /* This is the default ICF login window */
THEN DO:
    EMPTY TEMP-TABLE ttTranslate.

    DEFINE VARIABLE cLoginWidgets AS CHARACTER  NO-UNDO EXTENT 10.

    ASSIGN cLoginWidgets[1]  = 'aftemlognw.r,BUTTON,&Cancel,&Cancel,Abort login':U
           cLoginWidgets[2]  = 'aftemlognw.r,BUTTON,&OK,&OK,Login to application':U
           cLoginWidgets[3]  = 'aftemlognw.r,BUTTON,&Password,&Password,Change user password':U
           cLoginWidgets[4]  = 'aftemlognw.r,BUTTON,...,...,':U
           cLoginWidgets[5]  = 'aftemlognw.r,COMBO-BOX,Company,Company,':U
           cLoginWidgets[6]  = 'aftemlognw.r,COMBO-BOX,Language,Language,':U
           cLoginWidgets[7]  = 'aftemlognw.r,FILL-IN,Login Name,Login Name,User login name for authentication':U
           cLoginWidgets[8]  = 'aftemlognw.r,FILL-IN,Password,Password,User password - (case sesnsitive)':U
           cLoginWidgets[9]  = 'aftemlognw.r,FILL-IN,Processing Date,Processing Date,The date to use for processing transactions, etc.':U
           cLoginWidgets[10] = 'aftemlognw.r,TITLE,TITLE,Application Login,':U.
