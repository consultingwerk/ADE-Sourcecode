...
------------------------------------------------------------------------------*/
  ...
  DO:
    cParseConnect = parseConnectionParams(ttService.cConnectParams).
    CREATE AppSrv-TT.
    ASSIGN
      AppSrv-TT.partition = ttService.cServiceName
      AppSrv-TT.Configuration = NOT (cParseConnect = "<LOCAL>":U)
    .
  END.
