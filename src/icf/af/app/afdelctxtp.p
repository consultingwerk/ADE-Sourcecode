...
/*---------------------------------------------------------------------------------
  ...
  Description:  Delete session context table entries

  Purpose:      Delete session context table entries for current session
                Run from deleteContext in Session Manager.
