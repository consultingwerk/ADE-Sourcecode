  ...
  FOR EACH ttInfoMaster NO-LOCK:
    ...
    THEN DO:
      ...
      THEN DO:
        ...
        FOR EACH  gsc_entity_display_field
            WHERE gsc_entity_display_field.entity_mnemonic = gsc_entity_mnemonic.entity_mnemonic
            NO-LOCK:
          cDataObjectFieldList = IF cDataObjectFieldList = "":U THEN gsc_entity_display_field.display_field_name ELSE cDataObjectFieldList + ",":U + gsc_entity_display_field.display_field_name.
        END.
      END.
      ELSE DO:
        /* ERROR */
    ...
    ELSE DO: /* "SDO" */
      ...
      THEN DO:
        ...
        {get Tables cValueTables hSmartDataObject}.
        ...
        ELSE DO:
          ...
          ASSIGN
            cLogMessage = "DataObject":U
              ...
              + CHR(10) + "Module : ":U                               + cDataObjectModule
              + CHR(10) + "ObjectType : ":U                           + cDataObjectObjectType
              + CHR(10) + "Suppress Validation : ":U                  + STRING(lDataObjectSuppressValidation)
              + CHR(10) + "Follow Joins : ":U                         + STRING(lDataObjectFollowJoins)
              + CHR(10) + "Follow Depth : ":U                         + STRING(iDataObjectFollowDepth)
              + CHR(10) + "Field Sequences : ":U                      + cDataObjectFieldSequence
              + CHR(10) + "AppServer Partition : ":U                  + cDataObjectAppServerPartition
              + CHR(10)
    ...
    DO:
      ...
      ASSIGN
        cLogMessage = "DataObject":U
          ...
          + CHR(10) + "Number of Fields : ":U                   + STRING(iBrowseNumFields)
          + CHR(10) + "Use DataObject Fields : ":U              + STRING(lBrowseFromDataObject)
          + CHR(10) + "Delete contained DataField instances : " + STRING(lBrowseDeleteInstances)
          + CHR(10) + "Use DataObject Field Order : "           + STRING(lUseSDOFieldOrderForBrowser)
          .
      DYNAMIC-FUNCTION("logTheError":U
                      ,INPUT plRunSilent
                      ,INPUT cLogDescription
    ...
    DO:
      ...
      ASSIGN
        cLogMessage = "DataObject":U
          ...
          + CHR(10) + "Number of Fields : ":U                   + STRING(iViewerNumFields)
          + CHR(10) + "Fields per Column : ":U                  + STRING(iViewerFieldsPerColumn)
          + CHR(10) + "Use DataObject Fields : ":U              + STRING(lViewerFromDataObject)
          + CHR(10) + "Delete contained DataField instances : " + STRING(lViewerDeleteInstances)
          + CHR(10) + "Use DataObject Field Order : "           + STRING(lUseSDOFieldOrderForViewer)
          .
      DYNAMIC-FUNCTION("logTheError":U
                      ,INPUT plRunSilent
                      ,INPUT cLogDescription
