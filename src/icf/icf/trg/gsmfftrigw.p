...
TRIGGER PROCEDURE FOR WRITE OF gsm_field OLD BUFFER o_gsm_field.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afpropfrmp.p (INPUT BUFFER gsm_field:HANDLE).
...
IF NOT NEW gsm_field AND gsm_field.{&TRIGGER_OBJ} <> o_gsm_field.{&TRIGGER_OBJ} THEN
    DO:
...
{icf/trg/gsmfftrigw.i}

/* Update Audit Log */
IF CAN-FIND(FIRST gsc_entity_mnemonic
            WHERE gsc_entity_mnemonic.entity_mnemonic = 'gsmff':U
              AND gsc_entity_mnemonic.auditing_enabled = YES) THEN
  RUN af/app/afauditlgp.p (INPUT "WRITE":U, INPUT "gsmff":U, INPUT BUFFER gsm_field:HANDLE, INPUT BUFFER o_gsm_field:HANDLE).
