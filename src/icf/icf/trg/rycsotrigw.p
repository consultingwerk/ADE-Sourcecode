...
/* Generated by ICF ERwin Template */
/* gsc_object is a ryc_smartobject ON CHILD UPDATE RESTRICT */
IF NEW ryc_smartobject OR  ryc_smartobject.object_obj <> o_ryc_smartobject.object_obj  THEN
  DO:
    IF NOT(CAN-FIND(FIRST gsc_object WHERE
        ryc_smartobject.object_obj = gsc_object.object_obj)) THEN
              DO:
                /* Cannot update child because parent does not exist ! */
                ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 103 lv-include = "ryc_smartobject|gsc_object":U.
                RUN error-message (lv-errgrp, lv-errnum, lv-include).
              END.
