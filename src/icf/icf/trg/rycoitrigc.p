...
ASSIGN ryc_object_instance.{&TRIGGER_OBJ} = getNextObj().
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "rycoi":U, INPUT BUFFER ryc_object_instance:HANDLE, INPUT BUFFER o_ryc_object_instance:HANDLE).
