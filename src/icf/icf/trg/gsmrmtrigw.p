...
/* ryc_smartobject is the procedure object for gsm_required_manager ON CHILD UPDATE RESTRICT */
IF NEW gsm_required_manager OR  gsm_required_manager.object_obj <> o_gsm_required_manager.object_obj  THEN
  DO:
    IF NOT(CAN-FIND(FIRST ryc_smartobject WHERE
        gsm_required_manager.object_obj = ryc_smartobject.smartobject_obj)) THEN
              DO:
                ...
                ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 103 lv-include = "gsm_required_manager|ryc_smartobject":U.
