...
/* gsc_object is the procedure object for gsm_required_manager ON CHILD UPDATE RESTRICT */
    ...
    IF NOT(CAN-FIND(FIRST gsc_object WHERE
        gsm_required_manager.object_obj = gsc_object.object_obj)) THEN
              DO:
                ...
                ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 103 lv-include = "gsm_required_manager|gsc_object":U.
