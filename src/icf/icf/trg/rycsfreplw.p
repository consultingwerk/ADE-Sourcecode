...
*                                                                    *
*********************************************************************/
TRIGGER PROCEDURE FOR REPLICATION-WRITE OF ryc_smartobject_field OLD BUFFER lb_old.

/* generic trigger override include file to disable trigger if required */
{af/sup2/aftrigover.i &DB-NAME      = "ICFDB"
                      &TABLE-NAME   = "ryc_smartobject_field"
                      &TRIGGER-TYPE = "REPLICATION-WRITE"}

{af/sup/afreplicat.i  &TABLE-NAME   = "ryc_smartobject_field"
                      &TABLE-FLA    = "rycsf"
                      &TABLE-PK     = "smartobject_field_obj"
                      &OLD-BUFFER   = "lb_old"
                      &ACTION       = "WRITE"
                      &PRIMARY-FLA  = "rycso"
