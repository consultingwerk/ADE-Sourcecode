...
/* ryc_smartobject is the procedure object for gsm_required_manager ON CHILD INSERT RESTRICT */
IF 
  ...
  DO:
    IF NOT(CAN-FIND(FIRST ryc_smartobject WHERE
        ...
        DO:
          ...
          ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 102 lv-include = "gsm_required_manager|ryc_smartobject":U.
