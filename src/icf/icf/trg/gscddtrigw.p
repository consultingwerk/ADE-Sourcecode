...
/* gsm_site owns gsc_deploy_dataset ON CHILD UPDATE SET NULL */
IF NEW gsc_deploy_dataset OR  gsc_deploy_dataset.owner_site_code <> o_gsc_deploy_dataset.owner_site_code  THEN
  DO:
    IF NOT(CAN-FIND(FIRST gsm_site WHERE
        gsc_deploy_dataset.owner_site_code = gsm_site.site_code)) THEN DO:
