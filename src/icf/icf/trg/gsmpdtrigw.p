...
TRIGGER PROCEDURE FOR WRITE OF gsm_profile_date_value OLD BUFFER o_gsm_profile_date_value.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afpropfrmp.p (INPUT BUFFER gsm_profile_date_value:HANDLE).
  



/* Generated by ICF ERwin Template */
/* gsm_profile  gsm_profile_date_value ON CHILD UPDATE RESTRICT */
IF NEW gsm_profile_date_value OR  gsm_profile_date_value.profile_obj <> o_gsm_profile_date_value.profile_obj  THEN
  DO:
    IF NOT(CAN-FIND(FIRST gsm_profile WHERE
        gsm_profile_date_value.profile_obj = gsm_profile.profile_obj)) THEN
              DO:
                ...
                ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 103 lv-include = "gsm_profile_date_value|gsm_profile":U.
...
IF NOT NEW gsm_profile_date_value AND gsm_profile_date_value.{&TRIGGER_OBJ} <> o_gsm_profile_date_value.{&TRIGGER_OBJ} THEN
    DO:
...
{icf/trg/gsmpdtrigw.i}

/* Update Audit Log */
IF CAN-FIND(FIRST gsc_entity_mnemonic
            WHERE gsc_entity_mnemonic.entity_mnemonic = 'gsmpd':U
              AND gsc_entity_mnemonic.auditing_enabled = YES) THEN
  RUN af/app/afauditlgp.p (INPUT "WRITE":U, INPUT "gsmpd":U, INPUT BUFFER gsm_profile_date_value:HANDLE, INPUT BUFFER o_gsm_profile_date_value:HANDLE).
