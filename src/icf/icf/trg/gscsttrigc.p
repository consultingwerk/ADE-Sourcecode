...
/* gsc_object is the management object for gsc_service_type ON CHILD INSERT RESTRICT */
IF 
  ...
  DO:
    IF NOT(CAN-FIND(FIRST gsc_object WHERE
        ...
        DO:
          ...
          ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 102 lv-include = "gsc_service_type|gsc_object":U.
...
/* Generated by ICF ERwin Template */
/* gsc_object maintains gsc_service_type ON CHILD INSERT RESTRICT */
IF 
