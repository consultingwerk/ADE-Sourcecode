...
/* ryc_attribute_type defines ryc_attribute ON CHILD UPDATE RESTRICT */
IF NEW ryc_attribute OR  ryc_attribute.attribute_type_tla <> o_ryc_attribute.attribute_type_tla  THEN
  DO:
    IF NOT(CAN-FIND(FIRST ryc_attribute_type WHERE
        ryc_attribute.attribute_type_tla = ryc_attribute_type.attribute_type_tla)) THEN
              DO:
                ...
                ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 103 lv-include = "ryc_attribute|ryc_attribute_type":U.
...
/* Generated by ICF ERwin Template */
/* ryc_attribute_group has ryc_attribute ON CHILD UPDATE RESTRICT */
  ...
  DO:
    IF NOT(CAN-FIND(FIRST ryc_attribute_group WHERE
        ryc_attribute.attribute_group_obj = ryc_attribute_group.attribute_group_obj)) THEN
              DO:
                /* Cannot update child because parent does not exist ! */
                ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 103 lv-include = "ryc_attribute|ryc_attribute_group":U.
                RUN error-message (lv-errgrp, lv-errnum, lv-include).
              END.
