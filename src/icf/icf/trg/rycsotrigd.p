...
/* Generated by ICF ERwin Template */
/* ryc_smartobject is the procedure object for gsm_required_manager ON PARENT DELETE RESTRICT */
IF CAN-FIND(FIRST gsm_required_manager WHERE
    gsm_required_manager.object_obj = ryc_smartobject.smartobject_obj) THEN
    DO:
      /* Cannot delete parent because child exists! */
      ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 101 lv-include = "ryc_smartobject|gsm_required_manager":U.
      RUN error-message (lv-errgrp, lv-errnum, lv-include).
    END.
...
/* Generated by ICF ERwin Template */
/* ryc_smartobject contains ryc_page_object ON PARENT DELETE RESTRICT */
IF CAN-FIND(FIRST ryc_page_object WHERE
    ryc_page_object.container_smartobject_obj = ryc_smartobject.smartobject_obj) THEN
    DO:
      /* Cannot delete parent because child exists! */
      ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 101 lv-include = "ryc_smartobject|ryc_page_object":U.
      RUN error-message (lv-errgrp, lv-errnum, lv-include).
    END.
