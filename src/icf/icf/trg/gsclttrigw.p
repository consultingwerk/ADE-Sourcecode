...
TRIGGER PROCEDURE FOR WRITE OF gsc_language_text OLD BUFFER o_gsc_language_text.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afpropfrmp.p (INPUT BUFFER gsc_language_text:HANDLE).
  



/* Generated by ICF ERwin Template */
/* gsm_category of gsc_language_text ON CHILD UPDATE RESTRICT */
IF NEW gsc_language_text OR  gsc_language_text.category_obj <> o_gsc_language_text.category_obj  THEN
  DO:
    IF NOT(CAN-FIND(FIRST gsm_category WHERE
        gsc_language_text.category_obj = gsm_category.category_obj)) THEN
              DO:
                ...
                ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 103 lv-include = "gsc_language_text|gsm_category":U.
...
/* Generated by ICF ERwin Template */
/* gsc_language  gsc_language_text ON CHILD UPDATE RESTRICT */
IF NEW gsc_language_text OR  gsc_language_text.language_obj <> o_gsc_language_text.language_obj  THEN
  DO:
    IF NOT(CAN-FIND(FIRST gsc_language WHERE
        gsc_language_text.language_obj = gsc_language.language_obj)) THEN
              DO:
                /* Cannot update child because parent does not exist ! */
                ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 103 lv-include = "gsc_language_text|gsc_language":U.
                RUN error-message (lv-errgrp, lv-errnum, lv-include).
              END.
...
IF NOT NEW gsc_language_text AND gsc_language_text.{&TRIGGER_OBJ} <> o_gsc_language_text.{&TRIGGER_OBJ} THEN
    DO:
...
{icf/trg/gsclttrigw.i}

/* Update Audit Log */
IF CAN-FIND(FIRST gsc_entity_mnemonic
            WHERE gsc_entity_mnemonic.entity_mnemonic = 'gsclt':U
              AND gsc_entity_mnemonic.auditing_enabled = YES) THEN
  RUN af/app/afauditlgp.p (INPUT "WRITE":U, INPUT "gsclt":U, INPUT BUFFER gsc_language_text:HANDLE, INPUT BUFFER o_gsc_language_text:HANDLE).
