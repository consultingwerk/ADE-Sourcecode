...
TRIGGER PROCEDURE FOR WRITE OF rym_wizard_view OLD BUFFER o_rym_wizard_view.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afpropfrmp.p (INPUT BUFFER rym_wizard_view:HANDLE).
...
IF NOT NEW rym_wizard_view AND rym_wizard_view.{&TRIGGER_OBJ} <> o_rym_wizard_view.{&TRIGGER_OBJ} THEN
    DO:
...
{icf/trg/rymwvtrigw.i}

/* Update Audit Log */
IF CAN-FIND(FIRST gsc_entity_mnemonic
            WHERE gsc_entity_mnemonic.entity_mnemonic = 'rymwv':U
              AND gsc_entity_mnemonic.auditing_enabled = YES) THEN
  RUN af/app/afauditlgp.p (INPUT "WRITE":U, INPUT "rymwv":U, INPUT BUFFER rym_wizard_view:HANDLE, INPUT BUFFER o_rym_wizard_view:HANDLE).
