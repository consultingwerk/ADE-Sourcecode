...
TRIGGER PROCEDURE FOR WRITE OF gsm_entity_field OLD BUFFER o_gsm_entity_field.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afpropfrmp.p (INPUT BUFFER gsm_entity_field:HANDLE).
  



/* Generated by ICF ERwin Template */
/* gsc_entity_mnemonic has gsm_entity_field ON CHILD UPDATE RESTRICT */
IF NEW gsm_entity_field OR  gsm_entity_field.owning_entity_mnemonic <> o_gsm_entity_field.owning_entity_mnemonic  THEN
  DO:
    IF NOT(CAN-FIND(FIRST gsc_entity_mnemonic WHERE
        gsm_entity_field.owning_entity_mnemonic = gsc_entity_mnemonic.entity_mnemonic)) THEN
              DO:
                ...
                ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 103 lv-include = "gsm_entity_field|gsc_entity_mnemonic":U.
...
IF NOT NEW gsm_entity_field AND gsm_entity_field.{&TRIGGER_OBJ} <> o_gsm_entity_field.{&TRIGGER_OBJ} THEN
    DO:
...
{icf/trg/gsmeftrigw.i}

/* Update Audit Log */
IF CAN-FIND(FIRST gsc_entity_mnemonic
            WHERE gsc_entity_mnemonic.entity_mnemonic = 'gsmef':U
              AND gsc_entity_mnemonic.auditing_enabled = YES) THEN
  RUN af/app/afauditlgp.p (INPUT "WRITE":U, INPUT "gsmef":U, INPUT BUFFER gsm_entity_field:HANDLE, INPUT BUFFER o_gsm_entity_field:HANDLE).
