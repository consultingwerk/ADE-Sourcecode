...
TRIGGER PROCEDURE FOR WRITE OF gsm_token OLD BUFFER o_gsm_token.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afpropfrmp.p (INPUT BUFFER gsm_token:HANDLE).
...
IF NOT NEW gsm_token AND gsm_token.{&TRIGGER_OBJ} <> o_gsm_token.{&TRIGGER_OBJ} THEN
    DO:
...
{icf/trg/gsmtotrigw.i}

/* Update Audit Log */
IF CAN-FIND(FIRST gsc_entity_mnemonic
            WHERE gsc_entity_mnemonic.entity_mnemonic = 'gsmto':U
              AND gsc_entity_mnemonic.auditing_enabled = YES) THEN
  RUN af/app/afauditlgp.p (INPUT "WRITE":U, INPUT "gsmto":U, INPUT BUFFER gsm_token:HANDLE, INPUT BUFFER o_gsm_token:HANDLE).
