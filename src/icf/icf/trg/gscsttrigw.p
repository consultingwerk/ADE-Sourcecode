...
/* gsc_object is the management object for gsc_service_type ON CHILD UPDATE RESTRICT */
    ...
    IF NOT(CAN-FIND(FIRST gsc_object WHERE
        gsc_service_type.management_object_obj = gsc_object.object_obj)) THEN
              DO:
                ...
                ASSIGN lv-error = YES lv-errgrp = "AF ":U lv-errnum = 103 lv-include = "gsc_service_type|gsc_object":U.
...
/* Generated by ICF ERwin Template */
/* gsc_object maintains gsc_service_type ON CHILD UPDATE RESTRICT */
