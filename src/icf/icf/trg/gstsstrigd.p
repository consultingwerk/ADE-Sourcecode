...
/* gst_session has gsm_server_context ON PARENT DELETE CASCADE */
...
FOR EACH gsm_server_context NO-LOCK
   WHERE gsm_server_context.session_obj = gst_session.session_obj
   ON STOP UNDO, RETURN ERROR "AF^104^gstsstrigd.p^delete gsm_server_context":U:
...
IF CAN-FIND(FIRST lbx_gsm_comment 
            WHERE lbx_gsm_comment.owning_obj = gst_session.{&TRIGGER_OBJ}) THEN
    FOR EACH lbx_gsm_comment NO-LOCK
       WHERE lbx_gsm_comment.owning_obj = gst_session.{&TRIGGER_OBJ}
       ON STOP UNDO, RETURN ERROR "AF^104^gstsstrigd.p^delete gsm_comment":U:
...
IF CAN-FIND(FIRST lbx_gsm_user_allocation 
            WHERE lbx_gsm_user_allocation.owning_obj = gst_session.{&TRIGGER_OBJ}) THEN
    FOR EACH lbx_gsm_user_allocation NO-LOCK
       WHERE lbx_gsm_user_allocation.owning_obj = gst_session.{&TRIGGER_OBJ}
       ON STOP UNDO, RETURN ERROR "AF^104^gstsstrigd.p^delete gsm_user_allocation":U:
...
IF CAN-FIND(FIRST lbx_gsm_multi_media 
            WHERE lbx_gsm_multi_media.owning_obj = gst_session.{&TRIGGER_OBJ}) THEN
    FOR EACH lbx_gsm_multi_media NO-LOCK
       WHERE lbx_gsm_multi_media.owning_obj = gst_session.{&TRIGGER_OBJ}
       ON STOP UNDO, RETURN ERROR "AF^104^gstsstrigd.p^delete gsm_multi_media":U:
