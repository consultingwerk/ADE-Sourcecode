...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afpropfrmp.p (INPUT BUFFER gsm_currency:HANDLE).
...
IF NOT NEW gsm_currency AND gsm_currency.{&TRIGGER_OBJ} <> o_gsm_currency.{&TRIGGER_OBJ} THEN
    DO:
...
{icf/trg/gsmcrtrigw.i}

/* Update Audit Log */
IF CAN-FIND(FIRST gsc_entity_mnemonic
            WHERE gsc_entity_mnemonic.entity_mnemonic = 'gsmcr':U
              AND gsc_entity_mnemonic.auditing_enabled = YES) THEN
  RUN af/app/afauditlgp.p (INPUT "WRITE":U, INPUT "gsmcr":U, INPUT BUFFER gsm_currency:HANDLE, INPUT BUFFER o_gsm_currency:HANDLE).
