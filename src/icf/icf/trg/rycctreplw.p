...
*                                                                    *
*********************************************************************/
TRIGGER PROCEDURE FOR REPLICATION-WRITE OF ryc_custom_ui_trigger OLD BUFFER lb_old.
...
{af/sup/afreplicat.i  &TABLE-NAME   = "ryc_custom_ui_trigger"
                      &TABLE-FLA    = "rycct"
                      &TABLE-PK     = "custom_ui_trigger_obj"
                      &OLD-BUFFER   = "lb_old"
                      &ACTION       = "WRITE"
                      &PRIMARY-FLA  = "rycso"
