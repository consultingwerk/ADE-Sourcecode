...
TRIGGER PROCEDURE FOR CREATE OF gsm_session_type .
...
ASSIGN gsm_session_type.{&TRIGGER_OBJ} = getNextObj().
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "gsmse":U, INPUT BUFFER gsm_session_type:HANDLE, INPUT BUFFER o_gsm_session_type:HANDLE).
