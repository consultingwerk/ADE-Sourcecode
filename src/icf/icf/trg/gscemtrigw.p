...
TRIGGER PROCEDURE FOR WRITE OF gsc_entity_mnemonic OLD BUFFER o_gsc_entity_mnemonic.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afpropfrmp.p (INPUT BUFFER gsc_entity_mnemonic:HANDLE).
...
IF NOT NEW gsc_entity_mnemonic AND gsc_entity_mnemonic.{&TRIGGER_OBJ} <> o_gsc_entity_mnemonic.{&TRIGGER_OBJ} THEN
    DO:
...
{icf/trg/gscemtrigw.i}

/* Update Audit Log */
IF CAN-FIND(FIRST gsc_entity_mnemonic
            WHERE gsc_entity_mnemonic.entity_mnemonic = 'gscem':U
              AND gsc_entity_mnemonic.auditing_enabled = YES) THEN
  RUN af/app/afauditlgp.p (INPUT "WRITE":U, INPUT "gscem":U, INPUT BUFFER gsc_entity_mnemonic:HANDLE, INPUT BUFFER o_gsc_entity_mnemonic:HANDLE).
