...
/* Generated by ICF ERwin Template */
/* gsc_object appears on gsm_menu_item ON CHILD INSERT SET NULL */
IF NOT(CAN-FIND(FIRST gsc_object WHERE
    gsm_menu_item.object_obj = gsc_object.object_obj)) THEN
  DO:
...
ASSIGN gsm_menu_item.{&TRIGGER_OBJ} = getNextObj().
