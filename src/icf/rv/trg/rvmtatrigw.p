...
TRIGGER PROCEDURE FOR WRITE OF rvm_task OLD BUFFER o_rvm_task.
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afpropfrmp.p (INPUT BUFFER rvm_task:HANDLE).
...
IF NOT NEW rvm_task AND rvm_task.{&TRIGGER_OBJ} <> o_rvm_task.{&TRIGGER_OBJ} THEN
    DO:
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "WRITE":U, INPUT "rvmta":U, INPUT BUFFER rvm_task:HANDLE, INPUT BUFFER o_rvm_task:HANDLE).
