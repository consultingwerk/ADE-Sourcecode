...
TRIGGER PROCEDURE FOR CREATE OF rvm_task .
...
ASSIGN rvm_task.{&TRIGGER_OBJ} = getNextObj().
...
IF CAN-FIND(FIRST gsc_entity_mnemonic
  ...
  RUN af/app/afauditlgp.p (INPUT "CREATE":U, INPUT "rvmta":U, INPUT BUFFER rvm_task:HANDLE, INPUT BUFFER o_rvm_task:HANDLE).
