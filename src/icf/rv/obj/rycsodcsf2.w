...
/*---------------------------------------------------------------------------------
  ...
  Description:  SmartObject SmartDataField

  Purpose:      SmartDataField used to choose ryc_smartobject
...
DEFINE FRAME frMain
     coCombo AT ROW 1 COL 1 NO-LABEL
...
/* SETTINGS FOR COMBO-BOX coCombo IN FRAME frMain
   ALIGN-L                                                              */
...
ON VALUE-CHANGED OF coCombo IN FRAME frMain
DO:
...
DEFINE VARIABLE dSmartObjectObj         AS DECIMAL       NO-UNDO.
  ...
  dSmartObjectObj = DYNAMIC-FUNCTION('getSmartObjectObj' IN ghSDV).
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  ASSIGN
    ...
    ttComboData.cForEach = "FOR EACH ryc_smartlink NO-LOCK ":U +
                              "WHERE ryc_smartlink.container_smartobject_obj = ":U + STRING(dSmartObjectObj) + ", ":U +
                              "FIRST ryc_object_instance NO-LOCK ":U + 
                              "WHERE ryc_object_instance.object_instance_obj = ryc_smartlink.target_object_instance_obj, ":U +
                              "FIRST ryc_smartobject NO-LOCK ":U +
                              "WHERE ryc_smartobject.smartobject_obj = ryc_object_instance.smartobject_obj, ":U +
                              "FIRST ryc_page_object NO-LOCK ":U +
                              "WHERE ryc_page_object.container_smartobject_obj = ryc_smartlink.container_smartobject_obj ":U +
                                "AND ryc_page_object.object_instance_obj       = ryc_object_instance.object_instance_obj, ":U +
                              "FIRST ryc_page NO-LOCK ":U +
                              "WHERE ryc_page.page_obj = ryc_page_object.page_obj ":U
    ttComboData.cBufferList = "ryc_smartlink,ryc_object_instance,ryc_smartobject,ryc_page_object,ryc_page":U
    ttComboData.cKeyFieldName = "ryc_smartlink.target_object_instance_obj":U
    ttComboData.cDescFieldNames = "ryc_smartobject.object_filename,ryc_page.page_label":U
