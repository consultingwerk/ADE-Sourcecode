...
DO WITH FRAME {&FRAME-NAME}:
  ...
  ASSIGN
    ...
    ttComboData.cForEach = "FOR EACH ryc_object_instance NO-LOCK ":U + 
                              "WHERE ryc_object_instance.container_smartobject_obj   = ":U + STRING(dSmartObjectObj) + ", ":U +
                              ...
                              "WHERE ryc_page_object.container_smartobject_obj       = ryc_object_instance.container_smartobject_obj ":U +
    ...
    ttComboData.cBufferList = "ryc_object_instance,ryc_smartobject,ryc_page_object,ryc_page":U
    ttComboData.cKeyFieldName = "ryc_object_instance.object_instance_obj":U
