...
/*---------------------------------------------------------------------------------
  ...
  Description:  Page SmartDataField

  Purpose:      SmartDataField to choose from ryc_page
...
ON VALUE-CHANGED OF coCombo IN FRAME frMain /* Page */
DO:
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  ASSIGN
    ...
    ttComboData.cForEach = "FOR EACH ryc_page NO-LOCK WHERE ryc_page.container_smartobject_obj = ":U + 
                           STRING(dSmartObjectObj) + " BY ryc_page.page_sequence":U
    ttComboData.cBufferList = "ryc_page":U
    ttComboData.cKeyFieldName = "ryc_page.page_obj":U
    ttComboData.cDescFieldNames = "ryc_page.page_label":U
