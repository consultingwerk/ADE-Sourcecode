...
/*---------------------------------------------------------------------------------
  ...
  Description:  Set new site number plus other sequence values for RVDB

  Purpose:      Set new site number plus other sequence values for RVDB
...
ASSIGN
  CURRENT-VALUE(seq_obj1,RVDB)       = piSeqObj1
  CURRENT-VALUE(seq_obj2,RVDB)       = piSeqObj2
  CURRENT-VALUE(seq_site_division,RVDB) = piSeqSiteDiv
  CURRENT-VALUE(seq_site_reverse,RVDB)  = piSeqSiteRev
  CURRENT-VALUE(seq_session_id,RVDB) = piSessID
  .
