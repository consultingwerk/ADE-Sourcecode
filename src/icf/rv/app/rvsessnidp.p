...
/*---------------------------------------------------------------------------------
  ...
  Description:  Session Id Procedure - RVDB

  Purpose:      To allocate a unique session id using the RVDB sequence
                seq_session_id.
...
ASSIGN pcSessionId = STRING(NEXT-VALUE(seq_session_id,RVDB)).
