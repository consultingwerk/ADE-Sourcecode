...
"BGCOLOR" 1005078412.09 4 "" "" no no "" no "" "" no no 1005099282.101
...
"BrowseColumnFonts" 436.7063 1 "CHR(3) list of fonts for browser columns" "" no no "" no "" "" yes no 14656.409
...
"BuildSequence" 1005095447.101 4 "The sequence number in which the Dynamic Combo's data should be build." "" no no "" no "" "" no yes 1005115831.101
...
"ComboDelimiter" 1005095447.101 1 "" "" no no "" no "" "" no yes 831.7063
"ComboFlag" 1005095447.101 1 "Optional Dynamic Combo flags - Contains 'A' for <All> or 'N' for <None> - Blank will indicate that no extra option should be added to combo." "" no no "" no "" "" no no 1005111017.101
...
"DataFieldDefs" 152.7063 1 "The name of the include file in which the field definitions for this SDO's RowObject table are stored" "" yes no "Master" no "" "" yes yes 204.7063
...
"DataSourceName" 3000002003.09 1 "DataSourceName" "" no no "" no "" "" no no 1005104898.101
...
"DescSubstitute" 1005095447.101 1 "The field substitution list for Dynamic Combos" "" no no "" no "" "" no no 1005111016.101
...
"DOWN" 1005078412.09 3 "Frame attribute to indicate a down frame" "" no no "" no "" "" no no 14815.409
...
"FGCOLOR" 1005078412.09 4 "" "" no no "" no "" "" no no 1005099283.101
...
"FlagValue" 1005095447.101 1 "Dynamic Combo. This field contains the default optional combo flag value for the <All> and <None> options. This allows the user to override the default values like . or 0." "" no no "" no "" "" no no 1005111018.101
...
"LabelBgColor" 1005078412.09 4 "WidgetAttributes LabelBgColor" "" no no "" no "" "" no no 1005104906.101
"LabelEdit" 1005097792.101 4 "Is the node label editable. 1 = yes" "SET" no no "" no "" "" no yes 3510.66
"LabelFgColor" 1005078412.09 4 "WidgetAttributes LabelFgColor" "" no no "" no "" "" no no 1005104908.101
...
"ModRowIdent" 152.7063 10 "The default BUFFER handle of the 'ModRowIdent' temp table." "" yes no "" no "" "" no yes 1197.7063
"ModRowIdentTable" 152.7063 10 "The table handle of the 'ModRowIdent' temp table" "" yes no "" no "" "" no yes 1195.7063
...
"PanelType" 438.7063 1 "The type of Panel: Navigation, Save, Update" "" no no "" no "" "" yes yes 1003498440
...
"ParentField" 1005095447.101 1 "A field or widget name to a parent field on the viewer that will determine the filter query for a Dynamic Lookup/Dynamic Combo." "" no no "" no "" "" no no 1005089896.28
"ParentFilterQuery" 1005095447.101 1 "A Query sting used to filter the Base query of Dynamic Lookups/Dynamic Combos that depends on a parent field." "" no no "" no "" "" no no 1005089897.28
...
"PhysicalTableNames" 152.7063 1 "This list contains the names of the actual database tables." "" no no "" no "" "" no yes 3000031111.09
...
"PopupOnAmbiguous" 432.7063 3 "Indicates that the lookup should popup automatically when a field is modified and the value is ambiguous, i.e. partially entered some data and no record could be uniquely identified. The rule is normally applied on the leave event, but some UIs may require a more explicit user action." "" no no "" no "" "" no yes 18276.66
...
"PopupOnUniqueAmbiguous" 432.7063 3 "Indicates that the lookup should popup automatically when a field is modified and the value uniquely identifies a record, if one or more other records exists that begins with that value. The rule is normally applied on the leave event, but some UIs may require a more explicit user action." "" no no "" no "" "" no yes 18278.66
...
"QueryTables" 1005095447.101 1 "Comma list of query tables for Dynamic Lookups/Dynamic Combos (Buffers)" "" no no "" no "" "" no no 1005089875.28
...
"ReadOnly" 1005078412.09 3 "Set to true if the field never should be updated." "" no no "" no "" "" no yes 32996.66
...
"SEPARATOR-FGCOLOR" 1005078412.09 4 "The color of a browse's separator lines" "" no no "" no "" "" no no 14672.409
...
"SupportedLinks" 5.7063 1 "A comma-seaprated list of links that this object supports. The links must be specified as <linktype>-target or <linktype>-source" "" no no "Class" no "" "" no yes 1003498433
...
if the order of the tables were changed dynamically, because several other properties have table delimiters and are depending on the design-time order of this." "GET,SET" no no "" no "" "" no yes 535.7063
...
"TemplateObjectName" 1003183341 1 "Used by the Dynamic Container Builder Property Sheet." "" no no "" no "" "" no yes 1007500648.09
...
"TempTables" 152.7063 1 "This property contains a list of temp-table info corresponding to the Tables property or QueryTables property" "" no no "" no "" "" no yes 3000031113.09
...
"UpdateFromSource" 152.7063 3 "'TRUE' if this object should be updated as one-to-one with the datasource updates (one-to-one)" "" no no "" no "" "" no yes 215.7063
...
records=0000000000775
ldbname=ICFDB
timestamp=2003/04/02-13:47:48
numformat=44,46
dateformat=mdy-1950
map=NO-MAP
cpstream=utf-8
