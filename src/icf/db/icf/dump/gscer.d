...
"AF" 105 426 "Deletion of &1 records is not allowed by the system !" "Cannot delete &1 ! To disallow further use, set a stop date, disabled flag, etc. as appropriate. If you need to actually delete the record, then please contact your system administrator.
...
"CR" 20524 426 "Print job busy." "You tried to initiate printing while Crystal Reports is already rprinting a job.
...
"GS" 9 426 "This role is not valid for this organisation." "This role is not valid for this organisation.Role = &1Organisation = &2" 315 no "INF" yes
...
"GS" 12 426 "Access denied - Log in using a valid company." "Access denied - Log in using a valid company. This procedure requires that you log into a valid login organisation. Please re-logon, specifying a valid company to continue." 1003699845 no "ERR" yes
...
"HTM" 12 426 "How  many records do you want to export?" "How  many records do you want to export?" 2656.1713 no "QUE" yes
"HTM" 13 426 "Invalid data for &1 = &2" "Invalid data for &1 = &2" 2658.1713 no "ERR" yes
"HTM" 14 426 "Do you want to exit the application?" "Do you want to exit the application?" 2660.1713 no "QUE" yes
"HTM" 15 426 "&1 not yet implemented! (&2)" "&1 not yet implemented! (&2)" 2662.1713 no "WAR" yes
"HTM" 16 426 "&1 does not exist." "&1 does not exist." 3009.1713 no "ERR" yes
...
"ICF" 5 426 "The &1 field (&2) is invalid and cannot be applied to the relationship" "The &1 field (&2) is invalid and cannot be applied to the relationship" 9855.24 no "WAR" yes
...
"RV" 2 426 "Attempt to modify items outside the context of a specific workspace. &1" "Attempt to modify items outside the context of a specific workspace. &1" 1003021329 no "INF" yes
...
"RV" 6 426 "Attempt to modify item within workspace &1 under task &2, when that workspace is currently checked out under task &3. &4" "Attempt to modify item within workspace &1 under task &2, when that workspace is currently checked out under task &3. &4" 1003021333 no "INF" yes
"RV" 7 426 "Attempt to modify an element of item &1 which is not a recognised Configuratino Type. &2" "Attempt to modify an element of item &1 which is not a recognised Configuration Type. &2
...
"RV" 8 426 "Attempt to modify item of configuration type &1 which is currently locked. &2" "Attempt to modify item of configuration type &1 which is currently locked. &2

When the Configuration Type is locked no modifications to items of that type are permitted.  " 1003021335 no "INF" yes
"RV" 9 426 "Attempt to modify item of Configuration Type &1 under task &2, when that Configuration Type is currently checked out under task &3. &4" "Attempt to modify item of Configuration Type &1 under task &2, when that Configuration Type is currently checked out under task &3. &4

The Configuration Type has been checked out under a task.  Items of that Configuration Type can only be modifies under this task, until such time as it is checked in again." 1003021345 no "INF" yes
"RV" 10 426 "Attempt to create item &1 with key &2 which already exists in workspace &3. &4" "Attempt to create item &1 with key &2 which already exists in workspace &3. &4
...
"RV" 11 426 "Attempt to modify item &1 with key &2 which does not exist in workspace &3. &4" "Attempt to modify item &1 with key &2 which does not exist in workspace &3. &4
...
"RV" 12 426 "Attempt to modify item &1 with key &2 under task &3 when that item is currently checked out under task &4. &5" "Attempt to modify item &1 with key &2 under task &3 when that item is currently checked out under task &4. &5
...
"RV" 13 426 "Attempt to modify item checked out with an invalid modification type of &1.  Valid modification types are VER, REV, PAT or UNK. &4" "Attempt to modify item checked out with an invalid modification type of &1.  Valid modification types are VER, REV, PAT or UNK.
...
"RV" 14 426 "Unable to identify Product Module for a new Configuration Item of Configuration Type &1. &2" "Unable to identify Product Module for a new Configuration Item of Configuration Type &1. &2
...
"RV" 15 426 "Attempt to check out an item with an SCM SubType of &1.  However no COnfiguration Type record exists with an scm_code of &1. &2" "Attempt to check out an item with an SCM SubType of &1.  However no COnfiguration Type record exists with an scm_code of &1. &2" 1003032105 no "INF" yes
"RV" 16 426 "Attempt to check out an item in workspace with scm_code &1 which does not exist." "Attempt to check out an item in workspace with scm_code &1 which does not exist." 1003032126 no "INF" yes
"RV" 17 426 "Attempt to checkout from workspace &2 item with object name &1, which does not exist." "Attempt to checkout from workspace &2 item with object name &1, which does not exist." 1003032128 no "INF" yes
"RV" 18 426 "Attempt to checkout from workspace &3 item of subtype &1 with object name &2 which does not exist." "Attempt to checkout from workspace &3 item of subtype &1 with object name &2 which does not exist." 1003032130 no "INF" yes
...
"RV" 22 426 "You cannot create data item for &1 since this is already a configuration item in its own right.  Use your SCM tool to assign the item to this workspace." "You cannot create data item for &1 since this is already a configuration item in its own right.  Use your SCM tool to assign the item to this workspace." 1003203002 no "INF" yes
"RV" 23 426 "Could not find Configuration Item with name &1 and type &2 when performing deletion checks." "Could not find Configuration Item with name &1 and type &2 when performing deletion checks." 1003223586 no "INF" yes
...
"RV" 25 426 "Attempt to modify items within the context of task &1 which is not an open task." "Attempt to modify items within the context of task &1 which is not an open task." 1003223706 no "INF" yes
"RV" 26 426 "Attempt to create data corresponding to an object name &1 which exists in your SCM tool but has not been assigned to workspace &2." "Attempt to create data corresponding to an object name &1 which exists in your SCM tool but has not been assigned to workspace &2." 1003249904 no "INF" yes
"RV" 27 426 "Attempt to create data corresponding to an object named &1 which is not checked out in your SCM tool under workspace &2." "Attempt to create data corresponding to an object named &1 which is not checked out in your SCM tool under workspace &2." 1003249905 no "INF" yes
"RV" 28 426 "Attempt to create data corresponding to an object named &1 under task &2, when that object is checked out in your SCM toool under task &3." "Attempt to create data corresponding to an object named &1 under task &2, when that object is checked out in your SCM tool under task &3." 1003249906 no "INF" yes
