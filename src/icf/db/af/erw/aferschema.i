...
%If(%!=(%subjectareaprop("DBVersion"),%entityprop("XYZ"))) {
ADD SEQUENCE "seq_%subjectareaprop("DBlogical")_DBVersion"
  INITIAL %subjectareaprop("DBVersion")
  INCREMENT 1
  CYCLE-ON-LIMIT yes
  MIN-VAL 0
  MAX-VAL %subjectareaprop("DBVersion")
}
