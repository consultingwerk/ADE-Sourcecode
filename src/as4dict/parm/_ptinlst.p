...
Description:
   Put the new parmeter or existing parmater whose name or order # has changed
   into the browse select list in the correct position.

Input Parameters:
   p_Name  - The name of the new or modified parameter
   p_Order - The new or modified order# for this parameter.
...
find FIRST as4dict.p__Field where as4dict.p__Field._File-number = s_ParmForNo 
	     	      	        and as4dict.p__Field._Field-Name > p_Name NO-ERROR.
