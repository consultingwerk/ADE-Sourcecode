...
History
    ...
    gfs         94/06/15    Fixed select/unselect problem.
                            94-06-09-051
    mcmann      97/06/05    Modified to work with the AS/400 DataServer  
    mcmann      01/02/15    Added three-d to frame                      
-------------------------------------------------------------------------*/
...
FORM
   ...
   &IF "{&WINDOW-SYSTEM}" begins "MS-WIN" &THEN
      nextlbl  at row 2 col 48 VIEW-AS TEXT SPACE(1) SKIP
      nextnum  at 48 format ">>9" SPACE(1)                SKIP
      btn_skipd at 48 SPACE(1) btn_skip
   &ELSE
