...
DO:
    ...
    ASSIGN user_env[5]  = as4dict.p__db._db-xl-name. /* db codepage */
END.
  ...
  */
  IF is-all THEN FOR EACH as4dict.p__File
    WHERE as4dict.p__File._File-number > 0
      ...
      AND CAN-DO(as4dict.p__File._Can-read,USERID(user_dbname))
      AND CAN-DO(as4dict.p__File._Can-dump,USERID(user_dbname))
      AND (nodump = "" OR NOT CAN-DO(nodump,as4dict.p__File._For-type))
