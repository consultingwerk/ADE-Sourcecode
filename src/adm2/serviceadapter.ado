...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" deletion_flag="no" entity_mnemonic="rycso" import_version_number_seq="5.66" key_field_value="78404.66" record_version_obj="78405.66" secondary_key_value="serviceadapter.p#CHR(1)#0" version_date="02/01/2006" version_number_seq="5.66" version_time="53570" version_user="Admin"><smartobject_obj>78404.66</smartobject_obj>
