...
*********************************************************************/
/*--------------------------------------------------------------------------
    File        : lookupfieldpropcustom.i
    Purpose     : Defines basic properties.
    Syntax      : {src/adm2/custom/lookupfieldpropcustom.i}

    Description :

    Modified    : 08/11/2000
    Notes       : Referenced in {src/adm2/lookupfieldprop.i}    
  ------------------------------------------------------------------------*/
...
&IF "{&ADMSuper}":U EQ "":U &THEN
  {src/adm2/custom/lookupfieldprtocustom.i}
&ENDIF
