...
*********************************************************************/
/*------------------------------------------------------------------------
    File        : messagingcustom.i
    Purpose     : References the start of the custom super procedure.
                  Allows properties initialization.

    Syntax      : {src/adm2/custom/messagingcustom.i}

    Description :

    Created     : 05/03/2000
    Notes       : Referenced in {src/adm2/messaging.i}
  ----------------------------------------------------------------------*/
...
/* IF NOT {&ADM-LOAD-FROM-REPOSITORY} THEN
     RUN start-super-proc ("adm2/custom/messagingcustom.p":U).*/
