...
*********************************************************************/
/*------------------------------------------------------------------------
    File        : consumercustom.i
    Purpose     : References the start of the custom super procedure.
                  Allows properties initialization.

    Syntax      : {src/adm2/custom/consumercustom.i}

    Description :

    Created     : 05/03/2000
    Notes       : Referenced in {src/adm2/consumer.i}
  ----------------------------------------------------------------------*/
...
/* IF NOT {&ADM-LOAD-FROM-REPOSITORY} THEN
     RUN start-super-proc ("adm2/custom/consumercustom.p":U).*/
