...
*********************************************************************/
/*-------------------------------------------------------------------------
    File        : saxpropcustom.i
    Purpose     : Defines basic properties.
    Syntax      : {src/adm2/custom/saxpropcustom.i}

    Description :

    Modified    : 02/18/2002
    Notes       : Referenced in {src/adm2/saxprop.i}    
  ------------------------------------------------------------------------*/
...
/* Include the file which defines prototypes for all of the super procedure's 
   entry points and skip including the prototypes if we are *any* super 
   procedure. */
&IF "{&ADMSuper}":U EQ "":U &THEN
  {src/adm2/custom/saxprtocustom.i}
&ENDIF
