...
*********************************************************************/
/*------------------------------------------------------------------------
    File        : producercustom.i
    Purpose     : References the start of the custom super procedure.
                  Allows properties initialization.

    Syntax      : {src/adm2/custom/producercustom.i}

    Description :

    Created     : 04/26/2000
    Notes       : Referenced in {src/adm2/producer.i}
  ----------------------------------------------------------------------*/
...
/* IF NOT {&ADM-LOAD-FROM-REPOSITORY} THEN
     RUN start-super-proc ("adm2/custom/producercustom.p":U).*/
