...
/*--------------------------------------------------------------------------
    File        : dataquerypropcustom.i
    Purpose     : Defines basic properties.
    Syntax      : {src/adm2/custom/dataquerypropcustom.i}

    Description :

    Modified    : 06/27/2006
    Notes       : Referenced in {src/adm2/dataqueryprop.i}    
  ------------------------------------------------------------------------*/
...
&IF "{&ADMSuper}":U EQ "":U &THEN
  {src/adm2/custom/dataqueryprtocustom.i}
&ENDIF
