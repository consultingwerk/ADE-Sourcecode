...
*********************************************************************/
/*------------------------------------------------------------------------
    File        : lookupfieldcustom.i
    Purpose     : References the start of the custom super procedure.
                  Allows properties initialization.

    Syntax      : {src/adm2/custom/lookupfieldcustom.i}

    Description :

    Created     : 08/11/2000
    Notes       : Referenced in {src/adm2/lookupfield.i}
  ----------------------------------------------------------------------*/
...
/* IF NOT {&ADM-LOAD-FROM-REPOSITORY} THEN
     RUN start-super-proc ("adm2/custom/lookupfieldcustom.p":U).*/
