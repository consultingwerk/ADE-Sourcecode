  ...
  FOR EACH tDataRow WHERE tDataRow.TargetProc = TARGET-PROCEDURE:
    ...
    DO:
      ...
      ELSE DO: 
         ...
         MESSAGE "Not enough information to find a row in object:" 
                 {fn getObjectName tDataRow.DataSource} SKIP
...
------------------------------------------------------------------------------*/
  ...
  DO WHILE hSchemaQuery:QUERY-OFF-END = FALSE: 
    ...
    DO:
      ...
      DO:
         MESSAGE 'Could not find data source object' cDataObject 
         VIEW-AS ALERT-BOX.
         RETURN "ADM-ERROR":U.
      END.
      ELSE DO:
...
------------------------------------------------------------------------------*/
  ...
  DO:
    /* Developer error */
    MESSAGE 
      "Function 'storeNodeValue()' did not find data source information."
      "for object '" + cObjectName "' when trying to store value for column " 
       + "'" + pcColumnName + "'."  SKIP
