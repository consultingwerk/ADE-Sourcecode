...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="09/16/2003" version_time="61723" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="14276.81" record_version_obj="14277.81" version_number_seq="3.5566" secondary_key_value="viewer.w#CHR(1)#0" import_version_number_seq="3.5566"><smartobject_obj>14276.81</smartobject_obj>
