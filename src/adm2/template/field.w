...
"ADM2 SmartDataField Template.

Use this template as a starting point for creating SmartDataField Objects. A SmartDataField object represents a single field of a SmartDataObject using a non-standard visualization of your choosing, and can be inserted into a SmartDataViewer."
*/
&ANALYZE-RESUME
