...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/23/2005" version_time="57586" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="10324.81" record_version_obj="10325.81" version_number_seq="3.48" secondary_key_value="cntnrwin#CHR(1)#0" import_version_number_seq="3.48"><smartobject_obj>10324.81</smartobject_obj>
