...
------------------------------------------------------------------------------*/
  ...
  IF hNodeKey:BUFFER-VALUE <> "" AND hNodeKey:BUFFER-VALUE <> ? THEN DO:
    ...
    IF VALID-HANDLE(chNode) THEN DO:
      MESSAGE "The specified node key " + hNodeKey:BUFFER-VALUE + " already exists. You must specify a unique node."
 ...
 IF hParentKey:BUFFER-VALUE <> "" AND hParentKey:BUFFER-VALUE <> ? THEN DO:
   ...
   IF NOT VALID-HANDLE(chParent) THEN DO:
     MESSAGE "The specified parent node key " + hParentKey:BUFFER-VALUE + " does not exists."
          VIEW-AS ALERT-BOX INFO BUTTONS OK.
     RETURN.
   END.
 ...
 IF hParentKey:BUFFER-VALUE = "" THEN
  ...
  IF hChecked:BUFFER-VALUE = YES THEN
     chNode:CHECKED = YES.

  IF VALID-HANDLE(chParent) AND NOT chParent:Expanded AND hNodeExpand:BUFFER-VALUE THEN
...
------------------------------------------------------------------------------*/
  ...
  hQry:QUERY-PREPARE(SUBST("FOR EACH &1 WHERE  &1.parent_node_key = '&2' BY &1.node_key":U,
...
/*------------------------------------------------------------------------------
 ...
 ------------------------------------------------------------------------------*/
  ...
  ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
         ghProp = ghProp:BUFFER-FIELD('AutoSort':U).
...
------------------------------------------------------------------------------*/
 ...
 ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
        ghProp = ghProp:BUFFER-FIELD('FullRowSelect':U)
        lProp = ghProp:BUFFER-VALUE NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
         ghProp = ghProp:BUFFER-FIELD('HideSelection':U).
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
         ghProp = ghProp:BUFFER-FIELD('ImageHeight':U).
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
         ghProp = ghProp:BUFFER-FIELD('ImageWidth':U).
...
DEFINE VARIABLE iProp         AS INTEGER NO-UNDO.
 ...
 ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
        ghProp = ghProp:BUFFER-FIELD('Indentation':U)
...
------------------------------------------------------------------------------*/
 ...
 ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
        ghProp = ghProp:BUFFER-FIELD('LabelEdit':U)
        iProp = ghProp:BUFFER-VALUE NO-ERROR.
...
DEFINE VARIABLE iProp         AS INTEGER NO-UNDO.
 ...
 ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
        ghProp = ghProp:BUFFER-FIELD('LineStyle':U)
        iProp = ghProp:BUFFER-VALUE NO-ERROR.
...
------------------------------------------------------------------------------*/
 ...
 ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
        ghProp = ghProp:BUFFER-FIELD('OLEDrag':U)
        lCheck = ghProp:BUFFER-VALUE NO-ERROR.
...
DEFINE VARIABLE lCheck         AS LOGICAL NO-UNDO.
 ...
 ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
        ghProp = ghProp:BUFFER-FIELD('OLEDrop':U)
        lCheck = ghProp:BUFFER-VALUE NO-ERROR.
...
------------------------------------------------------------------------------*/
 ...
 ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
        ghProp = ghProp:BUFFER-FIELD('Scroll':U)
        lProp = ghProp:BUFFER-VALUE NO-ERROR.
...
/*------------------------------------------------------------------------------
 ...
 ------------------------------------------------------------------------------*/
  ...
  ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
         ghProp = ghProp:BUFFER-FIELD('ShowCheckBoxes':U).
...
/*------------------------------------------------------------------------------
 ...
 ------------------------------------------------------------------------------*/
  ...
  ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
         ghProp = ghProp:BUFFER-FIELD('ShowRootLines':U).
...
------------------------------------------------------------------------------*/
 ...
 ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
        ghProp = ghProp:BUFFER-FIELD('SingleSel':U)
        lProp = ghProp:BUFFER-VALUE NO-ERROR.
...
/*------------------------------------------------------------------------------
 ...
 ------------------------------------------------------------------------------*/
  ...
  ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
         ghProp = ghProp:BUFFER-FIELD('TreeStyle':U).
...
/*------------------------------------------------------------------------------
 ...
 ------------------------------------------------------------------------------*/
  ...
  ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
         ghProp = ghProp:BUFFER-FIELD('AutoSort':U)
         ghProp:BUFFER-VALUE = plAutoSort.
...
/*------------------------------------------------------------------------------
 ...
 ------------------------------------------------------------------------------*/
  ...
  ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
         ghProp = ghProp:BUFFER-FIELD('HideSelection':U)
         ghProp:BUFFER-VALUE = plHideSelection.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
         ghProp = ghProp:BUFFER-FIELD('ImageHeight':U)
         ghProp:BUFFER-VALUE = piImageHeight.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
         ghProp = ghProp:BUFFER-FIELD('ImageWidth':U)
         ghProp:BUFFER-VALUE = piImageWidth.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
         ghProp = ghProp:BUFFER-FIELD('ShowCheckBoxes':U)
         ghProp:BUFFER-VALUE = plShowCheckBoxes.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
         ghProp = ghProp:BUFFER-FIELD('ShowRootLines':U)
         ghProp:BUFFER-VALUE = plShowRootLines.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN ghProp = WIDGET-HANDLE(ENTRY(1, TARGET-PROCEDURE:ADM-DATA, CHR(1)))
         ghProp = ghProp:BUFFER-FIELD('TreeStyle':U)
         ghProp:BUFFER-VALUE = piTreeStyle.
