...
------------------------------------------------------------------------------*/
   ...
   DEFINE VARIABLE dVertMargin   AS DECIMAL    NO-UNDO.
   ...
   DO WITH FRAME {&FRAME-NAME}:
     ...
     ASSIGN            
      ...
      hValue:ROW     = edMessage:ROW + edMessage:HEIGHT
      hLabel:ROW     = hValue:ROW
      btnYes:ROW     = hValue:ROW + hValue:HEIGHT + dVertMargin
      btnNo:ROW      = btnYes:ROW 
      btnCancel:ROW  = btnYes:ROW 
      FRAME {&FRAME-NAME}:HEIGHT = btnYes:ROW + btnYes:HEIGHT + dVertMargin
      NO-ERROR.
