...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="07/08/2005" version_time="60388" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="1005118141.101" record_version_obj="2000001691.28" version_number_seq="5.48" secondary_key_value="dynlookup.w#CHR(1)#0" import_version_number_seq="5.48"><smartobject_obj>1005118141.101</smartobject_obj>
