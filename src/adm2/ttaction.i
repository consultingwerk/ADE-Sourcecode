...
&IF DEFINED(ttaction) = 0 &THEN
  ...
  DEFINE TEMP-TABLE ttAction      NO-UNDO 
   ...
   FIELD SystemOwned              AS LOG
   FIELD TranslatedActionLabel    AS CHARACTER
   FIELD TranslatedActionMLabel   AS CHARACTER
   FIELD TranslatedActionTooltip  AS CHARACTER
   FIELD ProcedureHandle          AS HANDLE
