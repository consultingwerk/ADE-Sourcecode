...
*********************************************************************/
  /* Additional fields beyond the data fields which are a standard part of
   ...
   /* The RowIdentIdx field and index is added to fix the Rocket's index length limitation 
      of 188 chars. Further in the code the RowIdentIdx field is deliberately trimmed to guaranteedly 
      not exceed this limit. The trimmed field is used for indexed search to keep the satisfactory 
      performance */
