...
&Scoped-Define ENABLED-OBJECTS l_DisplayField l_EnableField l_Enable l_View 
&Scoped-Define DISPLAYED-OBJECTS l_DisplayField l_EnableField l_Enable ~
c_Layout l_View 
...
DEFINE VARIABLE l_DisplayField AS LOGICAL INITIAL no 
     LABEL "&Display the Data Value" 
     VIEW-AS TOGGLE-BOX
...
DEFINE VARIABLE l_EnableField AS LOGICAL INITIAL no 
     LABEL "Enable the field for &Update" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME Attribute-Dlg
     l_DisplayField AT ROW 1.95 COL 4
     l_EnableField AT ROW 3 COL 4
     l_Enable AT ROW 6.24 COL 4
     c_Layout AT ROW 6.24 COL 18.4
     l_View AT ROW 7.29 COL 4
     "  Behavior During 'Initialize'" VIEW-AS TEXT
          SIZE 60 BY .62 AT ROW 5.05 COL 2
          BGCOLOR 1 FGCOLOR 15 
     "  Field properties" VIEW-AS TEXT
          SIZE 60 BY .62 AT ROW 1.24 COL 2
          BGCOLOR 1 FGCOLOR 15 
     SPACE(1.59) SKIP(6.56)
...
DO:     
  ...
  ASSIGN l_Enable l_View l_EnableField l_DisplayField
  ...
  DYNAMIC-FUNC("setDisplayField":U IN p_hSMO, INPUT l_DisplayField) NO-ERROR.
  DYNAMIC-FUNC("setEnableField":U IN p_hSMO, INPUT l_EnableField) NO-ERROR.
...
------------------------------------------------------------------------------*/
  DISPLAY l_DisplayField l_EnableField l_Enable c_Layout l_View 
      WITH FRAME Attribute-Dlg.
  ENABLE l_DisplayField l_EnableField l_Enable l_View 
      WITH FRAME Attribute-Dlg.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:   
    ...
    l_DisplayField = DYNAMIC-FUNC("getDisplayField":U IN p_hSMO).
    l_EnableField = DYNAMIC-FUNC("getEnableField":U IN p_hSMO).
