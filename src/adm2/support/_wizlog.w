...
&Scoped-Define ENABLED-OBJECTS e_msg ToLog fiTemplate RECT-3 
...
ASSIGN e_msg = 
      ...
      + "If you select to generate a new DLP, enter a relative directory and filename (i.e. mydirectory/custlog.p) ".
...
------------------------------------------------------------------------------*/
  DISPLAY e_msg ToLog radDLP fLogicProc fiTemplate 
      WITH FRAME DEFAULT-FRAME.
  ENABLE e_msg ToLog fiTemplate RECT-3 
      WITH FRAME DEFAULT-FRAME.
