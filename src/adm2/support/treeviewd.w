...
&Scoped-Define ENABLED-OBJECTS flnIndent cboLabel cboLine cbTreeStyle ~
tgShowCheckBoxes fiImageHeight fiImageWidth tgSort tgHideSelection ~
tglexpand tgldrag tglfull tgldrop tglsingle tglscroll buOK buCancel RECT-1 ~
RECT-2 
...
------------------------------------------------------------------------------*/
  ...
  ENABLE flnIndent cboLabel cboLine cbTreeStyle tgShowCheckBoxes fiImageHeight 
         fiImageWidth tgSort tgHideSelection tglexpand tgldrag tglfull tgldrop 
         tglsingle tglscroll buOK buCancel RECT-1 RECT-2 
      WITH FRAME Attribute-Dlg.
