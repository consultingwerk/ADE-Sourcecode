...
&Scoped-Define ENABLED-OBJECTS l_Enable l_View 
...
ON GO OF FRAME Attribute-Dlg /* Visual SmartObject Attributes */
DO:     
  /* Reassign the attribute alues back in the SmartObject. */
  ASSIGN l_Enable l_View 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Attribute-Dlg Attribute-Dlg
ON WINDOW-CLOSE OF FRAME Attribute-Dlg /* Visual SmartObject Attributes */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY l_Enable c_Layout l_View 
      WITH FRAME Attribute-Dlg.
  ENABLE l_Enable l_View 
      WITH FRAME Attribute-Dlg.
