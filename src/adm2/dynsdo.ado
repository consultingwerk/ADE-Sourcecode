...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/11/2003" version_time="58271" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="2609.66" record_version_obj="2610.66" version_number_seq="4.5566" secondary_key_value="dynsdo.w#CHR(1)#0" import_version_number_seq="4.5566"><smartobject_obj>2609.66</smartobject_obj>
