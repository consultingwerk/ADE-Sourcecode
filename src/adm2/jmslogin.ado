...
<dataset_records><dataset_transaction TransactionNo="1" TransactionType="DATA"><contained_record DB="icfdb" Table="ryc_smartobject" version_date="06/27/2003" version_time="40835" version_user="admin" deletion_flag="no" entity_mnemonic="rycso" key_field_value="3000031222.09" record_version_obj="3000031223.09" version_number_seq="6" secondary_key_value="jmslogin#CHR(1)#0" import_version_number_seq="6"><smartobject_obj>3000031222.09</smartobject_obj>
