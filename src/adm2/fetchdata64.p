...
/* ***************************  Definitions  ************************** */
  ...
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject33.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject34.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject35.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject36.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject37.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject38.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject39.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject40.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject41.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject42.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject43.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject44.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject45.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject46.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject47.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject48.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject49.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject50.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject51.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject52.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject53.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject54.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject55.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject56.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject57.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject58.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject59.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject60.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject61.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject62.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject63.
  DEFINE OUTPUT PARAMETER TABLE-HANDLE phRowObject64.
