...
/*------------------------------------------------------------------------
  ...
  File: _coderef-preproc.w

  Description: from SMART.W - Template for basic ADM2 SmartObject
  Preprocessor Names List for AppBuilder's Code References Window.
...
/* Help for this Instance of the Pick Frame */
ON HELP OF FRAME {&FRAME-NAME}
  RUN adecomm/_adehelp.p ("AB":U, "CONTEXT":U, {&Preprocessor_Names_Dlg_Box} , "":U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE InsertPreProcName sObject 
...
DO WITH FRAME {&FRAME-NAME}:
  /* Paste non-empty s_PickList into the buffer, with appropriate preprocessor
     headings.  */
  ASSIGN s_PickList.
...
DO WITH FRAME {&FRAME-NAME}:
  ...
  DO:
    ...
    RUN getPreProcNameList IN hSecEd (OUTPUT vList, OUTPUT vItem).
