      ...
      CASE choice:
        ...
        OTHERWISE DO:
          ...
          DO:
             ...
             /* ensure there actually is fields (Dataview on drop does not have
                fields yet)*/
             ASSIGN
                src_isQuery  = DYNAMIC-FUNCTION("getQueryObject":U IN _S._HANDLE)
                               AND {fn getDataColumns _S._HANDLE} > '' 
                targ_isQuery = DYNAMIC-FUNCTION("getQueryObject":U IN xx_S._HANDLE) 
                              AND {fn getDataColumns _S._HANDLE} > '' NO-ERROR
             .
