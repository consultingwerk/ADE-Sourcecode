...
DEFINE SUB-MENU m_Help 
       ...
       MENU-ITEM m_Contents     LABEL "AppBuilder &Help Topics"
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL m_OpenEdge_Master_Help h_sewin
...
/* ***************************  Main Block  *************************** */
ON SHIFT-F6 ANYWHERE PERSISTENT RUN choose_file_save_as IN _h_uib.
RUN init-win.
RUN set_vars.
