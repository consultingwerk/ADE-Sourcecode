...
*************************************************/
/*------------------------------------------------------------------------
    File        : dbconnectionrole_fn.i
    Purpose     : Common util functions for the dbconnectionrole_*.p utilities
    Author(s)   : pjudge 
    Created     : 2016-05-03
    Notes       :
  ----------------------------------------------------------------------*/
&global-define DB-OPTION-CODE _db.connection.roles
&global-define CONN-AUTH-ROLE _db.connection

define temp-table UserGrant no-undo
    field Grantee  as character
    field CanGrant as logical.
