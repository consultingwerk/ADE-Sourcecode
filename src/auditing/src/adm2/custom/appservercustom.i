...
*********************************************************************/
/*------------------------------------------------------------------------
    File        : appservercustom.i
    Purpose     : References the start of the custom super procedure.
                  Allows properties initialization.

    Syntax      : {src/adm2/custom/appservercustom.i}

    Description :

    Created     : 01/24/2001
    Notes       : Referenced in {src/adm2/appserver.i}
  ----------------------------------------------------------------------*/
...
/* IF NOT {&ADM-LOAD-FROM-REPOSITORY} THEN
     RUN start-super-proc ("adm2/custom/appservercustom.p":U).*/
